...
// node_modules/mermaid/dist/requirementDiagram-9f95ab38.js
var ce = function() {
  var e = function(V, i, r, a) {
    for (r = r || {}, a = V.length; a--; r[V[a]] = i)
      ;
    return r;
  }, t = [1, 3], l = [1, 4], c = [1, 5], u = [1, 6], d = [5, 6, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], f = [1, 18], h = [2, 7], o = [1, 22], E = [1, 23], R = [1, 24], A = [1, 25], T = [1, 26], N = [1, 27], w = [1, 20], k = [1, 28], x = [1, 29], F = [62, 63], de = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 51, 53, 62, 63], fe = [1, 47], pe = [1, 48], ye = [1, 49], _e = [1, 50], Ee = [1, 51], ge = [1, 52], Re = [1, 53], O = [53, 54], M = [1, 64], D = [1, 60], P2 = [1, 61], Y = [1, 62], U = [1, 63], B = [1, 65], j = [1, 69], z = [1, 70], X = [1, 67], J = [1, 68], m = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63], ie = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(i) {
      var r = this, a = [0], n = [], p = [null], s = [], W = this.table, _ = "", Z = 0, me = 0, Ve = 2, Ie = 1, qe = s.slice.call(arguments, 1), g = Object.create(this.lexer), L2 = { yy: {} };
      for (var re in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, re) && (L2.yy[re] = this.yy[re]);
      g.setInput(i, L2.yy), L2.yy.lexer = g, L2.yy.parser = this, typeof g.yylloc > "u" && (g.yylloc = {});
      var se = g.yylloc;
      s.push(se);
...
var pt = function(e, t, l, c, u) {
  const d = l.edge(H(t.src), H(t.dst)), f = P().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  ...
  t.type == u.db.Relationships.CONTAINS ? h.attr(
    ...
    "marker-end",
    "url(" + Rn.getUrl(y.arrowMarkerAbsolute) + "#" + xe.ReqMarkers.ARROW + "_line_ending)"
  )), ft(e, h, y, `<<${t.type}>>`);
};
var yt = (e, t, l) => {
...
var Rt = (e, t, l, c) => {
  ...
  let d;
  u === "sandbox" && (d = Tt("#i" + t));
  const h = (u === "sandbox" ? Tt(d.nodes()[0].contentDocument.body) : Tt("body")).select(`[id='${t}']`);
  ...
  Pl(h, k, w, y.useMaxWidth), h.attr("viewBox", `${N.x - T} ${N.y - T} ${w} ${k}`);
};
var mt = {
  draw: Rt
};
...
//# sourceMappingURL=requirementDiagram-9f95ab38-FDFGM2WB.js.map
