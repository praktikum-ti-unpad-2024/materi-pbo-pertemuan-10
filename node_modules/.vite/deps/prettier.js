  ...
  "node_modules/prettier/standalone.js"(exports, module) {
    (function(t) {
      ...
      var Cu = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), dt = (e, t) => {
        for (var r in t)
          Ue(e, r, { get: t[r], enumerable: true });
      }, er = (e, t, r, n) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let u of du(t))
            !Eu.call(e, u) && u !== r && Ue(e, u, { get: () => t[u], enumerable: !(n = pu(t, u)) || n.enumerable });
        return e;
      };
      var hu = (e, t, r) => (r = e != null ? Fu(mu(e)) : {}, er(t || !e || !e.__esModule ? Ue(r, "default", { value: e, enumerable: true }) : r, e)), gu = (e) => er(Ue({}, "__esModule", { value: true }), e);
...
${l}`), l;
      ...
      var oi = {};
      dt(oi, { __debug: () => ui, check: () => ri, doc: () => qt, format: () => fu, formatWithCursor: () => cu, getSupportInfo: () => ni, util: () => Qt, version: () => tu });
      var Au = (e, t, r, n) => {
        if (!(e && t == null))
...
`);
      ...
      var W = "string", Y = "array", j = "cursor", N = "indent", O = "align", P = "trim", B = "group", k = "fill", _ = "if-break", v = "indent-if-break", L = "line-suffix", I = "line-suffix-boundary", g = "line", S = "label", w = "break-parent", Ve = /* @__PURE__ */ new Set([j, N, O, P, B, k, _, v, L, I, g, S, w]);
      var Bu = (e, t, r) => {
        if (!(e && t == null))
...
`)) : r);
      ...
      var Ar = { type: I }, pe = { type: w }, Br = { type: P }, Te = { type: g, hard: true }, Bt = { type: g, hard: true, literal: true }, Ge = { type: g }, _r = { type: g, soft: true }, z = [Te, pe], Me = [Bt, pe], X = { type: j };
      function ke(e, t) {
        K(e), yt(t);
        let r = [];
        for (let n = 0; n < t.length; n++)
...
`, u) : f;
            ...
            case k: {
              ...
              if (E === 0)
                break;
              let h = C[m + 0], x = C[m + 1], A = { ind: l, mode: H, doc: h }, $ = { ind: l, mode: R, doc: h }, ue = ze(A, [], d, c.length > 0, r, true);
              if (E === 1) {
                ue ? i.push(A) : i.push($);
                break;
              }
              let Be = { ind: l, mode: H, doc: x }, Ft = { ind: l, mode: R, doc: x };
              if (E === 2) {
                ue ? i.push(Be, A) : i.push(Ft, $);
                break;
              }
              let lu = C[m + 2], pt = { ind: l, mode: F, doc: { ...f, [_t]: m + 2 } };
              ze({ ind: l, mode: H, doc: [h, x, lu] }, [], d, c.length > 0, r, true) ? i.push(pt, Be, A) : ue ? i.push(pt, Ft, A) : i.push(pt, Ft, $);
              break;
            }
            case _:
            case v: {
      ...
      var Z, kt, He, bt = class {
        ...
        findAncestor(t) {
          for (let r of fe(this, Z, He).call(this))
            if (t(r))
              return r;
        }
        hasAncestor(t) {
...
` || u === "\r" || u === "\u2028" || u === "\u2029")
      ...
      function Qe(e, t) {
        ...
        if (!n)
          return [];
        let s = ((r == null ? void 0 : r(e, t)) ?? [...Ce(e, { getVisitorKeys: J(u) })]).flatMap((a) => n(a) ? [a] : Qe(a, t));
      ...
      function Vr(e, t) {
        let { comments: r } = e;
        if (delete e.comments, !Xe(r) || !t.printer.canAttachComment)
          return;
      ...
      function Hu(e, t) {
        ...
        if ((D = u.isBlockComment) == null ? void 0 : D.call(u, r)) {
          let p = G(o, s(r)) ? G(o, i(r), { backwards: true }) ? z : Ge : " ";
          n.push(p);
        } else
          n.push(z);
        let c = U(o, T(o, s(r)));
...
The range will extend backwards to the start of the first line containing the selected statement.`, cliCategory: "Editor" }, requirePragma: { category: "Special", type: "boolean", default: false, description: "Require either '@prettier' or '@format' to be present in the file's first docblock comment in order for it to be formatted.", cliCategory: "Other" }, tabWidth: { type: "int", category: "Global", default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: 1 / 0, step: 1 } }, useTabs: { category: "Global", type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { category: "Global", type: "choice", default: "auto", description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      function Ze({ plugins: e = [], showDeprecated: t = false } = {}) {
...
`)), Fn(o, r.loggerPrintWidth);
      ...
      function cn(e, t, r, n) {
        return [`Invalid ${V.red(n.key(e))} value.`, `Expected ${V.blue(r)},`, `but received ${t === et ? V.gray("nothing") : V.red(n.value(t))}.`].join(" ");
      }
...
`, 1)[0].length);
      ...
      function lo(e, t, { logger: r = false, isCLI: n = false, passThrough: u = false, FlagSchema: o, descriptor: i } = {}) {
        ...
        }, a = Fo(t, { isCLI: n, FlagSchema: o }), c = new ct(a, { logger: r, unknown: s, descriptor: i }), D = r !== false;
      ...
      function Fo(e, { isCLI: t, FlagSchema: r }) {
        ...
        for (let u of e)
          n.push(po(u, { isCLI: t, optionInfos: e, FlagSchema: r })), u.alias && t && n.push(rt.create({ name: u.alias, sourceName: u.name }));
        return n;
      }
      function po(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
        ...
        switch (e.type) {
          ...
          case "string":
            ...
            break;
          case "choice":
            i = st, o.choices = e.choices.map((a) => a != null && a.redirect ? { ...a, redirect: { to: { key: e.name, value: a.redirect } } } : a);
            break;
          case "boolean":
            i = ot;
            break;
        ...
        return e.array ? ut.create({ ...t ? { preprocess: (a) => Array.isArray(a) ? a : [a] } : {}, ...s, valueSchema: i.create(o) }) : i.create({ ...o, ...s });
      }
      var kn = lo;
      var mo = (e, t, r) => {
        if (!(e && t == null)) {
      ...
      async function Eo(e, t = {}) {
        ...
        let n = Ze({ plugins: e.plugins, showDeprecated: true }).options, u = { ...Nn, ...Object.fromEntries(n.filter((l) => l.default !== void 0).map((l) => [l.name, l.default])) }, o = $t(r.plugins, r.parser), i = await Wt(o, r.parser);
...
`);
      ...
      var ye = jo;
      function Uo(e, t) {
        return t === false ? false : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? qe(e, t) : t;
      }
      var Ae = Uo;
      function Vo(e, t) {
        let r = null, n = t;
...
`);
      ...
      var lt = "'", ou = '"';
      function Ko(e, t) {
        let r = t === true || t === lt ? lt : ou, n = r === lt ? ou : lt, u = 0, o = 0;
        for (let i of e)
          i === r ? u++ : i === n && o++;
        return u > o ? n : r;
      }
...
`)
      ...
      var ni = ce(Ze, 0), ui = { parse: ce(qn), formatAST: ce(Xn), formatDoc: ce(Qn), printToDoc: ce(Zn), printDocToString: ce(eu) };
      return gu(oi);
    });
  }
});
