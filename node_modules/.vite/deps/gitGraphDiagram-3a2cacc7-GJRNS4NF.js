...
// node_modules/mermaid/dist/gitGraphDiagram-3a2cacc7.js
var me = function() {
...
Expecting ` + se.join(", ") + ", got '" + (this.terminals_[N] || N) + "'" : he = "Parse error on line " + (re + 1) + ": Unexpected " + (N == pe ? "end of input" : "'" + (this.terminals_[N] || N) + "'"), this.parseError(he, {
    ...
    var G = {
      ...
      setInput: function(o, u) {
        return this.yy = u || this.yy || {}, this._input = o, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
        ...
        for (var T = this._currentRules(), e = 0; e < T.length; e++)
          if (d = this._input.match(this.rules[T[e]]), d && (!u || d[0].length > u[0].length)) {
            if (u = d, s = e, this.options.backtrack_lexer) {
              if (o = this.test_match(d, T[e]), o !== false)
                return o;
              if (this._backtrack) {
                u = false;
                continue;
...
me.parser = me;
var Ve = me;
var ae = Jn().gitGraph.mainBranchName;
var De = Jn().gitGraph.mainBranchOrder;
var C = {};
var S = null;
var ee = {};
...
var qe = function(r) {
  ...
  try {
    ...
    L.error("error while parsing gitGraph options", n.message);
  }
};
var Ye = function() {
  return xe;
};
var Fe = function(r, n, l, h) {
  L.debug("Entering commit:", r, n, l, h), n = Rn.sanitizeText(n, Jn()), r = Rn.sanitizeText(r, Jn()), h = Rn.sanitizeText(h, Jn());
  const i = {
    id: n || W + "-" + ue(),
    message: r,
    seq: W++,
  ...
  S = i, C[i.id] = i, L2[A] = i.id, L.debug("in pushCommit " + i.id);
};
var Ke = function(r, n) {
  if (r = Rn.sanitizeText(r, Jn()), L2[r] === void 0)
    L2[r] = S != null ? S.id : null, ee[r] = { name: r, order: n ? parseInt(n, 10) : null }, ye(r), L.debug("in createBranch");
  else {
    let l = new Error(
...
var Ue = function(r, n, l, h) {
  r = Rn.sanitizeText(r, Jn()), n = Rn.sanitizeText(n, Jn());
  const i = C[L2[A]], c = C[L2[r]];
  if (A === r) {
  ...
  S = p, C[p.id] = p, L2[A] = p.id, L.debug(L2), L.debug("in mergeBranch");
};
var We = function(r, n, l, h) {
  if (L.debug("Entering cherryPick:", r, n, l), r = Rn.sanitizeText(r, Jn()), n = Rn.sanitizeText(n, Jn()), l = Rn.sanitizeText(l, Jn()), h = Rn.sanitizeText(h, Jn()), !r || C[r] === void 0) {
    let p = new Error(
  ...
  if (!n || C[n] === void 0) {
    ...
    S = m, C[m.id] = m, L2[A] = m.id, L.debug(L2), L.debug("in cherryPick");
  }
};
var ye = function(r) {
  if (r = Rn.sanitizeText(r, Jn()), L2[r] === void 0) {
...
function _e(r) {
  ...
  for (let i in L2)
    L2[i] === n.id && h.push(i);
  if (L.debug(h.join(" ")), n.parents && n.parents.length == 2) {
...
var Qe = function() {
  C = {}, S = null;
  let r = Jn().gitGraph.mainBranchName, n = Jn().gitGraph.mainBranchOrder;
  L2 = {}, L2[r] = null, ee = {}, ee[r] = { name: r, order: n }, A = r, W = 0, O_();
};
var Xe = function() {
...
var de = (r, n, l) => {
  const h = Jn().gitGraph, i = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let p = 0;
  w === "TB" && (p = 30);
...
var lt = (r, n) => {
  const l = Jn().gitGraph, h = r.append("g");
  n.forEach((i, c) => {
    ...
    let f = a.getBBox();
    R.attr("class", "branchLabelBkg label" + p).attr("rx", 4).attr("ry", 4).attr("x", -f.width - 4 - (l.rotateCommitLabel === true ? 30 : 0)).attr("y", -f.height / 2 + 8).attr("width", f.width + 18).attr("height", f.height + 4), b.attr(
      "transform",
      "translate(" + (-f.width - 14 - (l.rotateCommitLabel === true ? 30 : 0)) + ", " + (m - f.height / 2 - 1) + ")"
...
var ht = function(r, n, l, h) {
  st();
  const i = Jn(), c = i.gitGraph;
...
`, "id:", n, l), Z = h.db.getCommits();
  ...
  }), de(m, Z, false), c.showBranches && lt(m, p), ot(m, Z), de(m, Z, true), oi.insertTitle(
    m,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-3a2cacc7-GJRNS4NF.js.map
