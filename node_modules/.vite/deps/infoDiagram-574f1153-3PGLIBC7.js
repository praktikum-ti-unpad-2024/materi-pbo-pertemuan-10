...
// node_modules/mermaid/dist/infoDiagram-574f1153.js
var O = function() {
...
` + a);
  const k = G_(f);
  Pl(k, 100, 400, true), k.append("g").append("text").attr("x", 100).attr("y", 40).attr("class", "version").attr("font-size", 32).style("text-anchor", "middle").text(`v${m}`);
};
var H = { draw: G };
var K = {
  parser: B,
...
//# sourceMappingURL=infoDiagram-574f1153-3PGLIBC7.js.map
