...
// node_modules/mermaid/dist/styles-434cae6b.js
var gt = function() {
  var t = function(C, r, n, i) {
    ...
    parse: function(r) {
      var n = this, i = [0], o = [], p = [null], e = [], $ = this.table, l = "", A = 0, O = 0, st = 2, B = 1, ft = e.slice.call(arguments, 1), S = Object.create(this.lexer), L2 = { yy: {} };
...
var I = function(t, s = Et, a = null, h = null, f = null, d = null, y = null, k = null) {
  ...
  g.states[u] === void 0 ? (L.info("Adding state ", u, h), g.states[u] = {
    ...
    styles: [],
    textStyles: []
  }) : (g.states[u].doc || (g.states[u].doc = a), g.states[u].type || (g.states[u].type = s)), h && (L.info("Setting state description", u, h), typeof h == "string" && kt(u, h.trim()), typeof h == "object" && h.forEach((E) => kt(u, E.trim()))), f && (g.states[u].note = f, g.states[u].note.text = Rn.sanitizeText(
...
function ye(t, s, a) {
  ...
  I(
    ...
    id1: h,
    id2: d,
    relationTitle: Rn.sanitizeText(a, Jn())
  });
}
var Ft = function(t, s, a) {
  if (typeof t == "object")
    ye(t, s, a);
  else {
    ...
    I(h, f), I(d, y), g.relations.push({
      id1: h,
      id2: d,
      title: Rn.sanitizeText(a, Jn())
    });
  }
};
var kt = function(t, s) {
  const a = g.states[t], h = s.startsWith(":") ? s.replace(":", "").trim() : s;
  a.descriptions.push(Rn.sanitizeText(h, Jn()));
};
var pe = function(t) {
...
//# sourceMappingURL=chunk-DEOTBQCL.js.map
