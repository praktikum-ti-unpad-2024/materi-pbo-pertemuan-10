...
// node_modules/mermaid/dist/mindmap-definition-f3352918.js
var Qi = function() {
...
` + te + "^";
      ...
      next: function() {
        ...
        for (var R = this._currentRules(), q = 0; q < R.length; q++)
          if (S = this._input.match(this.rules[R[q]]), S && (!te || S[0].length > te[0].length)) {
            if (te = S, V = q, this.options.backtrack_lexer) {
              if (H = this.test_match(S, R[q]), H !== false)
                return H;
              if (this._backtrack) {
                te = false;
                continue;
        ...
        return te ? (H = this.test_match(te, R[V]), H !== false ? H : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var Lp = () => or.length > 0 ? or[0] : null;
var Ap = (de, Pe, _, fe) => {
  var I, z;
  L.info("addNode", de, Pe, _, fe);
  const Q = Jn();
  let C = ((I = Q.mindmap) == null ? void 0 : I.padding) ?? kp.mindmap.padding;
  switch (fe) {
  ...
  const T = {
    ...
    type: fe,
    children: [],
    width: ((z = Q.mindmap) == null ? void 0 : z.maxNodeWidth) ?? kp.mindmap.maxNodeWidth,
    padding: C
  }, x = Sp(de);
  if (x)
...
var Op = (de, Pe) => {
  switch (L.debug("In get type", de, Pe), de) {
    case "[":
      return St.RECT;
    case "(":
...
var Ip = (de) => {
  if (!de)
    return;
  const Pe = Jn(), _ = or[or.length - 1];
  de.icon && (_.icon = Oe(de.icon, Pe)), de.class && (_.class = Oe(de.class, Pe));
};
var Mp = (de) => {
  switch (de) {
    case St.DEFAULT:
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var kr = ru, Sa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof Th < "u" ? Th : typeof self < "u" ? self : {};
    function au(t, e) {
    ...
    var du = cu, gu = sn.Symbol, Zr2 = gu, as = Object.prototype, pu = as.hasOwnProperty, yu = as.toString, La = Zr2 ? Zr2.toStringTag : void 0;
    function mu(t) {
    ...
    var Tu = xu, Cu = "[object Null]", Du = "[object Undefined]", ns = Zr2 ? Zr2.toStringTag : void 0;
    function Su(t) {
    ...
    function zu(t, e, r) {
      var a, n, i, s, o, u, l = 0, f = false, h = false, v = true;
      ...
      function d(L2) {
        var w = a, k = n;
        return a = n = void 0, l = L2, s = t.apply(k, w), s;
      }
      function c(L2) {
        return l = L2, o = setTimeout(g, e), f ? d(L2) : s;
      }
      function y(L2) {
        var w = L2 - u, k = L2 - l, D = e - w;
        return h ? Gu(D, i - k) : D;
      }
      function p(L2) {
        var w = L2 - u, k = L2 - l;
      ...
      function m(L2) {
        return o = void 0, v && a ? d(L2) : (a = n = void 0, s);
      }
      function b() {
      ...
      return M.cancel = b, M.flush = E2, M;
    }
    var on = zu, ni = A ? A.performance : null, ls = ni && ni.now ? function() {
      ...
      return r;
    }, vs = true, Yu = console.warn != null, Hu = console.trace != null, ii = Number.MAX_SAFE_INTEGER || 9007199254740991, cs = function() {
      return true;
    }, fn = function() {
      return false;
    }, ds = function() {
    ...
    }(), ur = typeof Map < "u" ? Map : Zu, Qu = "undefined", Ju = function() {
      function t(e) {
      ...
      return e = {
        ...
        for (var o = this._private.cy, u = a = ee(a) ? this.filter(a) : a, l = [], f = [], h = {}, v = {}, d = {}, c = 0, y, p = this.byGroup(), g = p.nodes, m = p.edges, b = 0; b < u.length; b++) {
          var E2 = u[b], M = E2.id();
          E2.isNode() && (l.unshift(E2), e.bfs && (d[M] = true, f.push(E2)), v[M] = 0);
        }
        for (var L2 = function() {
          var X = e.bfs ? l.shift() : l.pop(), B2 = X.id();
          if (e.dfs) {
            if (d[B2])
              return "continue";
            d[B2] = true, f.push(X);
          }
          var re = v[B2], K = h[B2], W = K != null ? K.source() : null, ae = K != null ? K.target() : null, ue = K == null ? void 0 : X.same(W) ? ae[0] : W[0], me = void 0;
          if (me = n(X, K, ue, c++, re), me === true)
            return y = X, "break";
          if (me === false)
            return "break";
          for (var ie = X.connectedEdges().filter(function(De) {
            ...
            Ce.length !== 0 && !d[we] && (Ce = Ce[0], l.push(Ce), e.bfs && (d[we] = true, f.push(Ce)), h[we] = Ee, v[we] = v[B2] + 1);
          }
        }; l.length !== 0; ) {
          var w = L2();
    ...
    var ju = au(function(t, e) {
      (function() {
        ...
        n = Math.floor, h = Math.min, a = function(g, m) {
        ...
        }, f = function(g, m, b, E2, M) {
          var L2;
          if (b == null && (b = 0), M == null && (M = a), b < 0)
            throw new Error("lo must be non-negative");
          for (E2 == null && (E2 = g.length); b < E2; )
            L2 = n((b + E2) / 2), M(m, g[L2]) < 0 ? E2 = L2 : b = L2 + 1;
          return [].splice.apply(g, [b, b - b].concat(m)), m;
        }, o = function(g, m, b) {
          return b == null && (b = a), g.push(m), y(g, 0, g.length - 1, b);
        }, s = function(g, m) {
          var b, E2;
          return m == null && (m = a), b = g.pop(), g.length ? (E2 = g[0], g[0] = b, p(g, 0, m)) : E2 = b, E2;
        }, l = function(g, m, b) {
          var E2;
          return b == null && (b = a), E2 = g[0], g[0] = m, p(g, 0, b), E2;
        }, u = function(g, m, b) {
          var E2;
          return b == null && (b = a), g.length && b(g[0], m) < 0 && (E2 = [g[0], m], m = E2[0], g[0] = E2[1], p(g, 0, b)), m;
        }, i = function(g, m) {
          var b, E2, M, L2, w, k;
          for (m == null && (m = a), L2 = (function() {
            k = [];
            for (var D = 0, F = n(g.length / 2); 0 <= F ? D < F : D > F; 0 <= F ? D++ : D--)
              k.push(D);
            return k;
          }).apply(this).reverse(), w = [], E2 = 0, M = L2.length; E2 < M; E2++)
            b = L2[E2], w.push(p(g, b, m));
          return w;
        }, c = function(g, m, b) {
          var E2;
          if (b == null && (b = a), E2 = g.indexOf(m), E2 !== -1)
            return y(g, 0, E2, b), p(g, E2, b);
        }, v = function(g, m, b) {
          var E2, M, L2, w, k;
          if (b == null && (b = a), M = g.slice(0, m), !M.length)
            return M;
          for (i(M, b), k = g.slice(m), L2 = 0, w = k.length; L2 < w; L2++)
            E2 = k[L2], u(M, E2, b);
          return M.sort(b).reverse();
        }, d = function(g, m, b) {
          var E2, M, L2, w, k, D, F, G, N;
          if (b == null && (b = a), m * 10 <= g.length) {
            if (L2 = g.slice(0, m).sort(b), !L2.length)
              return L2;
            for (M = L2[L2.length - 1], F = g.slice(m), w = 0, D = F.length; w < D; w++)
              E2 = F[w], b(E2, M) < 0 && (f(L2, E2, 0, null, b), L2.pop(), M = L2[L2.length - 1]);
            return L2;
          }
          ...
          var M, L2, w;
          for (E2 == null && (E2 = a), M = g[b]; b > m; ) {
            if (w = b - 1 >> 1, L2 = g[w], E2(M, L2) < 0) {
              g[b] = L2, b = w;
              continue;
            }
            break;
          ...
          var E2, M, L2, w, k;
          for (b == null && (b = a), M = g.length, k = m, L2 = g[m], E2 = 2 * m + 1; E2 < M; )
            w = E2 + 1, w < M && !(b(g[E2], g[w]) < 0) && (E2 = w), g[m] = g[E2], m = E2, E2 = 2 * m + 1;
          return g[m] = L2, y(g, k, m, b);
        }, r = function() {
      ...
      dijkstra: function(e) {
        ...
        for (var p = function(K) {
          ...
          var E2 = c[b];
          f[E2.id()] = E2.same(l) ? 0 : 1 / 0, m.push(E2);
        }
        for (var M = function(K, W) {
          ...
          var L2 = m.pop(), w = p(L2), k = L2.id();
          if (v[k] = w, w !== 1 / 0)
            for (var D = L2.neighborhood().intersect(c), F = 0; F < D.length; F++) {
              var G = D[F], N = G.id(), X = M(L2, G), B2 = w + X.dist;
              B2 < p(G) && (g(G, B2), h[N] = {
                node: L2,
                edge: X.edge
              });
      ...
      kruskal: function(e) {
        ...
        for (var r = this.byGroup(), a = r.nodes, n = r.edges, i = a.length, s = new Array(i), o = a, u = function(E2) {
          ...
          s[l] = this.spawn(a[l]);
        for (var f = n.sort(function(b, E2) {
          return e(b) - e(E2);
        }), h = 0; h < f.length; h++) {
      ...
      aStar: function(e) {
        ...
        for (var w = 0; c.size() > 0; ) {
          ...
          for (var N = b._private.edges, X = 0; X < N.length; X++) {
            var B2 = N[X];
            if (this.hasElementWithId(B2.id()) && !(o && B2.data("source") !== E2)) {
              var re = B2.source(), K = B2.target(), W = re.id() !== E2 ? re : K, ae = W.id();
              if (this.hasElementWithId(ae) && !d[ae]) {
                var ue = h[E2] + u(B2);
                if (!L2(ae)) {
                  h[ae] = ue, v[ae] = ue + s(W), m(W, ae), p[ae] = b, g[ae] = B2;
                  continue;
                }
                ue < h[ae] && (h[ae] = ue, v[ae] = ue + s(W), p[ae] = b, g[ae] = B2);
              }
            }
          }
        }
      ...
      floydWarshall: function(e) {
        ...
        for (var m = new Array(h), b = new Array(h), E2 = 0; E2 < l.length; E2++) {
          var M = l[E2], L2 = M.source()[0], w = M.target()[0];
          if (L2 !== w) {
            var k = v(L2), D = v(w), F = k * f + D, G = s(M);
        ...
        for (var X = 0; X < f; X++)
          for (var B2 = 0; B2 < f; B2++)
            for (var re = B2 * f + X, K = 0; K < f; K++) {
              var W = B2 * f + K, ae = X * f + K;
      ...
      bellmanFord: function(e) {
        var r = this, a = lf(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(), f = this.byGroup(), h = f.edges, v = f.nodes, d = v.length, c = new ur(), y = false, p = [];
        ...
        for (var D = false, F = function(Be, $e, rt, je, We, et) {
          var he = je.dist + et;
          he < We.dist && !rt.same(je.edge) && (We.dist = he, We.pred = Be, We.edge = rt, D = true);
        }, G = 1; G < d; G++) {
          D = false;
          for (var N = 0; N < g; N++) {
            var X = h[N], B2 = X.source(), re = X.target(), K = o(X), W = m(B2), ae = m(re);
            F(B2, re, X, W, ae, K), i || F(re, B2, X, ae, W, K);
          }
          if (!D)
            break;
        }
        if (D)
          for (var ue = [], me = 0; me < g; me++) {
            ...
            if (we + Ce < De || !i && De + Ce < we)
              if (y || (vt("Graph contains a negative weight cycle for Bellman-Ford"), y = true), e.findNegativeWeightCycles !== false) {
                var se = [];
                we + Ce < De && se.push(ge), !i && De + Ce < we && se.push(Ee);
                for (var xe = se.length, Le = 0; Le < xe; Le++) {
                  var Se = se[Le], Oe2 = [Se];
                  Oe2.push(m(Se).edge);
                  for (var Fe = m(Se).pred; Oe2.indexOf(Fe) === -1; )
                    Oe2.push(Fe), Oe2.push(m(Fe).edge), Fe = m(Fe).pred;
                  Oe2 = Oe2.slice(Oe2.indexOf(Fe));
                  for (var Xe = Oe2[0].id(), Ie = 0, Me = 2; Me < Oe2.length; Me += 2)
                    Oe2[Me].id() < Xe && (Xe = Oe2[Me].id(), Ie = Me);
                  Oe2 = Oe2.slice(Ie).concat(Oe2.slice(0, Ie)), Oe2.push(Oe2[0]);
                  var Ue = Oe2.map(function(ze) {
                    return ze.id();
                  }).join(",");
                  ue.indexOf(Ue) === -1 && (p.push(u.spawn(Oe2)), ue.push(Ue));
                }
              } else
                break;
          }
      ...
      kargerStein: function() {
        ...
        for (var v = 1 / 0, d = [], c = new Array(i), y = new Array(i), p = new Array(i), g = function(ue, me) {
          ...
          for (var b = 0; b < i; b++)
            y[b] = b;
          var E2 = li(y, l.slice(), i, u), M = E2.slice();
          g(y, p);
          var L2 = li(y, E2, u, 2), w = li(p, M, u, 2);
          L2.length <= w.length && L2.length < v ? (v = L2.length, d = L2, g(y, c)) : w.length <= L2.length && w.length < v && (v = w.length, d = w, g(p, c));
        }
        for (var k = this.spawn(d.map(function(ae) {
          return n[ae[0]];
        })), D = this.spawn(), F = this.spawn(), G = c[0], N = 0; N < c.length; N++) {
          var X = c[N], B2 = a[N];
          X === G ? D.merge(B2) : F.merge(B2);
        }
        var re = function(ue) {
          var me = e.spawn();
      ...
      var u = Fa(i, s), l = i / 2, f = s / 2, h;
      {
        ...
        if (h = Cr(e, r, a, n, v, d, c, y, false), h.length > 0)
          return h;
      }
      {
        var p = a + l + o, g = n - f + u - o, m = p, b = n + f - u + o;
        if (h = Cr(e, r, a, n, p, g, m, b, false), h.length > 0)
          return h;
      }
      {
        var E2 = a - l + u - o, M = n + f + o, L2 = a + l - u + o, w = M;
        if (h = Cr(e, r, a, n, E2, M, L2, w, false), h.length > 0)
          return h;
      }
      {
        var k = a - l - o, D = n - f + u - o, F = k, G = n + f - u + o;
        if (h = Cr(e, r, a, n, k, D, F, G, false), h.length > 0)
          return h;
      }
      var N;
      {
        var X = a - l + u, B2 = n - f + u;
        if (N = Pa(e, r, a, n, X, B2, u + o), N.length > 0 && N[0] <= X && N[1] <= B2)
          return [N[0], N[1]];
      }
      {
      ...
      y.push(1), y.push(0);
      for (var g = -1, m, b, E2, M = 0; M < y.length; M++)
        m = Math.pow(1 - y[M], 2) * a + 2 * (1 - y[M]) * y[M] * i + y[M] * y[M] * o, b = Math.pow(1 - y[M], 2) * n + 2 * (1 - y[M]) * y[M] * s + y[M] * y[M] * u, E2 = Math.pow(m - e, 2) + Math.pow(b - r, 2), g >= 0 ? E2 < g && (g = E2) : g = E2;
      return g;
      ...
      for (var u = new Array(a.length), l = s / 2, f = o / 2, h = ci(s, o), v = h * h, d = 0; d < a.length / 4; d++) {
        ...
        var p = n + l * a[d * 4], g = i + f * a[d * 4 + 1], m = -a[c] * a[y] - a[c + 1] * a[y + 1], b = h / Math.tan(Math.acos(m) / 2), E2 = p - b * a[c], M = g - b * a[c + 1], L2 = p + b * a[y], w = g + b * a[y + 1];
        u[d * 4] = E2, u[d * 4 + 1] = M, u[d * 4 + 2] = L2, u[d * 4 + 3] = w;
        var k = a[c + 1], D = -a[c], F = k * a[y] + D * a[y + 1];
        F < 0 && (k *= -1, D *= -1);
        var G = E2 + k * h, N = M + D * h, X = Math.pow(G - e, 2) + Math.pow(N - r, 2);
        if (X <= v)
          return true;
      }
      return Ht(e, r, u);
      ...
      if (p >= 0 && p <= 1 && m.push(p), g >= 0 && g <= 1 && m.push(g), m.length === 0)
        return [];
      var b = m[0] * u[0] + e, E2 = m[0] * u[1] + r;
      if (m.length > 1) {
        if (m[0] == m[1])
          return [b, E2];
        var M = m[1] * u[0] + e, L2 = m[1] * u[1] + r;
        return [b, E2, M, L2];
      } else
        return [b, E2];
    }, hi = function(e, r, a) {
      ...
      if (m !== 0) {
        var b = p / m, E2 = g / m, M = 1e-3, L2 = 0 - M, w = 1 + M;
        return L2 <= b && b <= w && L2 <= E2 && E2 <= w ? [e + b * h, r + b * c] : l ? [e + b * h, r + b * c] : [];
      } else
        return p === 0 || g === 0 ? hi(e, a, o) === o ? [o, u] : hi(e, a, i) === i ? [i, s] : hi(i, o, a) === a ? [a, n] : [] : [];
    }, Ba = function(e, r, a, n, i, s, o, u) {
      var l = [], f, h = new Array(a.length), v = true;
      s == null && (v = false);
      var d;
      if (v) {
        ...
        d = a;
      for (var p, g, m, b, E2 = 0; E2 < d.length / 2; E2++)
        p = d[E2 * 2], g = d[E2 * 2 + 1], E2 < d.length / 2 - 1 ? (m = d[(E2 + 1) * 2], b = d[(E2 + 1) * 2 + 1]) : (m = d[0], b = d[1]), f = Cr(e, r, n, i, p, g, m, b), f.length !== 0 && l.push(f[0], f[1]);
      return l;
      ...
      for (var l = [], f, h = new Array(a.length), v = s / 2, d = o / 2, c = ci(s, o), y = 0; y < a.length / 4; y++) {
        ...
        var m = n + v * a[y * 4], b = i + d * a[y * 4 + 1], E2 = -a[p] * a[g] - a[p + 1] * a[g + 1], M = c / Math.tan(Math.acos(E2) / 2), L2 = m - M * a[p], w = b - M * a[p + 1], k = m + M * a[g], D = b + M * a[g + 1];
        y === 0 ? (h[a.length - 2] = L2, h[a.length - 1] = w) : (h[y * 4 - 2] = L2, h[y * 4 - 1] = w), h[y * 4] = k, h[y * 4 + 1] = D;
        var F = a[p + 1], G = -a[p], N = F * a[g] + G * a[g + 1];
        N < 0 && (F *= -1, G *= -1);
        var X = L2 + F * c, B2 = w + G * c;
        f = Pa(e, r, n, i, X, B2, c), f.length !== 0 && l.push(f[0], f[1]);
      }
      for (var re = 0; re < h.length / 4; re++)
        f = Cr(e, r, n, i, h[re * 4], h[re * 4 + 1], h[re * 4 + 2], h[re * 4 + 3], false), f.length !== 0 && l.push(f[0], f[1]);
      if (l.length > 2) {
      ...
      pageRank: function(e) {
        ...
        for (var E2 = 0; E2 < d; E2++) {
          var M = f[E2], L2 = M.data("source"), w = M.data("target");
          if (L2 !== w) {
            var k = l.indexOfId(L2), D = l.indexOfId(w), F = s(M), G = D * h + k;
            c[G] += F, y[k] += F;
          }
        }
      ...
      degreeCentrality: function(e) {
        ...
        if (i = r.collection(i)[0], o) {
          for (var d = i.connectedEdges(), c = d.filter(function(L2) {
            return L2.target().same(i) && a.has(L2);
          }), y = d.filter(function(L2) {
            return L2.source().same(i) && a.has(L2);
          }), p = c.length, g = y.length, m = 0, b = 0, E2 = 0; E2 < c.length; E2++)
            m += s(c[E2]);
    ...
    var Gf = At({
      ...
      betweennessCentrality: function(e) {
        ...
        for (var y = function(b) {
          for (var E2 = o[b].id(), M = [], L2 = {}, w = {}, k = {}, D = new Ra(function(we, De) {
            return k[we] - k[De];
          }), F = 0; F < o.length; F++) {
            var G = o[F].id();
            L2[G] = [], w[G] = 0, k[G] = 1 / 0;
          }
          for (w[E2] = 1, k[E2] = 0, D.push(E2); !D.empty(); ) {
            var N = D.pop();
            if (M.push(N), i)
              for (var X = 0; X < u[N].length; X++) {
                var B2 = u[N][X], re = s.getElementById(N), K = void 0;
                re.edgesTo(B2).length > 0 ? K = re.edgesTo(B2)[0] : K = B2.edgesTo(re)[0];
                var W = n(K);
                B2 = B2.id(), k[B2] > k[N] + W && (k[B2] = k[N] + W, D.nodes.indexOf(B2) < 0 ? D.push(B2) : D.updateItem(B2), w[B2] = 0, L2[B2] = []), k[B2] == k[N] + W && (w[B2] = w[B2] + w[N], L2[B2].push(N));
              }
            else
              for (var ae = 0; ae < u[N].length; ae++) {
                var ue = u[N][ae].id();
                k[ue] == 1 / 0 && (D.push(ue), k[ue] = k[N] + 1), k[ue] == k[N] + 1 && (w[ue] = w[ue] + w[N], L2[ue].push(N));
              }
          }
          for (var me = {}, ie = 0; ie < o.length; ie++)
            me[o[ie].id()] = 0;
          for (; M.length > 0; ) {
            for (var ge = M.pop(), Ee = 0; Ee < L2[ge].length; Ee++) {
              var Ce = L2[ge][Ee];
    ...
    var zf = At({
      ...
      for (var m = true, b = 0; m && b < i.maxIterations; )
        m = false, h = Yf(f, u, i.expandFactor), f = Hf(h, u, i.inflateFactor), Xf(f, h, l, 4) || (m = true), b++;
      var E2 = Wf(f, u, r, n);
      return E2 = Kf(E2), E2;
    }, Zf = {
      markovClustering: Ns,
    ...
    var eh = At({
        ...
        for (var v = 0; v < i.k; v++) {
          ...
          if (d.length !== 0) {
            for (var c = i.attributes.length, y = u[v], p = new Array(c), g = new Array(c), m = 0; m < c; m++) {
              ...
              p[m] = g[m] / d.length, th(p[m], y[m], i.sensitivityThreshold) || (l = true);
            }
      ...
      for (var h = true, v = 0; h && v < i.maxIterations; ) {
        for (var d = 0; d < a.length; d++)
        ...
        for (var c = 0; c < o.length; c++) {
          ...
          if (y.length !== 0) {
            ...
            for (var p = 0; p < y.length; p++)
              l = Fs(y[p], y, i.attributes), l < f[c] && (f[c] = l, o[c] = y[p], h = true);
            s[c] = r.collection(y);
          }
        }
        v++;
      ...
      for (var m = true, b = 0; m && b < n.maxIterations; )
        m = false, sh(s, a, o, l, n), oh(o, u, s, a, n), rh(o, u, n.sensitivityThreshold) || (m = true), b++;
      return i = lh(a, o, n, r), {
        clusters: i,
      ...
      for (var b = 0; b < e.length; b++) {
        var E2 = e[b].key;
        if (n[E2] === c.key || n[E2] === y.key) {
          for (var M = E2, L2 = 0; L2 < e.length; L2++) {
            var w = e[L2].key;
            a[E2][w] < a[E2][M] && (M = w);
          }
          n[E2] = M;
      ...
      return c.key = y.key = c.index = y.index = null, true;
    }, wn = function t(e, r, a) {
      ...
      for (var r = this.cy(), a = this.nodes(), n = vh(e), i = n.attributes, s = function(b, E2) {
      ...
      for (var m = 0; m < u; m++)
        v[m] = 0;
      for (var b = new Array(o), E2 = new Array(o), M = new Array(o), L2 = 0; L2 < o; L2++)
        b[L2] = 0, E2[L2] = 0, M[L2] = 0;
      for (var w = new Array(o * n.minIterations), k = 0; k < w.length; k++)
        w[k] = 0;
      var D;
      for (D = 0; D < n.maxIterations; D++) {
        for (var F = 0; F < o; F++) {
          for (var G = -1 / 0, N = -1 / 0, X = -1, B2 = 0, re = 0; re < o; re++)
            b[re] = h[F * o + re], B2 = v[F * o + re] + l[F * o + re], B2 >= G ? (N = G, G = B2, X = re) : B2 > N && (N = B2);
          for (var K = 0; K < o; K++)
        ...
        for (var W = 0; W < o; W++) {
          for (var ae = 0, ue = 0; ue < o; ue++)
            b[ue] = v[ue * o + W], E2[ue] = Math.max(0, h[ue * o + W]), ae += E2[ue];
          ae -= E2[W], E2[W] = h[W * o + W], ae += E2[W];
          for (var me = 0; me < o; me++)
            v[me * o + W] = (1 - n.damping) * Math.min(0, ae - E2[me]) + n.damping * b[me];
          v[W * o + W] = (1 - n.damping) * (ae - E2[W]) + n.damping * b[W];
        }
      ...
      for (var se = Eh(o, h, v), xe = wh(o, l, se), Le = {}, Se = 0; Se < se.length; Se++)
        Le[se[Se]] = [];
      for (var Oe2 = 0; Oe2 < a.length; Oe2++) {
        var Fe = i[a[Oe2].id()], Xe = xe[Fe];
        Xe != null && Le[Xe].push(a[Oe2]);
      }
      ...
      hierholzer: function(e) {
        ...
        var a = Th2(e), n = a.root, i = a.directed, s = this, o = false, u, l, f;
        n && (f = ee(n) ? this.filter(n)[0].id() : n[0].id());
        var h = {}, v = {};
        i ? s.forEach(function(m) {
          var b = m.id();
          if (m.isNode()) {
            var E2 = m.indegree(true), M = m.outdegree(true), L2 = E2 - M, w = M - E2;
            L2 == 1 ? u ? o = true : u = b : w == 1 ? l ? o = true : l = b : (w > 1 || L2 > 1) && (o = true), h[b] = [], m.outgoers().forEach(function(k) {
          ...
          var b = m.id();
          if (m.isNode()) {
            var E2 = m.degree(true);
            E2 % 2 && (u ? l ? o = true : l = b : u = b), h[b] = [], m.connectedEdges().forEach(function(M) {
        ...
        if (l && u)
          ...
          f || (f = s[0].id());
        var c = function(b) {
          for (var E2 = b, M = [b], L2, w, k; h[E2].length; )
            L2 = h[E2].shift(), w = v[L2][0], k = v[L2][1], E2 != k ? (h[k] = h[k].filter(function(D) {
              return D != L2;
            }), E2 = k) : !i && E2 != w && (h[w] = h[w].filter(function(D) {
              return D != L2;
            }), E2 = w), M.unshift(L2), M.unshift(E2);
          return M;
        }, y = [], p = [];
        ...
        for (var g in h)
          if (h[g].length)
            return d;
        return d.found = true, d.trail = this.spawn(y, true), d;
      }
    }, xn = function() {
      var e = this, r = {}, a = 0, n = 0, i = [], s = [], o = {}, u = function(v, d) {
        ...
        y.push(s.pop().edge), y.forEach(function(g) {
          ...
          p.merge(g), m.forEach(function(b) {
            var E2 = b.id(), M = b.connectedEdges().intersection(e);
            p.merge(b), r[E2].cutVertex ? p.merge(M.filter(function(L2) {
              return L2.isLoop();
            })) : p.merge(M);
          });
        }), i.push(p);
        ...
        if (y.size() === 0)
          ...
          y.forEach(function(E2) {
            p = E2.source().id(), g = E2.target().id(), m = p === d ? g : p, m !== c && (b = E2.id(), o[b] || (o[b] = true, s.push({
              x: d,
              y: m,
              edge: E2
            })), m in r ? r[d].low = Math.min(r[d].low, r[m].id) : (h(v, m, d), r[d].low = Math.min(r[d].low, r[m].low), r[d].id <= r[m].low && (r[d].cutVertex = true, u(d, m))));
          });
        }
      };
      ...
      var e = this, r = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function u(l) {
        ...
        if (f.forEach(function(y) {
          ...
          for (var h = e.spawn(); ; ) {
            var v = i.pop();
            if (h.merge(e.getElementById(v)), r[v].low = r[l].index, r[v].explored = true, v === l)
              break;
          }
    ...
    var Ah = {
      ...
      animation: function() {
        return function(r, a) {
          ...
          if (u && r.fit != null) {
            var b = r.fit, E2 = o.getFitViewport(b.eles || b.boundingBox, b.padding);
            E2 != null && (r.pan = E2.pan, r.zoom = E2.zoom);
          }
          if (u && S(r.zoom)) {
    ...
    function Mh(t, e) {
      if (Cn(t))
        return false;
      var r = typeof t;
      return r == "number" || r == "symbol" || r == "boolean" || t == null || Aa(t) ? true : Ih.test(t) || !Nh.test(t) || e != null && t in Object(e);
    }
    var Rh = Mh, kh2 = "[object AsyncFunction]", Ph = "[object Function]", Bh = "[object GeneratorFunction]", Fh = "[object Proxy]";
    function Gh(t) {
      if (!kr(t))
        return false;
      var e = is(t);
      return e == Ph || e == Bh || e == kh2 || e == Fh;
    }
    ...
    function Av(t) {
      ...
      if (r < 0)
        return false;
      var a = e.length - 1;
      return r == a ? e.pop() : Lv.call(e, r, 1), --this.size, true;
    }
    var Ov = Av;
    function Nv(t) {
      var e = this.__data__, r = Dn(e, t);
    ...
    var ro = sc, oc = 1 / 0, ao = Zr2 ? Zr2.prototype : void 0, no = ao ? ao.toString : void 0;
    function io(t) {
      if (typeof t == "string")
        return t;
      if (Cn(t))
      ...
      data: function(e) {
        ...
        return e = He({}, r, e), function(n, i) {
          ...
          if (ee(n)) {
            ...
            var b = n, E2, M, L2 = Object.keys(b);
            s.beforeSet(o, b);
            for (var w = 0; w < L2.length; w++) {
              E2 = L2[w], M = b[E2];
              var k = !s.immutableKeys[E2];
              if (k)
                for (var D = 0; D < l.length; D++) {
                  var F = l[D];
                  s.canSet(F) && (F._private[s.field][E2] = M);
                }
            }
            s.updateStyle && o.updateStyle(), s.onSet(o), s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent);
        ...
        return e = He({}, r, e), function(n) {
          ...
          if (ee(n)) {
            ...
            for (var p = 0, g = u.length; p < g; p++)
              for (var m = u[p]._private[i.field], b = Object.keys(m), E2 = 0; E2 < b.length; E2++) {
                var M = b[E2], L2 = !i.immutableKeys[M];
                L2 && (m[M] = void 0);
              }
            i.triggerEvent && s[i.triggerFnName](i.event);
          }
    ...
    var Gc = {
      ...
      classes: function(e) {
        ...
        for (var n = [], i = new Jr(e), s = 0; s < r.length; s++) {
          for (var o = r[s], u = o._private, l = u.classes, f = false, h = 0; h < e.length; h++) {
            var v = e[h], d = l.has(v);
            if (!d) {
              f = true;
              break;
      ...
      toggleClass: function(e, r) {
        ...
        for (var a = this, n = r === void 0, i = [], s = 0, o = a.length; s < o; s++)
          for (var u = a[s], l = u._private.classes, f = false, h = 0; h < e.length; h++) {
            var v = e[h], d = l.has(v), c = false;
            r || n && !d ? (l.add(v), c = true) : (!r || n && d) && (l.delete(v), c = true), !f && c && (i.push(u), f = true);
          }
    ...
    var pt = function() {
      ...
      populate: function(e, r) {
        if (e.currentSubject != null && e.currentSubject !== r)
          return vt("Redefinition of subject in selector `" + e.toString() + "`"), false;
        e.currentSubject = r;
    ...
    Ci2.forEach(function(t) {
      return t.regexObj = new RegExp("^" + t.regex);
    });
    var $c = function(e) {
      for (var r, a, n, i = 0; i < Ci2.length; i++) {
        var s = Ci2[i], o = s.name, u = e.match(s.regexObj);
        if (u != null) {
          a = u, r = s, n = o;
          var l = u[0];
      ...
      for (r.length = 1, a = _c(a); ; ) {
        var i = $c(a);
        if (i.expr == null)
          return vt("The selector `" + e + "`is invalid"), false;
      ...
      for (var l = 0; l < r.length; l++) {
        ...
        if (f.compoundCount > 0 && f.edgeCount > 0)
          return vt("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), false;
        if (f.edgeCount > 1)
          return vt("The selector `" + e + "` is invalid because it uses multiple edge selectors"), false;
      ...
      for (var e = function(f) {
        ...
        switch (v) {
          ...
          case ke.COMPOUND_SPLIT: {
            var L2 = i(f.left, h), w = i(f.subject, h), k = i(f.right, h);
            return L2 + (L2.length > 0 ? " " : "") + w + k;
          }
          case ke.TRUE:
            return "";
        }
      ...
      var n, i = ee(e), s = R(e), o = ee(a), u, l, f = false, h = false, v = false;
      switch (r.indexOf("!") >= 0 && (r = r.replace("!", ""), h = true), r.indexOf("@") >= 0 && (r = r.replace("@", ""), f = true), (i || o || f) && (u = !i && !s ? "" : "" + e, l = "" + a), f && (e = u = u.toLowerCase(), a = l = l.toLowerCase()), r) {
        case "*=":
          n = u.indexOf(l) >= 0;
          break;
        case "$=":
    ...
    tr = co = {
      ...
      silentShift: function(e, r) {
        return S(e) ? this.shift(e, true) : ee(e) && R(r) && this.shift(e, r, true), this;
      },
    ...
    va = Or = {}, Or.renderedBoundingBox = function(t) {
      ...
      function r(s) {
        ...
        function d(D, F, G) {
          var N = 0, X = 0, B2 = F + G;
          return D > 0 && B2 > 0 && (N = F / B2 * D, X = G / B2 * D), {
            biasDiff: N,
        ...
        var b = d(f.width.val - h.w, y, p), E2 = b.biasDiff, M = b.biasComplementDiff, L2 = d(f.height.val - h.h, g, m), w = L2.biasDiff, k = L2.biasComplementDiff;
        o.autoPadding = c(h.w, h.h, s.pstyle("padding"), s.pstyle("padding-relative-to").value), o.autoWidth = Math.max(h.w, f.width.val), v.x = (-E2 + h.x1 + h.x2 + M) / 2, o.autoHeight = Math.max(h.h, f.height.val), v.y = (-w + h.y1 + h.y2 + k) / 2;
      }
      for (var a = 0; a < this.length; a++) {
    ...
    var Qt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          var u = r.pstyle("text-halign"), l = r.pstyle("text-valign"), f = Ua(s, "labelWidth", a), h = Ua(s, "labelHeight", a), v = Ua(s, "labelX", a), d = Ua(s, "labelY", a), c = r.pstyle(n + "text-margin-x").pfValue, y = r.pstyle(n + "text-margin-y").pfValue, p = r.isEdge(), g = r.pstyle(n + "text-rotation"), m = r.pstyle("text-outline-width").pfValue, b = r.pstyle("text-border-width").pfValue, E2 = b / 2, M = r.pstyle("text-background-padding").pfValue, L2 = 2, w = h, k = f, D = k / 2, F = w / 2, G, N, X, B2;
          if (p)
            G = v - D, N = v + D, X = d - F, B2 = d + F;
          else {
            switch (u.value) {
              case "left":
                G = v - k, N = v;
          ...
          G += c - Math.max(m, E2) - M - L2, N += c + Math.max(m, E2) + M + L2, X += y - Math.max(m, E2) - M - L2, B2 += y + Math.max(m, E2) + M + L2;
          var re = a || "main", K = i.labelBounds, W = K[re] = K[re] || {};
          W.x1 = G, W.y1 = X, W.x2 = N, W.y2 = B2, W.w = N - G, W.h = B2 - X;
          var ae = p && g.strValue === "autorotate", ue = g.pfValue != null && g.pfValue !== 0;
          if (ae || ue) {
            var me = ae ? Ua(i.rstyle, "labelAngle", a) : g.pfValue, ie = Math.cos(me), ge = Math.sin(me), Ee = (G + N) / 2, Ce = (X + B2) / 2;
            if (!p) {
              switch (u.value) {
                case "left":
                  Ee = N;
            ...
            }, De = we(G, X), se = we(G, B2), xe = we(N, X), Le = we(N, B2);
            G = Math.min(De.x, se.x, xe.x, Le.x), N = Math.max(De.x, se.x, xe.x, Le.x), X = Math.min(De.y, se.y, xe.y, Le.y), B2 = Math.max(De.y, se.y, xe.y, Le.y);
          }
          var Se = re + "Rot", Oe2 = K[Se] = K[Se] || {};
          Oe2.x1 = G, Oe2.y1 = X, Oe2.x2 = N, Oe2.y2 = B2, Oe2.w = N - G, Oe2.h = B2 - X, rr(e, G, X, N, B2), rr(i.labelBounds.all, G, X, N, B2);
        }
        return e;
      }
    }, rd = function(e, r) {
      ...
      if (b) {
        var E2 = 0, M = 0;
        n && r.includeOverlays && (E2 = e.pstyle("overlay-opacity").value, E2 !== 0 && (M = e.pstyle("overlay-padding").value));
        var L2 = 0, w = 0;
        n && r.includeUnderlays && (L2 = e.pstyle("underlay-opacity").value, L2 !== 0 && (w = e.pstyle("underlay-padding").value));
        var k = Math.max(M, w), D = 0, F = 0;
        if (n && (D = e.pstyle("width").pfValue, F = D / 2), u && r.includeNodes) {
          var G = e.position();
          c = G.x, y = G.y;
          var N = e.outerWidth(), X = N / 2, B2 = e.outerHeight(), re = B2 / 2;
        ...
        if (n && r.includeEdges && l && (On(s, e, "mid-source"), On(s, e, "mid-target"), On(s, e, "source"), On(s, e, "target")), n) {
          ...
          if (Le) {
            var Se = e.pstyle("ghost-offset-x").pfValue, Oe2 = e.pstyle("ghost-offset-y").pfValue;
            rr(s, s.x1 + Se, s.y1 + Oe2, s.x2 + Se, s.y2 + Oe2);
          }
        }
    ...
    Or.boundingBox = function(t) {
      ...
      return e.silentPositions(o), a && (n.dirtyCompoundBoundsCache(), n.dirtyBoundingBoxCache(), n.updateCompoundBounds(true)), r.endBatch(), u;
      ...
      return this.emitting++, te(e) || (e = [e]), bd(this, function(i, s) {
        ...
        for (var o = function(f) {
          ...
          if (h.type === s.type && (!h.namespace || h.namespace === s.namespace || h.namespace === yd) && i.eventMatches(i.context, h, s)) {
            ...
            i.afterEmit(i.context, h, s), c === false && (s.stopPropagation(), s.preventDefault());
          }
        }, u = 0; u < n; u++)
          o(u);
    ...
    var Td = At({
      ...
      layoutPositions: function(e, r, a) {
        var n = this.nodes().filter(function(M) {
          return !M.isParent();
        }), i = this.cy(), s = r.eles, o = function(L2) {
          return L2.id();
        }, u = it(a, o);
        e.emit({
          type: "layoutstart",
        ...
        var l = function(L2, w, k) {
          ...
          if (!f)
            return null;
          for (var L2 = Yt(), w = 0; w < n.length; w++) {
            var k = n[w], D = u(k, w);
            Cf(L2, D.x, D.y);
          }
          return L2;
        }, v = h(), d = it(function(M, L2) {
          var w = u(M, L2);
          if (f) {
      ...
      return t = He({}, e, t), function(a) {
        for (var n = [], i = this.edges(), s = t, o = 0; o < i.length; o++)
          for (var u = i[o], l = u._private, f = l.source, h = f._private.data.id, v = l.data.target, d = f._private.edges, c = 0; c < d.length; c++) {
            var y = d[c], p = y._private.data, g = p.target, m = p.source, b = g === v && m === h, E2 = h === g && v === m;
            (s.codirected && b || !s.codirected && (b || E2)) && n.push(y);
          }
    ...
    var Nt = function(e, r) {
      ...
      this._private = {
        ...
        rebuildMap: function() {
          for (var b = this.lazyMap = new ur(), E2 = this.eles, M = 0; M < E2.length; M++) {
            var L2 = E2[M];
            b.set(L2.id(), {
              index: M,
              ele: L2
    ...
    mt.instanceString = function() {
      ...
      return new Nt(this._private.cy, this, true);
        ...
        if (S(t)) {
          if (r.startBatch(), t.data) {
            ...
            if (e.isEdge()) {
              ...
              o != null && o != n.source && (s.source = "" + o, i = true), u != null && u != n.target && (s.target = "" + u, i = true), i && (e = e.move(s));
            } else {
      ...
      for (var t = this.cy(), e = [], r = 0; r < this.length; r++) {
        var a = this[r], n = a.json(), i = new hn(t, n, false);
        e.push(i);
      }
      return new Nt(t, e);
    }, mt.copy = mt.clone, mt.restore = function() {
      for (var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, r = this, a = r.cy(), n = a._private, i = [], s = [], o, u = 0, l = r.length; u < l; u++) {
        var f = r[u];
      ...
      for (h = 0; h < o.length; h++) {
        ...
        if (d.isEdge()) {
          for (var m = d, b = ["source", "target"], E2 = b.length, M = false, L2 = 0; L2 < E2; L2++) {
            var w = b[L2], k = y[w];
            R(k) && (k = y[w] = "" + y[w]), k == null || k === "" ? (xt("Can not create edge `" + p + "` with unspecified " + w), M = true) : a.hasElementWithId(k) || (xt("Can not create edge `" + p + "` with nonexistant " + w + " `" + k + "`"), M = true);
          }
          if (M) {
            v();
            continue;
        ...
        c.map = new ur(), c.map.set(p, {
          ele: d,
          index: 0
        }), c.removed = false, e && a.addToPool(d);
      }
      for (var G = 0; G < i.length; G++) {
        var N = i[G], X = N._private.data;
        R(X.parent) && (X.parent = "" + X.parent);
        var B2 = X.parent, re = B2 != null;
        if (re || N._private.parent) {
          var K = N._private.parent ? a.collection().merge(N._private.parent) : a.getElementById(B2);
          if (K.empty())
            X.parent = void 0;
          else if (K[0].removed())
            vt("Node added with missing parent, reference to parent removed"), X.parent = void 0, N._private.parent = null;
          else {
            for (var W = false, ae = K; !ae.empty(); ) {
              if (N.same(ae)) {
                W = true, X.parent = void 0;
                break;
              }
              ae = ae.parent();
            }
            W || (K[0]._private.children.push(N), N._private.parent = K[0], n.hasCompoundNodes = true);
          }
        }
      }
      if (o.length > 0) {
      ...
      function s(B2) {
        for (var re = B2._private.edges, K = 0; K < re.length; K++)
          u(re[K]);
      }
      function o(B2) {
        for (var re = B2._private.children, K = 0; K < re.length; K++)
          u(re[K]);
      }
      function u(B2) {
        var re = n[B2.id()];
        e && B2.removed() || re || (n[B2.id()] = true, B2.isNode() ? (a.push(B2), s(B2), o(B2)) : a.unshift(B2));
      }
      ...
      function v(B2, re) {
        var K = B2._private.edges;
        xr(K, re), B2.clearTraversalCache();
      }
      function d(B2) {
        B2.clearTraversalCache();
      }
      var c = [];
      c.ids = {};
      function y(B2, re) {
        re = re[0], B2 = B2[0];
        var K = B2._private.children, W = B2.id();
        xr(K, re), re._private.parent = null, c.ids[W] || (c.ids[W] = true, c.push(B2));
      }
      ...
      for (var p = 0; p < a.length; p++) {
        ...
        if (g.isEdge()) {
          ...
          v(m, g), v(b, g);
          for (var E2 = g.parallelEdges(), M = 0; M < E2.length; M++) {
            var L2 = E2[M];
            d(L2), L2.isBundledBezier() && L2.dirtyBoundingBoxCache();
          }
        } else {
          var w = g.parent();
          w.length !== 0 && y(w, g);
      ...
      var e = this._private.cy, r = this, a = false, n = false, i = function(c) {
        return c == null ? c : "" + c;
      };
    ...
    function Od(t, e, r, a) {
      ...
      function E2(F, G, N) {
        var X, B2, re = 0;
        do
          B2 = G + (N - G) / 2, X = p(B2, t, r) - F, X > 0 ? N = B2 : G = B2;
      ...
      function M(F) {
        for (var G = 0, N = 1, X = u - 1; N !== X && v[N] <= F; ++N)
          G += l;
        --N;
        var B2 = (F - v[N]) / (v[N + 1] - v[N]), re = G + B2 * l, K = g(re, t, r);
        return K >= i ? m(F, re) : K === 0 ? re : E2(F, G, G + l);
      }
      var L2 = false;
      function w() {
        L2 = true, (t !== e || r !== a) && b();
      ...
      var k = function(G) {
        return L2 || w(), t === e && r === a ? G : G === 0 ? 0 : G === 1 ? 1 : p(M(G), e, a);
      };
    ...
    function Id(t, e, r, a) {
      ...
      if (s.duration === 0 ? p = 1 : p = (r - u) / s.duration, s.applying && (p = s.progress), p < 0 ? p = 0 : p > 1 && (p = 1), s.delay == null) {
        ...
        var E2 = s.startPan, M = s.pan, L2 = i.pan, w = M != null && a;
        w && (Xa(E2.x, M.x) && (L2.x = ga(E2.x, M.x, p, y)), Xa(E2.y, M.y) && (L2.y = ga(E2.y, M.y, p, y)), t.emit("pan"));
        ...
        if (G && G.length > 0 && n) {
          for (var N = 0; N < G.length; N++) {
            var X = G[N], B2 = X.name, re = X, K = s.startStyle[B2], W = f.properties[K.name], ae = ga(K, re, p, y, W);
            f.overrideBypass(t, B2, ae);
          }
          t.emit("style");
        }
      }
    ...
    function Xa(t, e) {
      return t == null || e == null ? false : R(t) && R(e) ? true : !!(t && e);
    }
    function Md(t, e, r, a) {
      var n = e._private;
    ...
    function _o(t, e) {
      ...
      function n(f, h) {
        var v = f._private, d = v.animation.current, c = v.animation.queue, y = false;
        if (d.length === 0) {
          var p = c.shift();
          p && d.push(p);
        }
        for (var g = function(L2) {
          for (var w = L2.length - 1; w >= 0; w--) {
            var k = L2[w];
            k();
          }
          L2.splice(0, L2.length);
        }, m = d.length - 1; m >= 0; m--) {
          var b = d[m], E2 = b._private;
          if (E2.stopped) {
            d.splice(m, 1), E2.hooked = false, E2.playing = false, E2.started = false, g(E2.frames);
            continue;
          }
          !E2.playing && !E2.applying || (E2.playing && E2.applying && (E2.applying = false), E2.started || Md(f, b, t), Id(f, b, t, h), E2.applying && (E2.applying = false), g(E2.frames), E2.step != null && E2.step(t), b.completed() && (d.splice(m, 1), E2.hooked = false, E2.playing = false, E2.started = false, g(E2.completes)), y = true);
        }
    ...
    Ft.apply = function(t) {
      ...
      for (var s = [], o = {}, u = 0; u < r.length; u++) {
        ...
        if (v || h && d) {
          ...
          for (var y = 0; y < c.length; y++) {
            for (var p = c[y], g = p.name, m = false, b = u + 1; b < r.length; b++) {
              var E2 = r[b], M = e[b] === Wa;
              if (M && (m = E2.properties[p.name] != null, m))
                break;
            }
            !o[g] && !m && (o[g] = true, s.push(g));
          }
        }
      }
      return a[n] = s, s;
      ...
      var e = t._private, r = this, a = r.propertyGroupNames, n = r.propertyGroupKeys, i = function(Oe2, Fe, Xe) {
        return r.getPropertiesHash(Oe2, Fe, Xe);
      }, s = e.styleKey;
      if (t.removed())
        return false;
      ...
      for (var h = function(Oe2, Fe) {
        return e.styleKeys[Fe][0] = Na(Oe2, e.styleKeys[Fe][0]);
      }, v = function(Oe2, Fe) {
        return e.styleKeys[Fe][1] = Ia(Oe2, e.styleKeys[Fe][1]);
      }, d = function(Oe2, Fe) {
        h(Oe2, Fe), v(Oe2, Fe);
      }, c = function(Oe2, Fe) {
        for (var Xe = 0; Xe < Oe2.length; Xe++) {
          var Ie = Oe2.charCodeAt(Xe);
          h(Ie, Fe), v(Ie, Fe);
        }
      }, y = 2e9, p = function(Oe2) {
        return -128 < Oe2 && Oe2 < 128 && Math.floor(Oe2) !== Oe2 ? y - (Oe2 * 1024 | 0) : Oe2;
      }, g = 0; g < a.length; g++) {
        var m = a[g], b = u[m];
        if (b != null) {
          var E2 = this.properties[m], M = E2.type, L2 = E2.groupKey, w = void 0;
          E2.hashOverride != null ? w = E2.hashOverride(t, b) : b.pfValue != null && (w = b.pfValue);
          var k = E2.enums == null ? b.value : null, D = w != null, F = k != null, G = D || F, N = b.units;
          if (M.number && G && !M.multiple) {
            var X = D ? w : k;
            d(p(X), L2), !D && N != null && c(N, L2);
          } else
            c(b.strValue, L2);
        }
      }
      for (var B2 = [Qr, Oa], re = 0; re < n.length; re++) {
        var K = n[re], W = e.styleKeys[K];
        B2[0] = Na(W[0], B2[0]), B2[1] = Ia(W[1], B2[1]);
      }
      e.styleKey = Uu(B2[0], B2[1]);
      var ae = e.styleKeys;
      ...
      e.value === "haystack" && (t.source().isParent() || t.target().isParent())) && (a = e = this.parse(e.name, "bezier", u)), a.delete)
        return n[a.name] = void 0, c(), true;
      if (a.deleteBypassed)
        return l ? l.bypass ? (l.bypassed = void 0, c(), true) : false : (c(), true);
      if (a.deleteBypass)
        return l ? l.bypass ? (n[a.name] = l.bypassed, c(), true) : false : (c(), true);
      var y = function() {
      ...
      switch (a.mapped) {
        case s.mapData: {
          ...
          if (R(g)) {
            ...
            M === 0 ? E2 = 0 : E2 = (g - a.fieldMin) / M;
          } else
            return vt("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + g + "` for `" + t.id() + "` is non-numeric)"), false;
          if (E2 < 0 ? E2 = 0 : E2 > 1 && (E2 = 1), o.color) {
            var L2 = a.valueMin[0], w = a.valueMax[0], k = a.valueMin[1], D = a.valueMax[1], F = a.valueMin[2], G = a.valueMax[2], N = a.valueMin[3] == null ? 1 : a.valueMin[3], X = a.valueMax[3] == null ? 1 : a.valueMax[3], B2 = [Math.round(L2 + (w - L2) * E2), Math.round(k + (D - k) * E2), Math.round(F + (G - F) * E2), Math.round(N + (X - N) * E2)];
            i = {
              ...
              name: a.name,
              value: B2,
              strValue: "rgb(" + B2[0] + ", " + B2[1] + ", " + B2[2] + ")"
            };
          } else if (o.number) {
            var re = a.valueMin + (a.valueMax - a.valueMin) * E2;
        ...
        case s.fn: {
          ...
          if (a.prevFnValue = ie, ie == null)
            return vt("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + t.id() + "` is null)"), false;
          if (i = this.parse(a.name, ie, a.bypass, v), !i)
            return vt("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + t.id() + "` is invalid)"), false;
          i.mapping = lr(a), a = i;
          break;
        }
        case void 0:
      ...
      return u ? (f ? a.bypassed = l.bypassed : a.bypassed = l, n[a.name] = a) : f ? l.bypassed = a : n[a.name] = a, c(), true;
      ...
      if (n.length > 0 && i > 0) {
        for (var o = {}, u = false, l = 0; l < n.length; l++) {
          var f = n[l], h = t.pstyle(f), v = e[f];
          if (v) {
            var d = v.prev, c = d, y = v.next != null ? v.next : h, p = false, g = void 0, m = 1e-6;
            c && (R(c.pfValue) && R(y.pfValue) ? (p = y.pfValue - c.pfValue, g = c.pfValue + m * p) : R(c.value) && R(y.value) ? (p = y.value - c.value, g = c.value + m * p) : te(c.value) && te(y.value) && (p = c.value[0] !== y.value[0] || c.value[1] !== y.value[1] || c.value[2] !== y.value[2], g = c.strValue), p && (o[f] = y.strValue, this.applyBypass(t, f, g), u = true));
          }
        }
        if (!u)
          return;
    ...
    qa.applyBypass = function(t, e, r, a) {
      ...
      if (e === "*" || e === "**") {
        if (r !== void 0)
          for (var o = 0; o < n.properties.length; o++) {
            var u = n.properties[o], l = u.name, f = this.parse(l, r, true);
            f && i.push(f);
          }
      } else if (ee(e)) {
      ...
      for (var m = false, b = 0; b < t.length; b++) {
        for (var E2 = t[b], M = {}, L2 = void 0, w = 0; w < i.length; w++) {
          var k = i[w];
          if (a) {
            var D = E2.pstyle(k.name);
            L2 = M[k.name] = {
              prev: D
            };
          }
          m = this.applyParsedProperty(E2, lr(k)) || m, a && (L2.next = E2.pstyle(k.name));
        }
        m && this.updateStyleHints(E2), a && this.updateTransitions(E2, M, s);
      }
      return m;
      ...
      for (var a = true, n = 0; n < t.length; n++) {
        for (var i = t[n], s = {}, o = 0; o < e.length; o++) {
          ...
          if (!(!f || !f.bypass)) {
            var h = "", v = this.parse(u, h, true), d = s[l.name] = {
              prev: f
            };
    ...
    fr.getRenderedStyle = function(t, e) {
      ...
      for (u = 0; u < e.length; u++)
        if (n = e[u], i = t.pstyle(n, false), i != null)
          if (i.pfValue != null)
    ...
    ki.appendFromString = function(t) {
      ...
      for (; ; ) {
        ...
        for (var y = []; ; ) {
          ...
          if (!g) {
            vt("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + d), c = true;
            break;
          }
          s = g[0];
          var m = g[1], b = g[2], E2 = e.properties[m];
          if (!E2) {
    ...
    (function() {
      ...
      var u = {
        zeroNonZero: function(Le, Se) {
          return (Le == null || Se == null) && Le !== Se || Le == 0 && Se != 0 ? true : Le != 0 && Se == 0;
        },
        any: function(Le, Se) {
          return Le != Se;
        },
        emptyNonEmpty: function(Le, Se) {
          var Oe2 = Re(Le), Fe = Re(Se);
          return Oe2 && !Fe || !Oe2 && Fe;
        }
      }, l = It.types, f = [{
        name: "label",
        type: l.text,
      ...
      for (var B2 = 1; B2 <= It.pieBackgroundN; B2++)
        X.push({
          name: "pie-" + B2 + "-background-color",
          type: l.color
        }), X.push({
          name: "pie-" + B2 + "-background-size",
          type: l.percent
        }), X.push({
          name: "pie-" + B2 + "-background-opacity",
          type: l.zeroOneNumber
        });
      ...
      [{
        ...
        K.forEach(function(Le) {
          var Se = Le + "-" + xe.name, Oe2 = xe.type, Fe = xe.triggersBounds;
          re.push({
            name: Se,
            type: Oe2,
            triggersBounds: Fe
      ...
      var W = It.properties = [].concat(y, b, p, g, m, G, c, d, f, h, v, M, L2, w, k, X, D, F, re, N), ae = It.propertyGroups = {
        // common to all eles
        behavior: y,
        transition: b,
        visibility: p,
    ...
    $n.parse = function(t, e, r, a) {
      ...
      var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, u = hs(t, o, s, i), l = n.propCache = n.propCache || [], f;
      ...
      if (l.multiple && a !== "multiple") {
        ...
        if (u ? b = e.split(/\s+/) : te(e) ? b = e : b = [e], l.evenMultiple && b.length % 2 !== 0)
          return null;
        for (var E2 = [], M = [], L2 = [], w = "", k = false, D = 0; D < b.length; D++) {
          var F = n.parse(t, b[D], r, "multiple");
          k = k || ee(F.value), E2.push(F.value), L2.push(F.pfValue != null ? F.pfValue : F.value), M.push(F.units), w += (D > 0 ? " " : "") + F.strValue;
        }
        return l.validate && !l.validate(E2, M) ? null : l.singleEnum && k ? E2.length === 1 && ee(E2[0]) ? {
          name: t,
          value: E2[0],
          strValue: E2[0],
          bypass: r
      ...
      if (l.number) {
        ...
        if (l.units && (N = l.units), l.implicitUnits && (X = l.implicitUnits), !l.unitless)
          if (u) {
            var B2 = "px|em" + (l.allowPercent ? "|\\%" : "");
            N && (B2 = N);
            var re = e.match("^(" + gt + ")(" + B2 + ")?$");
            re && (e = re[1], N = re[2] || X);
          } else
    ...
    }, [Ft, qa, Ri, fr, Un2, ki, It, $n].forEach(function(t) {
      He(zt, t);
    ...
    var Gd = {
      ...
      getZoomedViewport: function(e) {
        ...
        if (r.zoomingEnabled || (o = true), R(e) ? s = e : S(e) && (s = e.level, e.position != null ? i = vn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = true)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !R(s) || s === n || i != null && (!R(i.x) || !R(i.y)))
          return null;
        if (i != null) {
          var u = a, l = n, f = s, h = {
            x: -f / l * (i.x - u.x) + i.x,
      ...
      viewport: function(e) {
        ...
        if (!e)
          return this;
        if (R(e.zoom) || (a = false), S(e.pan) || (n = false), !a && !n)
          return this;
        if (a) {
          var u = e.zoom;
        ...
        if (n && (!s || !e.cancelOnFailedZoom) && r.panningEnabled) {
          var l = e.pan;
          R(l.x) && (r.pan.x = l.x, o = false), R(l.y) && (r.pan.y = l.y, o = false), o || i.push("pan");
        }
    ...
    var Za = function(e) {
      ...
      var v = function(c, y, p) {
        ...
        g.length > 0 && g.remove(), c != null && (S(c) || te(c)) && r.add(c), r.one("layoutready", function(b) {
          r.notifications(true), r.emit(b), r.one("load", y), r.emitAndNotify("load");
      ...
      f([o.style, o.elements], function(d) {
        ...
        l.styleEnabled && r.style().append(c), v(y, function() {
          r.startAnimationLoop(), l.ready = true, H(o.ready) && r.on("ready", o.ready);
    ...
    He(_n, {
      ...
      mount: function(e) {
        if (e != null) {
          ...
          return !ve(e) && ve(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = true, r.invalidateSize(), r.initRenderer(He({}, n, n.renderer, {
      ...
      json: function(e) {
        var r = this, a = r._private, n = r.mutableElements(), i = function(E2) {
          return r.getElementById(E2.id());
        };
        if (S(e)) {
          if (r.startBatch(), e.elements) {
            var s = {}, o = function(E2, M) {
              for (var L2 = [], w = [], k = 0; k < E2.length; k++) {
                var D = E2[k];
                if (!D.data.id) {
                ...
                s[F] = true, G.length !== 0 ? w.push({
                  ele: G,
                  json: D
                }) : (M && (D.group = M), L2.push(D));
              }
              r.add(L2);
              for (var N = 0; N < w.length; N++) {
                var X = w[N], B2 = X.ele, re = X.json;
                B2.json(re);
              }
            };
            if (te(e.elements))
          ...
          p ? g.elements = this.elements().map(function(b) {
            ...
            var E2 = b.group();
            g.elements[E2] || (g.elements[E2] = []), g.elements[E2].push(b.json());
    ...
    Xo.prototype.run = function() {
      ...
      if (pe(e.roots))
        ...
        for (var y = function(Me) {
          var Ue = c[Me], ze = Ue.maxDegree(false), Be = Ue.filter(function($e) {
            return $e.degree(false) === ze;
          });
          l = l.add(Be);
        }, p = 0; p < c.length; p++)
          y(p);
      ...
      var Oe2 = {
        ...
        if (We = Math.max(We, W), e.circle) {
          ...
          return ze === 0 && g[0].length === 1 && (he = 1), {
            x: Oe2.x + he * Math.cos(O),
            y: Oe2.y + he * Math.sin(O)
          };
        } else {
          var et = {
            x: Oe2.x + (Be + 1 - ($e + 1) / 2) * rt,
            y: (ze + 1) * je
          };
          return et;
        }
    ...
    Wo.prototype.run = function() {
      ...
      return a.nodes().layoutPositions(this, e, E2), this;
    };
    var _d = {
      fit: true,
      // whether to fit the viewport to the graph
    ...
    qo.prototype.run = function() {
      ...
      for (var p = e.levelWidth(i), g = [[]], m = g[0], b = 0; b < u.length; b++) {
        var E2 = u[b];
        if (m.length > 0) {
          var M = Math.abs(m[0].value - E2.value);
          M >= p && (m = [], g.push(m));
        }
        m.push(E2);
      }
      var L2 = l + e.minNodeSpacing;
      if (!e.avoidOverlap) {
        var w = g.length > 0 && g[0].length > 1, k = Math.min(s.w, s.h) / 2 - L2, D = k / (g.length + w ? 1 : 0);
        L2 = Math.min(L2, D);
      }
      for (var F = 0, G = 0; G < g.length; G++) {
        var N = g[G], X = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / N.length : e.sweep, B2 = N.dTheta = X / Math.max(1, N.length - 1);
        if (N.length > 1 && e.avoidOverlap) {
          var re = Math.cos(B2) - Math.cos(0), K = Math.sin(B2) - Math.sin(0), W = Math.sqrt(L2 * L2 / (re * re + K * K));
          F = Math.max(W, F);
        }
        N.r = F, F += L2;
      }
      ...
      for (var we = {}, De = 0; De < g.length; De++)
        for (var se = g[De], xe = se.dTheta, Le = se.r, Se = 0; Se < se.length; Se++) {
          var Oe2 = se[Se], Fe = e.startAngle + (r ? 1 : -1) * xe * Se, Xe = {
    ...
    var Hd = function(e, r, a) {
      ...
      for (var g = [], m = 0, b = -1, E2 = [], f = 0; f < o.nodeSize; f++) {
        var c = o.layoutNodes[f], M = c.parentId;
        M != null ? o.layoutNodes[o.idToIndex[M]].children.push(c.id) : (g[++b] = c.id, E2.push(c.id));
      }
      for (o.graphSet.push(E2); m <= b; ) {
        var L2 = g[m++], w = o.idToIndex[L2], d = o.layoutNodes[w], k = d.children;
        if (k.length > 0) {
          o.graphSet.push(k);
      ...
      for (var f = 0; f < o.edgeSize; f++) {
        ...
        var X = H(a.idealEdgeLength) ? a.idealEdgeLength(G) : a.idealEdgeLength, B2 = H(a.edgeElasticity) ? a.edgeElasticity(G) : a.edgeElasticity, re = o.idToIndex[N.sourceId], K = o.idToIndex[N.targetId], W = o.indexToGraph[re], ae = o.indexToGraph[K];
        if (W != ae) {
        ...
        N.idealLength = X, N.elasticity = B2, o.layoutEdges.push(N);
      }
      return o;
    }, Xd = function(e, r, a) {
      var n = Wd(e, r, 0, a);
      ...
      if (i.h === 0 || i.w === 0)
        ...
        if (e.condense && (m = 0, b = 0), e.avoidOverlap)
          for (var E2 = 0; E2 < n.length; E2++) {
            var M = n[E2], L2 = M._private.position;
            (L2.x == null || L2.y == null) && (L2.x = 0, L2.y = 0);
        ...
        var ge = function(Ce, we) {
          ...
          if (xe)
            ...
            for (; N(B2, re); )
              K();
            De = re * m + m / 2 + i.x1, se = B2 * b + b / 2 + i.y1, X(B2, re), K();
          }
          return {
            x: De,
            y: se
    ...
    Fi.arrowShapeWidth = 0.3, Fi.registerArrowShapes = function() {
      var t = this.arrowShapes = {}, e = this, r = function(l, f, h, v, d, c, y) {
        var p = d.x - h / 2 - y, g = d.x + h / 2 + y, m = d.y - h / 2 - y, b = d.y + h / 2 + y, E2 = p <= l && l <= g && m <= f && f <= b;
        return E2;
    ...
    $r.projectIntoViewport = function(t, e) {
      ...
      function m(w) {
        var k = w._private, D = k.rscratch, F = w.pstyle("width").pfValue, G = w.pstyle("arrow-scale").value, N = F / 2 + f, X = N * N, B2 = N * 2, ae = k.source, ue = k.target, re;
        if (D.edgeType === "segments" || D.edgeType === "straight" || D.edgeType === "haystack") {
          for (var K = D.allpts, W = 0; W + 3 < K.length; W += 2)
            if (Sf(t, e, K[W], K[W + 1], K[W + 2], K[W + 3], B2) && X > (re = If(t, e, K[W], K[W + 1], K[W + 2], K[W + 3])))
              return p(w, re), true;
          ...
          for (var K = D.allpts, W = 0; W + 5 < D.allpts.length; W += 4)
            if (Lf(t, e, K[W], K[W + 1], K[W + 2], K[W + 3], K[W + 4], K[W + 5], B2) && X > (re = Nf(t, e, K[W], K[W + 1], K[W + 2], K[W + 3], K[W + 4], K[W + 5])))
              return p(w, re), true;
        }
      ...
      function E2(w, k) {
        ...
        var N = D.labelBounds[k || "main"], X = w.pstyle(G + "label").value, B2 = w.pstyle("text-events").strValue === "yes";
        if (!(!B2 || !X)) {
          ...
          if (W) {
            ...
            }, se = De(me, ge), xe = De(me, Ee), Le = De(ie, ge), Se = De(ie, Ee), Oe2 = [
      ...
      for (var M = s.length - 1; M >= 0; M--) {
        var L2 = s[M];
        L2.isNode() ? g(L2) || E2(L2) : m(L2) || E2(L2) || E2(L2, "source") || E2(L2, "target");
      }
      return o;
      ...
      for (var f = Yt({
        ...
        if (v.isNode()) {
          ...
          if (g.edgeType === "bezier" || g.edgeType === "multibezier" || g.edgeType === "self" || g.edgeType === "compound" || g.edgeType === "segments" || g.edgeType === "haystack") {
            for (var m = p.rstyle.bezierPts || p.rstyle.linePts || p.rstyle.haystackPts, b = true, E2 = 0; E2 < m.length; E2++)
              if (!Df(f, m[E2])) {
                b = false;
                break;
              }
    ...
    Xn.calculateArrowAngles = function(t) {
      ...
      if (r && (g = (f + v) / 2, m = (h + d) / 2), u = v - f, l = d - h, i) {
        var c = e.allpts;
        if (c.length / 2 % 2 === 0) {
          var b = c.length / 2, E2 = b - 2;
          u = c[b] - c[E2], l = c[b + 1] - c[E2 + 1];
        } else {
          var b = c.length / 2 - 1, E2 = b - 2, M = b + 2;
          u = c[b] - c[E2], l = c[b + 1] - c[E2 + 1];
        }
      } else if (n || s || o) {
        var c = e.allpts, L2 = e.ctrlpts, w, k, D, F;
        if (L2.length / 2 % 2 === 0) {
      ...
      if (e.midsrcArrowAngle = cn(u, l), i)
        ...
        var c = e.allpts, B2 = c.length, y = Lt(c[B2 - 6], c[B2 - 4], c[B2 - 2], 0.9), p = Lt(c[B2 - 5], c[B2 - 3], c[B2 - 1], 0.9);
        u = v - y, l = d - p;
      } else
        u = v - g, l = d - m;
    ...
    Vt.findMidptPtsEtc = function(t, e) {
      var r = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = t.pstyle("source-endpoint"), o = t.pstyle("target-endpoint"), u = s.units != null && o.units != null, l = function(M, L2, w, k) {
        var D = k - L2, F = w - M, G = Math.sqrt(F * F + D * D);
        return {
          x: -D / G,
          y: F / G
        };
      ...
      for (var e = 0; e < t.length; e++) {
        ...
        n.haystackPts = n.allpts = [n.source.x * f * y + u.x, n.source.y * v * y + u.y, n.target.x * h * y + l.x, n.target.y * d * y + l.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = true, this.storeEdgeProjections(r), this.calculateArrowAngles(r), this.recalculateEdgeLabelProjections(r), this.calculateLabelAngles(r);
      }
      ...
      var p = 50, g = {
        ...
        x: Math.min(g.x, m.x),
        y: Math.min(g.y, m.y)
      }, E2 = 0.5, M = Math.max(E2, Math.log(o * 0.01)), L2 = Math.max(E2, Math.log(l * 0.01));
      n.ctrlpts = [b.x, b.y - (1 + Math.pow(p, 1.12) / 100) * y * (c / 3 + 1) * M, b.x - (1 + Math.pow(p, 1.12) / 100) * y * (c / 3 + 1) * L2, b.y];
      ...
      if (se && !me)
        if (K) {
          ...
          if (xe) {
            var Se = (f.x1 + f.x2) / 2, Oe2 = f.y1, Fe = f.y2;
            r.segpts = [Se, Oe2, Se, Fe];
          } else if (Le) {
      ...
      if (r.edgeType === "bezier") {
        ...
        if (d || c || M) {
          ...
          var X = {
            ...
            x: r.ctrlpts[0] - n.x,
            y: r.ctrlpts[1] - n.y
          }, B2 = Math.sqrt(X.x * X.x + X.y * X.y), re = {
            // normalised delta
            x: X.x / B2,
            y: X.y / B2
          }, K = Math.max(i, s), W = {
          ...
          M ? (r.ctrlpts[0] = r.ctrlpts[0] + re.x * (g - E2), r.ctrlpts[1] = r.ctrlpts[1] + re.y * (g - E2)) : (r.ctrlpts[0] = ae[0] + re.x * g, r.ctrlpts[1] = ae[1] + re.y * g);
        }
        L2 && this.findEndpoints(t);
      }
      ...
      if (!(!t || t.length === 0)) {
        for (var r = this, a = r.cy, n = a.hasCompoundNodes(), i = {
          ...
          if (!(l.removed() || !l.takesUpSpace())) {
            ...
            b == null && (b = {
              eles: []
            }, i.set(m, b), s.push(m)), b.eles.push(l), v && (b.hasUnbundled = true), d && (b.hasBezier = true);
          }
        }
        for (var E2 = function(w) {
          ...
          var N = D.eles[0], X = N.source(), B2 = N.target();
          if (X.poolIndex() > B2.poolIndex()) {
            var re = X;
            X = B2, B2 = re;
          }
          var K = D.srcPos = X.position(), W = D.tgtPos = B2.position(), ae = D.srcW = X.outerWidth(), ue = D.srcH = X.outerHeight(), me = D.tgtW = B2.outerWidth(), ie = D.tgtH = B2.outerHeight(), ge = D.srcShape = r.nodeShapes[e.getNodeShape(X)], Ee = D.tgtShape = r.nodeShapes[e.getNodeShape(B2)];
          D.dirCounts = {
            north: 0,
            west: 0,
            south: 0,
          ...
          for (var Ce = 0; Ce < D.eles.length; Ce++) {
            ...
            if (!D.calculatedIntersection && X !== B2 && (D.hasBezier || D.hasUnbundled)) {
              D.calculatedIntersection = true;
              var Se = ge.intersectLine(K.x, K.y, ae, ue, W.x, W.y, 0), Oe2 = D.srcIntn = Se, Fe = Ee.intersectLine(W.x, W.y, me, ie, K.x, K.y, 0), Xe = D.tgtIntn = Fe, Ie = D.intersectionPts = {
                x1: Se[0],
                x2: Fe[0],
                y1: Se[1],
                y2: Fe[1]
            ...
            var We = Le ? F : D;
            De.nodesOverlap = We.nodesOverlap, De.srcIntn = We.srcIntn, De.tgtIntn = We.tgtIntn, n && (X.isParent() || X.isChild() || B2.isParent() || B2.isChild()) && (X.parents().anySame(B2) || B2.parents().anySame(X) || X.same(B2) && X.isParent()) ? e.findCompoundLoopPoints(we, We, Ce, xe) : X === B2 ? e.findLoopPoints(we, We, Ce, xe) : se === "segments" ? e.findSegmentsPoints(we, We) : se === "taxi" ? e.findTaxiPoints(we, We) : se === "straight" || !xe && D.eles.length % 2 === 1 && Ce === Math.floor(D.eles.length / 2) ? e.findStraightEdgePoints(we) : e.findBezierPoints(we, We, Ce, xe, Le), e.findEndpoints(we), e.tryToCorrectInvalidPoints(we, We), e.checkForInvalidEdgeWarning(we), e.storeAllpts(we), e.storeEdgeProjections(we), e.calculateArrowAngles(we), e.recalculateEdgeLabelProjections(we), e.calculateLabelAngles(we);
          }
        }, M = 0; M < s.length; M++)
          E2(M);
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (D === "inside-to-node")
        ...
        if (se.length > 0) {
          var xe = i, Le = Fr(xe, jr(r)), Se = Fr(xe, jr(se)), Oe2 = Le;
          if (Se < Le && (r = se, Oe2 = Se), se.length > 2) {
            var Fe = Fr(xe, {
              x: se[2],
              y: se[3]
            });
      ...
      v.startX = be[0], v.startY = be[1], v.arrowStartX = _e[0], v.arrowStartY = _e[1], E2 && (!R(v.startX) || !R(v.startY) || !R(v.endX) || !R(v.endY) ? v.badLine = true : v.badLine = false);
      ...
      if (i.mid || i.source || i.target) {
        ...
        var u = function f() {
          ...
          function m(w, k, D, F, G) {
            var N = Br(k, D), X = w.segments[w.segments.length - 1], B2 = {
              p0: k,
              p1: D,
              t0: F,
              t1: G,
            ...
            w.segments.push(B2), w.length += N;
          }
          for (var b = 0; b < h.length; b++) {
            var E2 = h[b], M = h[b - 1];
            M && (E2.startDist = M.startDist + M.length), m(E2, E2.p0, p[b * g], 0, n.bezierProjPcts[0]);
            for (var L2 = 0; L2 < g - 1; L2++)
              m(E2, p[b * g + L2], p[b * g + L2 + 1], n.bezierProjPcts[L2], n.bezierProjPcts[L2 + 1]);
            m(E2, p[b * g + g - 1], E2.p2, n.bezierProjPcts[g - 1], 1);
          }
          return f.cache = h;
        }, l = function(h) {
          var v, d = h === "source";
            ...
            switch (a.edgeType) {
              ...
              case "multibezier": {
                for (var y = u(), p, g = 0, m = 0, b = 0; b < y.length; b++) {
                  for (var E2 = y[d ? b : y.length - 1 - b], M = 0; M < E2.segments.length; M++) {
                    var L2 = E2.segments[d ? M : E2.segments.length - 1 - M], w = b === y.length - 1 && M === E2.segments.length - 1;
                    if (g = m, m += L2.length, m >= c || w) {
                      p = {
                        cp: E2,
                        segment: L2
                      };
              ...
              case "segments":
              case "haystack": {
                for (var X = 0, B2, re, K, W, ae = a.allpts.length, ue = 0; ue + 3 < ae && (d ? (K = {
                  x: a.allpts[ue],
                  y: a.allpts[ue + 1]
                }, W = {
                  x: a.allpts[ue + 2],
                  ...
                  x: a.allpts[ae - 4 - ue],
                  y: a.allpts[ae - 3 - ue]
                }), B2 = Br(K, W), re = X, X += B2, !(X >= c)); ue += 2)
                  ;
                var me = c - re, ie = me / B2;
...
`), h = t.pstyle("text-max-width").pfValue, v = t.pstyle("text-overflow-wrap").value, d = v === "anywhere", c = [], y = /[\s\u200b]+/, p = d ? "" : " ", g = 0; g < f.length; g++) {
          var m = f[g], b = this.calculateLabelDimensions(t, m), E2 = b.width;
          if (d) {
            var M = m.split("").join(l);
            m = M;
          }
          if (E2 > h) {
            for (var L2 = m.split(y), w = "", k = 0; k < L2.length; k++) {
              var D = L2[k], F = w.length === 0 ? D : w + p + D, G = this.calculateLabelDimensions(t, F), N = G.width;
...
`)), s("labelWrapKey", u);
        ...
        var X = t.pstyle("text-max-width").pfValue, B2 = "", re = "…", K = false;
        if (this.calculateLabelDimensions(t, n).width < X)
          return n;
        for (var W = 0; W < n.length; W++) {
          var ae = this.calculateLabelDimensions(t, B2 + n[W] + re).width;
          if (ae > X)
            break;
          B2 += n[W], W === n.length - 1 && (K = true);
        }
        return K || (B2 += re), B2;
      }
      return n;
...
`), g = 0; g < p.length; g++) {
        var m = p[g], b = v.measureText(m), E2 = Math.ceil(b.width), M = u;
        c = Math.max(E2, c), y += M;
      }
      return c += s, y += s, n[a] = {
        width: c,
    ...
    var ol = {}, ll = 28, ul = false;
    ol.getNodeShape = function(t) {
      var e = this, r = t.pstyle("shape").value;
      if (r === "cutrectangle" && (t.width() < ll || t.height() < ll))
        return ul || (vt("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), ul = true), "rectangle";
      if (t.isParent())
    ...
    Wn.registerCalculationListeners = function() {
      ...
      var n = function(s) {
        if (s) {
          ...
          for (var u = 0; u < e.length; u++) {
            ...
            l.isNode() && !f.cleanConnected && (a(l.connectedEdges()), f.cleanConnected = true);
          }
          if (o)
      ...
      if (!this.destroyed) {
        ...
        for (var i = 0; i < t.length; i++) {
          ...
          s.isEdge() && (!r(s.source()) || !r(s.target())) && (u.clean = false), !(e && u.clean || s.removed()) && s.pstyle("display").value !== "none" && (o.group === "nodes" ? n.push(s) : a.push(s), u.clean = true);
        }
        for (var l = 0; l < n.length; l++) {
    ...
    ya.registerBinding = function(t, e, r, a) {
      ...
      var t = this, e = t.cy.window(), r = function(O) {
        ...
        O[0]._private.grabbed = true;
      }, o = function(O) {
        O[0]._private.grabbed = false;
      }, u = function(O) {
        O[0]._private.rscratch.inDragLayer = true;
      }, l = function(O) {
        O[0]._private.rscratch.inDragLayer = false;
      }, f = function(O) {
        O[0]._private.rscratch.isGrabTarget = true;
      }, h = function(O) {
        O[0]._private.rscratch.isGrabTarget = false;
      }, v = function(O, oe) {
      ...
      }, b = typeof MutationObserver < "u", E2 = typeof ResizeObserver < "u";
      ...
      b && (t.styleObserver = new MutationObserver(M), t.styleObserver.observe(t.container, {
        attributes: true
      })), t.registerBinding(e, "resize", M), E2 && (t.resizeObserver = new ResizeObserver(M), t.resizeObserver.observe(t.container));
      var L2 = function(O, oe) {
        for (; O != null; )
          oe(O), O = O.parentNode;
      }, w = function() {
        t.invalidateContainerClientCoordsCache();
      };
      L2(t.container, function(he) {
      ...
      var k = function() {
        ...
        for (var oe = t.findContainerClientCoords(), Te = oe[0], ce = oe[1], ye = oe[2], _e = oe[3], be = O.touches ? O.touches : [O], Ge = false, Qe = 0; Qe < be.length; Qe++) {
          var ft = be[Qe];
        ...
        if (!Ge)
          return false;
        for (var qe = t.container, ot = O.target, Ke = ot.parentNode, Je = false; Ke; ) {
          if (Ke === qe) {
            Je = true;
            break;
          }
      ...
      t.registerBinding(t.container, "mousedown", function(O) {
        if (D(O)) {
          O.preventDefault(), m(), t.hoverData.capture = true, t.hoverData.which = O.which;
          var oe = t.cy, Te = [O.clientX, O.clientY], ce = t.projectIntoViewport(Te[0], Te[1]), ye = t.selection, _e = t.findNearestElements(ce[0], ce[1], true, false), be = _e[0], Ge = t.dragData.possibleDragElements;
          ...
          if (O.which == 3) {
            ...
            be ? (be.activate(), be.emit(ft), t.hoverData.down = be) : oe.emit(ft), t.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), t.hoverData.cxtDragged = false;
          } else if (O.which == 1) {
            be && be.activate();
            {
            ...
            a(be, ["mousedown", "tapstart", "vmousedown"], O, {
              ...
              x: ce[0],
              y: ce[1]
            }, t.redrawHint("select", true), t.redraw()) : be.pannable() && (ye[4] = 1), Qe();
          }
          ye[0] = ye[2] = ce[0], ye[1] = ye[3] = ce[1];
        }
      }, false), t.registerBinding(e, "mousemove", function(O) {
        var oe = t.hoverData.capture;
        if (!(!oe && !D(O))) {
          var Te = false, ce = t.cy, ye = ce.zoom(), _e = [O.clientX, O.clientY], be = t.projectIntoViewport(_e[0], _e[1]), Ge = t.hoverData.mdownPos, Qe = t.hoverData.mdownGPos, ft = t.selection, qe = null;
          !t.hoverData.draggingEles && !t.hoverData.dragging && !t.hoverData.selecting && (qe = t.findNearestElement(be[0], be[1], true, false));
          ...
          var xa = function() {
            ...
            }), ft[4] = 1, t.hoverData.selecting = true, t.redrawHint("select", true), t.redraw();
          };
          if (t.hoverData.which === 3) {
            if (Rt) {
              ...
              Ke ? Ke.emit(Xr) : ce.emit(Xr), t.hoverData.cxtDragged = true, (!t.hoverData.cxtOver || qe !== t.hoverData.cxtOver) && (t.hoverData.cxtOver && t.hoverData.cxtOver.emit({
                originalEvent: O,
                type: "cxtdragout",
                position: {
                  x: be[0],
            ...
            if (Te = true, ce.panningEnabled() && ce.userPanningEnabled()) {
              var Ta;
              if (t.hoverData.justStartedPan) {
                var Jn2 = t.hoverData.mdownPos;
                Ta = {
                  x: (be[0] - Jn2[0]) * ye,
                  y: (be[1] - Jn2[1]) * ye
              ...
              ce.panBy(Ta), ce.emit("dragpan"), t.hoverData.dragged = true;
            }
            ...
            if (Rt) {
              if (!t.hoverData.dragging && ce.boxSelectionEnabled() && (Er || !ce.panningEnabled() || !ce.userPanningEnabled()))
                ...
                Wr && (t.hoverData.dragging = true, t.hoverData.justStartedPan = true, ft[4] = 0, t.data.bgActivePosistion = jr(Ge), t.redrawHint("select", true), t.redraw());
              }
            ...
            if (Ke && Ke.pannable() && Ke.active() && Ke.unactivate(), (!Ke || !Ke.grabbed()) && qe != ot && (ot && a(ot, ["mouseout", "tapdragout"], O, {
              ...
              if (Rt) {
                if (ce.boxSelectionEnabled() && Er)
                  ...
                  Xt && t.redrawHint("eles", true), t.dragData.didDrag = true, t.hoverData.draggingEles || c(Ct, {
                    inDragLayer: true
                  });
                  var Ut = {
                    x: 0,
                  ...
                  t.hoverData.draggingEles = true, Ct.silentShift(Ut).emit("position drag"), t.redrawHint("drag", true), t.redraw();
                }
              } else
                Rr();
            Te = true;
          ...
          if (ft[2] = be[0], ft[3] = be[1], Te)
            return O.stopPropagation && O.stopPropagation(), O.preventDefault && O.preventDefault(), false;
        }
      }, false);
      var F, G, N;
      t.registerBinding(e, "mouseup", function(O) {
        ...
        if (oe) {
          ...
          var Te = t.cy, ce = t.projectIntoViewport(O.clientX, O.clientY), ye = t.selection, _e = t.findNearestElement(ce[0], ce[1], true, false), be = t.dragData.possibleDragElements, Ge = t.hoverData.down, Qe = n(O);
          if (t.data.bgActivePosistion && (t.redrawHint("select", true), t.redraw()), t.hoverData.tapholdCancelled = true, t.data.bgActivePosistion = void 0, Ge && Ge.unactivate(), t.hoverData.which === 3) {
            var ft = {
              originalEvent: O,
              type: "cxttapend",
              position: {
            ...
            !t.hoverData.isOverThresholdDrag && (a(Ge, ["click", "tap", "vclick"], O, {
              x: ce[0],
              y: ce[1]
            }), G = false, O.timeStamp - N <= Te.multiClickDebounceTime() ? (F && clearTimeout(F), G = true, N = null, a(Ge, ["dblclick", "dbltap", "vdblclick"], O, {
              x: ce[0],
              y: ce[1]
            ...
            }, Te.multiClickDebounceTime()), N = O.timeStamp)), Ge == null && !t.dragData.didDrag && !t.hoverData.selecting && !t.hoverData.dragged && !n(O) && (Te.$(r).unselect(["tapunselect"]), be.length > 0 && t.redrawHint("eles", true), t.dragData.possibleDragElements = be = Te.collection()), _e == Ge && !t.dragData.didDrag && !t.hoverData.selecting && _e != null && _e._private.selectable && (t.hoverData.dragging || (Te.selectionType() === "additive" || Qe ? _e.selected() ? _e.unselect(["tapunselect"]) : _e.select(["tapselect"]) : Qe || (Te.$(r).unmerge(_e).unselect(["tapunselect"]), _e.select(["tapselect"]))), t.redrawHint("eles", true)), t.hoverData.selecting) {
              var ot = Te.collection(t.getAllInBox(ye[0], ye[1], ye[2], ye[3]));
              t.redrawHint("select", true), ot.length > 0 && t.redrawHint("eles", true), Te.emit({
                type: "boxend",
                originalEvent: O,
                position: {
                  x: ce[0],
            ...
            if (t.hoverData.dragging && (t.hoverData.dragging = false, t.redrawHint("select", true), t.redrawHint("eles", true), t.redraw()), !ye[4]) {
          ...
          ye[4] = 0, t.hoverData.down = null, t.hoverData.cxtStarted = false, t.hoverData.draggingEles = false, t.hoverData.selecting = false, t.hoverData.isOverThresholdDrag = false, t.dragData.didDrag = false, t.hoverData.dragged = false, t.hoverData.dragDelta = [], t.hoverData.mdownPos = null, t.hoverData.mdownGPos = null;
        }
      }, false);
      var X = function(O) {
        if (!t.scrollingPage) {
          ...
          if (oe.panningEnabled() && oe.userPanningEnabled() && oe.zoomingEnabled() && oe.userZoomingEnabled()) {
            O.preventDefault(), t.data.wheelZooming = true, clearTimeout(t.data.wheelTimeout), t.data.wheelTimeout = setTimeout(function() {
      ...
      t.registerBinding(t.container, "wheel", X, true), t.registerBinding(e, "scroll", function(O) {
        t.scrollingPage = true, clearTimeout(t.scrollingPageTimeout), t.scrollingPageTimeout = setTimeout(function() {
          t.scrollingPage = false;
        }, 250);
      }, true), t.registerBinding(t.container, "gesturestart", function(O) {
        t.gestureStartZoom = t.cy.zoom(), t.hasTouchStarted || O.preventDefault();
      }, true), t.registerBinding(t.container, "gesturechange", function(he) {
        t.hasTouchStarted || X(he);
      }, true), t.registerBinding(t.container, "mouseout", function(O) {
      ...
      }, false), t.registerBinding(t.container, "mouseover", function(O) {
        var oe = t.projectIntoViewport(O.clientX, O.clientY);
        t.cy.emit({
          originalEvent: O,
          type: "mouseover",
      ...
      var B2, re, K, W, ae, ue, me, ie, ge, Ee, Ce, we, De, se = function(O, oe, Te, ce) {
      ...
      t.registerBinding(t.container, "touchstart", Le = function(O) {
        if (t.hasTouchStarted = true, !!D(O)) {
          ...
          if (O.touches[1]) {
            ...
            ge = _e[0], Ee = _e[1], Ce = _e[2], we = _e[3], B2 = O.touches[0].clientX - ge, re = O.touches[0].clientY - Ee, K = O.touches[1].clientX - ge, W = O.touches[1].clientY - Ee, De = 0 <= B2 && B2 <= Ce && 0 <= K && K <= Ce && 0 <= re && re <= we && 0 <= W && W <= we;
            var be = oe.pan(), Ge = oe.zoom();
            ae = se(B2, re, K, W), ue = xe(B2, re, K, W), me = [(B2 + K) / 2, (re + W) / 2], ie = [(me[0] - be.x) / Ge, (me[1] - be.y) / Ge];
            var Qe = 200, ft = Qe * Qe;
            if (ue < ft && !O.touches[2]) {
              var qe = t.findNearestElement(Te[0], Te[1], true, true), ot = t.findNearestElement(Te[2], Te[3], true, true);
          ...
          if (O.touches[2])
            ...
            if (O.touches[0]) {
              var Ke = t.findNearestElements(Te[0], Te[1], true, true), Je = Ke[0];
              if (Je != null && (Je.activate(), t.touchData.start = Je, t.touchData.starts = Ke, t.nodeIsGrabbable(Je))) {
                ...
                t.redrawHint("eles", true), t.redrawHint("drag", true), Je.selected() ? (Rt = oe.$(function(_t) {
              ...
              a(Je, ["touchstart", "tapstart", "vmousedown"], O, {
                ...
                t.touchData.singleTouchMoved === false && !t.pinching && !t.touchData.selecting && a(t.touchData.start, ["taphold"], O, {
                  x: Te[0],
                  y: Te[1]
                });
              }, t.tapholdDuration);
      ...
      t.registerBinding(window, "touchmove", Se = function(O) {
        ...
        if (!(!oe && !D(O))) {
          ...
          if (oe && t.touchData.cxt) {
            O.preventDefault();
            var nr = O.touches[0].clientX - ge, kt = O.touches[0].clientY - Ee, Jt = O.touches[1].clientX - ge, _t = O.touches[1].clientY - Ee, Er = xe(nr, kt, Jt, _t), Rr = Er / ue, xa = 150, Xr = xa * xa, Ta = 1.5, Jn2 = Ta * Ta;
            if (Rr >= Jn2 || Er >= Xr) {
          ...
          if (oe && t.touchData.cxt) {
            ...
            t.data.bgActivePosistion = void 0, t.redrawHint("select", true), t.touchData.start ? t.touchData.start.emit(Wr) : ce.emit(Wr), t.touchData.start && (t.touchData.start._private.grabbed = false), t.touchData.cxtDragged = true;
            var Xt = t.findNearestElement(ye[0], ye[1], true, true);
            ...
            }), t.touchData.selecting = true, t.touchData.didSelect = true, Te[4] = 1, !Te || Te.length === 0 || Te[0] === void 0 ? (Te[0] = (ye[0] + ye[2] + ye[4]) / 3, Te[1] = (ye[1] + ye[3] + ye[5]) / 3, Te[2] = (ye[0] + ye[2] + ye[4]) / 3 + 1, Te[3] = (ye[1] + ye[3] + ye[5]) / 3 + 1) : (Te[2] = (ye[0] + ye[2] + ye[4]) / 3, Te[3] = (ye[1] + ye[3] + ye[5]) / 3), t.redrawHint("select", true), t.redraw();
            ...
            O.preventDefault(), t.data.bgActivePosistion = void 0, t.redrawHint("select", true);
            ...
            if (De) {
              var lp = nr - B2, up = kt - re, fp = Jt - K, hp = _t - W, vp = (lp + fp) / 2, cp = (up + hp) / 2, rn = ce.zoom(), Wi = rn * op, ei = ce.pan(), Fl = ie[0] * rn + ei.x, Gl = ie[1] * rn + ei.y, dp = {
                x: -Wi / rn * (Fl - ei.x - vp) + Fl,
                y: -Wi / rn * (Gl - ei.y - cp) + Gl
              };
              if (cr && cr.active()) {
                var Ut = t.dragData.touchDragEles;
                p(Ut), t.redrawHint("drag", true), t.redrawHint("eles", true), cr.unactivate().emit("freeon"), Ut.emit("free"), t.dragData.didDrag && (cr.emit("dragfreeon"), Ut.emit("dragfree"));
              }
              ce.viewport({
                zoom: Wi,
                pan: dp,
                cancelOnFailedZoom: true
              }), ce.emit("pinchzoom"), ae = Bl, B2 = nr, re = kt, K = Jt, W = _t, t.pinching = true;
            }
            if (O.touches[0]) {
              var Ge = t.projectIntoViewport(O.touches[0].clientX, O.touches[0].clientY);
              ye[0] = Ge[0], ye[1] = Ge[1];
            ...
            if (!t.hoverData.draggingEles && !t.swipePanning && (Xt = t.findNearestElement(ye[0], ye[1], true, true)), oe && ir != null && O.preventDefault(), oe && ir != null && t.nodeIsDraggable(ir))
              if (ft) {
                ...
                t.hoverData.draggingEles = true, Ut.silentShift(an).emit("position drag"), t.redrawHint("drag", true), t.touchData.startPosition[0] == _e[0] && t.touchData.startPosition[1] == _e[1] && t.redrawHint("eles", true), t.redraw();
              } else {
            ...
            if (a(ir || Xt, ["touchmove", "tapdrag", "vmousemove"], O, {
              ...
              for (var Wt = 0; Wt < ye.length; Wt++)
                ye[Wt] && t.touchData.startPosition[Wt] && ft && (t.touchData.singleTouchMoved = true);
            if (oe && (ir == null || ir.pannable()) && ce.panningEnabled() && ce.userPanningEnabled()) {
              ...
              gp && (O.preventDefault(), t.data.bgActivePosistion || (t.data.bgActivePosistion = jr(t.touchData.startPosition)), t.swipePanning ? (ce.panBy({
                x: qe[0] * be,
                y: qe[1] * be
              }), ce.emit("dragpan")) : ft && (t.swipePanning = true, ce.panBy({
                x: Ke * be,
                y: Ct * be
              }), ce.emit("dragpan"), ir && (ir.unactivate(), t.redrawHint("select", true), t.touchData.start = null)));
              var Ge = t.projectIntoViewport(O.touches[0].clientX, O.touches[0].clientY);
              ye[0] = Ge[0], ye[1] = Ge[1];
            }
          }
          for (var ot = 0; ot < ye.length; ot++)
            _e[ot] = ye[ot];
          oe && O.touches.length > 0 && !t.hoverData.draggingEles && !t.swipePanning && t.data.bgActivePosistion != null && (t.data.bgActivePosistion = void 0, t.redrawHint("select", true), t.redraw());
        }
      }, false);
      var Oe2;
      t.registerBinding(e, "touchcancel", Oe2 = function(O) {
        var oe = t.touchData.start;
        t.touchData.capture = false, oe && oe.unactivate();
      });
      var Fe, Xe, Ie, Me;
      if (t.registerBinding(e, "touchend", Fe = function(O) {
        var oe = t.touchData.start, Te = t.touchData.capture;
        if (Te)
          O.touches.length === 0 && (t.touchData.capture = false), O.preventDefault();
        else
          return;
        var ce = t.selection;
        ...
        if (!O.touches[2] && ye.boxSelectionEnabled() && t.touchData.selecting) {
          ...
          ce[0] = void 0, ce[1] = void 0, ce[2] = void 0, ce[3] = void 0, ce[4] = 0, t.redrawHint("select", true), ye.emit({
            type: "boxend",
            originalEvent: O,
            position: {
              x: be[0],
          ...
          ot.emit("box").stdFilter(Ke).select().emit("boxselect"), ot.nonempty() && t.redrawHint("eles", true), t.redraw();
        }
          ...
          if (!O.touches[0]) {
            if (!O.touches[0]) {
              ...
              if (oe != null) {
                ...
                p(Je), t.redrawHint("drag", true), t.redrawHint("eles", true), Ct && (oe.emit("freeon"), Je.emit("free"), t.dragData.didDrag && (oe.emit("dragfreeon"), Je.emit("dragfree"))), a(oe, ["touchend", "tapend", "vmouseup", "tapdragout"], O, {
                  x: be[0],
                  y: be[1]
                }), oe.unactivate(), t.touchData.start = null;
              } else {
                var Rt = t.findNearestElement(be[0], be[1], true, true);
              ...
              t.touchData.singleTouchMoved || (oe || ye.$(":selected").unselect(["tapunselect"]), a(oe, ["tap", "vclick"], O, {
                x: be[0],
                y: be[1]
              }), Xe = false, O.timeStamp - Me <= ye.multiClickDebounceTime() ? (Ie && clearTimeout(Ie), Xe = true, Me = null, a(oe, ["dbltap", "vdblclick"], O, {
                x: be[0],
                y: be[1]
              ...
              }, ye.multiClickDebounceTime()), Me = O.timeStamp)), oe != null && !t.dragData.didDrag && oe._private.selectable && Er < t.touchTapThreshold2 && !t.pinching && (ye.selectionType() === "single" ? (ye.$(r).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"])) : oe.selected() ? oe.unselect(["tapunselect"]) : oe.select(["tapselect"]), t.redrawHint("eles", true)), t.touchData.singleTouchMoved = true;
            }
          }
        }
        for (var Rr = 0; Rr < be.length; Rr++)
          Ge[Rr] = be[Rr];
        t.dragData.didDrag = false, O.touches.length === 0 && (t.touchData.dragDelta = [], t.touchData.startPosition = [null, null, null, null, null, null], t.touchData.startGPosition = null, t.touchData.didSelect = false), O.touches.length < 2 && (O.touches.length === 1 && (t.touchData.startGPosition = [O.touches[0].clientX, O.touches[0].clientY]), t.pinching = false, t.redrawHint("eles", true), t.redraw());
    ...
    mr.generatePolygon = function(t, e) {
      ...
      return this.nodeShapes.barrel = {
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          ...
          for (var h = this.generateBarrelBezierPts(n, i, s, o), v = function(w, k, D) {
            var F = D[4], G = D[2], N = D[0], X = D[5], B2 = D[1], re = Math.min(F, N), K = Math.max(F, N), W = Math.min(X, B2), ae = Math.max(X, B2);
            ...
            if (g != null) {
              var m = p[5], b = p[3], E2 = p[1], M = Lt(m, b, E2, g);
      ...
      return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
        ...
        intersectLine: function(e, r, a, n, i, s, o) {
          var u = e - (a / 2 + o), l = r - (n / 2 + o), f = l, h = e + (a / 2 + o), v = Cr(i, s, e, r, u, l, h, f, false);
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      if (!this.isVisible(t, v))
        return null;
      var d = u.get(t, a);
      if (d && d.invalidated && (d.invalidated = false, d.texture.invalidatedWidth -= d.width), d)
        return d;
      var c;
      ...
      }, b = n && n === ba.dequeue, E2 = n && n === ba.highQuality, M = n && n === ba.downscale, L2, w = a + 1; w <= Vi; w++) {
        var k = u.get(t, w);
        if (k) {
          L2 = k;
          break;
      ...
      var D = L2 && L2.level === a + 1 ? L2 : null, F = function() {
      ...
      if (p.context.setTransform(1, 0, 0, 1, 0, 0), p.context.clearRect(p.usedWidth, 0, h, c), m(D))
        ...
        if (E2) {
          for (var G = L2.level; G > a; G--)
            D = i.getElement(t, e, r, G, ba.downscale);
          F();
        } else
          return i.queueElement(t, L2.level - 1), L2;
      else {
        var N;
        if (!b && !E2 && !M)
        ...
        p.context.translate(p.usedWidth, 0), p.context.scale(l, l), this.drawElement(p.context, t, e, v, false), p.context.scale(1 / l, 1 / l), p.context.translate(-p.usedWidth, 0);
      }
      return d = {
        x: p.usedWidth,
        texture: p,
      ...
      for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
        var s = n[i];
        if (s.width >= e)
          return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, oi(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), xr(n, s), a.push(s), s;
      }
    ...
    var Ig = 1, en = -4, Qn = 2, Mg = 3.99, Rg = 50, kg = 50, Pg = 0.15, Bg = 0.1, Fg = 0.9, Gg = 0.9, zg = 1, pl = 250, Vg = 4e3 * 4e3, Ug = true, yl = function(e) {
      var r = this, a = r.renderer = e, n = a.cy;
      r.layersByLevel = {}, r.firstGet = true, r.lastInvalidationTime = gr() - 2 * pl, r.skipping = false, r.eleTxrDeqs = n.collection(), r.scheduleElementRefinement = on(function() {
        r.refineElementTextures(r.eleTxrDeqs), r.eleTxrDeqs.unmerge(r.eleTxrDeqs);
      }, kg), a.beforeRender(function(s, o) {
        o - r.lastInvalidationTime <= pl ? r.skipping = true : r.skipping = false;
    ...
    Mt.makeLayer = function(t, e) {
      ...
      if (a.skipping && !o)
        return null;
      for (var g = null, m = t.length / Ig, b = !o, E2 = 0; E2 < t.length; E2++) {
        var M = t[E2], L2 = M._private.rscratch, w = L2.imgLayerCaches = L2.imgLayerCaches || {}, k = w[r];
        if (k) {
          g = k;
          continue;
        }
      ...
      o.w === 0 || o.h === 0 || !e.visible() || (r = n.getEleLevelForLayerLevel(r, a), i.setImgSmoothing(s, false), i.drawCachedElement(s, e, null, null, r, Ug), i.setImgSmoothing(s, true));
      ...
      if (this.lastInvalidationTime = gr(), !t.invalid) {
        ...
        xr(a, t), t.elesQueue = [], t.invalid = true, t.replacement && (t.replacement.invalid = true);
    ...
    vr.drawElement = function(t, e, r, a, n, i) {
      ...
      if (!(l.w === 0 || l.h === 0)) {
        ...
        if (f != null) {
          ...
          if (h === 0)
            return;
          var v = s(u, e), d = l.x1, c = l.y1, y = l.w, p = l.h, g, m, b, E2, M;
          if (v !== 0) {
            var L2 = r.getRotationPoint(e);
            b = L2.x, E2 = L2.y, t.translate(b, E2), t.rotate(v), M = u.getImgSmoothing(t), M || u.setImgSmoothing(t, true);
            var w = r.getRotationOffset(e);
            g = w.x, m = w.y;
          } else
            g = d, m = c;
          var k;
          h !== 1 && (k = t.globalAlpha, t.globalAlpha = k * h), t.drawImage(f.texture.canvas, f.x, 0, f.width, f.height, g, m, y, p), h !== 1 && (t.globalAlpha = k), v !== 0 && (t.rotate(-v), t.translate(-b, -E2), M || u.setImgSmoothing(t, false));
        } else
          r.drawElement(t, e);
      }
    };
    ...
    vr.drawCachedElement = function(t, e, r, a, n, i) {
      var s = this, o = s.data, u = o.eleTxrCache, l = o.lblTxrCache, f = o.slbTxrCache, h = o.tlbTxrCache, v = e.boundingBox(), d = i === true ? u.reasons.highQuality : null;
    ...
    br.drawEdgeOverlay = xl("overlay"), br.drawEdgeUnderlay = xl("underlay"), br.drawEdgePath = function(t, e, r, a) {
      var n = t._private.rscratch, i = e, s, o = false, u = this.usePaths(), l = t.pstyle("line-dash-pattern").pfValue, f = t.pstyle("line-dash-offset").pfValue;
      if (u) {
        var h = r.join("$"), v = n.pathCacheKey && n.pathCacheKey === h;
        v ? (s = e = n.pathCache, o = true) : (s = e = new Path2D(), n.pathCacheKey = h, n.pathCache = s);
      }
      if (i.setLineDash)
        switch (a) {
          case "dotted":
      ...
      var l = this, f = this.usePaths() && n !== "triangle-cross", h = false, v, d = e, c = {
        x: s,
        y: o
      }, y = t.pstyle("arrow-scale").value, p = this.getArrowWidth(a, y), g = l.arrowShapes[n];
      if (f) {
        var m = l.arrowPathCache = l.arrowPathCache || [], b = Pr(n), E2 = m[b];
        E2 != null ? (v = e = E2, h = true) : (v = e = new Path2D(), m[b] = v);
      }
    ...
    $i.safeDrawImage = function(t, e, r, a, n, i, s, o, u, l) {
      ...
      if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? D = f(r, "background-width", "pfValue", a) * p : D = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? F = f(r, "background-height", "pfValue", a) * g : F = f(r, "background-height", "pfValue", a)), !(D === 0 || F === 0)) {
        ...
        var N = o - p / 2, X = f(r, "background-position-x", "units", a), B2 = f(r, "background-position-x", "pfValue", a);
        X === "%" ? N += (p - D) * B2 : N += B2;
        ...
        t.globalAlpha = M;
        var Ee = i.getImgSmoothing(t), Ce = false;
        if (L2 === "no" && Ee ? (i.setImgSmoothing(t, false), Ce = true) : L2 === "yes" && !Ee && (i.setImgSmoothing(t, true), Ce = true), v === "no-repeat")
          E2 && (t.save(), m.pathCache ? t.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(r)].draw(t, o, u, p, g), t.clip())), i.safeDrawImage(t, e, 0, 0, w, k, N, W, D, F), E2 && t.restore();
        else {
    ...
    _r.eleTextBiggerThanMin = function(t, e) {
      ...
      var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true, a = e.pstyle("font-style").strValue, n = e.pstyle("font-size").pfValue + "px", i = e.pstyle("font-family").strValue, s = e.pstyle("font-weight").strValue, o = r ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1, u = e.pstyle("text-outline-opacity").value * o, l = e.pstyle("color").value, f = e.pstyle("text-outline-color").value;
    ...
    _r.getTextAngle = function(t, e) {
      ...
      if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (v != null && v !== "" && !isNaN(u) && !isNaN(l)) {
          ...
          var d = r ? r + "-" : "", c = er(s, "labelWidth", r), y = er(s, "labelHeight", r), p = e.pstyle(d + "text-margin-x").pfValue, g = e.pstyle(d + "text-margin-y").pfValue, m = e.isEdge(), b = e.pstyle("text-halign").value, E2 = e.pstyle("text-valign").value;
          m && (b = "center", E2 = "center"), u += p, l += g;
          var M;
          switch (a ? M = this.getTextAngle(e, r) : M = 0, M !== 0 && (f = u, h = l, t.translate(f, h), t.rotate(M), u = 0, l = 0), E2) {
            case "top":
              break;
            case "center":
              l += y / 2;
          ...
          var L2 = e.pstyle("text-background-opacity").value, w = e.pstyle("text-border-opacity").value, k = e.pstyle("text-border-width").pfValue, D = e.pstyle("text-background-padding").pfValue, F = e.pstyle("text-background-shape").strValue, G = F.indexOf("round") === 0, N = 2;
          if (L2 > 0 || k > 0 && w > 0) {
            var X = u - D;
            switch (b) {
              case "left":
            ...
            var B2 = l - y - D, re = c + 2 * D, K = y + 2 * D;
            if (L2 > 0) {
              var W = t.fillStyle, ae = e.pstyle("text-background-color").value;
              t.fillStyle = "rgba(" + ae[0] + "," + ae[1] + "," + ae[2] + "," + L2 * o + ")", G ? _i(t, X, B2, re, K, N) : t.fillRect(X, B2, re, K), t.fillStyle = W;
            }
            if (k > 0 && w > 0) {
              ...
              if (G ? _i(t, X, B2, re, K, N, "stroke") : t.strokeRect(X, B2, re, K), ge === "double") {
                var Ee = k / 2;
                G ? _i(t, X + Ee, B2 + Ee, re - Ee * 2, K - Ee * 2, N, "stroke") : t.strokeRect(X + Ee, B2 + Ee, re - Ee * 2, K - Ee * 2);
              }
          ...
          if (Ce > 0 && (t.lineWidth = Ce), e.pstyle("text-wrap").value === "wrap") {
            ...
            switch (xe === "auto" || (b === "left" ? xe === "left" ? u += -c : xe === "center" && (u += -se) : b === "center" ? xe === "left" ? u += -se : xe === "right" && (u += se) : b === "right" && (xe === "center" ? u += se : xe === "right" && (u += c))), E2) {
              case "top":
                l -= (we.length - 1) * De;
                break;
              case "center":
    ...
    Ea.drawNode = function(t, e, r) {
      var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true, i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : true, s = this, o, u, l = e._private, f = l.rscratch, h = e.position();
      if (!(!R(h.x) || !R(h.y)) && !(i && !e.visible())) {
        var v = i ? e.effectiveOpacity() : 1, d = s.usePaths(), c, y = false, p = e.padding();
        o = e.width() + 2 * p, u = e.height() + 2 * p;
        var g;
        r && (g = r, t.translate(-g.x1, -g.y1));
        for (var m = e.pstyle("background-image"), b = m.value, E2 = new Array(b.length), M = new Array(b.length), L2 = 0, w = 0; w < b.length; w++) {
          var k = b[w], D = E2[w] = k != null && k !== "none";
          if (D) {
            var F = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", w);
            L2++, M[w] = s.getCachedImage(k, F, function() {
              l.backgroundTimestamp = Date.now(), e.emitAndNotify("background");
            });
          }
        }
        var G = e.pstyle("background-blacken").value, N = e.pstyle("border-width").pfValue, X = e.pstyle("background-opacity").value * v, B2 = e.pstyle("border-color").value, re = e.pstyle("border-style").value, K = e.pstyle("border-opacity").value * v, W = e.pstyle("outline-width").pfValue, ae = e.pstyle("outline-color").value, ue = e.pstyle("outline-style").value, me = e.pstyle("outline-opacity").value * v, ie = e.pstyle("outline-offset").value;
        t.lineJoin = "miter";
        var ge = function() {
          ...
          s.colorStrokeStyle(t, B2[0], B2[1], B2[2], he);
        }, Ce = function() {
          var he = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : me;
          s.colorStrokeStyle(t, ae[0], ae[1], ae[2], he);
        }, we = function(he, O, oe, Te) {
          var ce = s.nodePathCache = s.nodePathCache || [], ye = hs(oe === "polygon" ? oe + "," + Te.join(",") : oe, "" + O, "" + he), _e = ce[ye], be, Ge = false;
          return _e != null ? (be = _e, Ge = true, f.pathCache = be) : (be = new Path2D(), ce[ye] = f.pathCache = be), {
            path: be,
            cacheHit: Ge
          };
        ...
        var Le = function() {
          ...
          for (var he = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : v, O = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, oe = l.backgrounding, Te = 0, ce = 0; ce < M.length; ce++) {
            var ye = e.cy().style().getIndexedStyle(e, "background-image-containment", "value", ce);
            if (O && ye === "over" || !O && ye === "inside") {
              Te++;
              continue;
            }
            E2[ce] && M[ce].complete && !M[ce].error && (Te++, s.drawInscribedImage(t, M[ce], e, ce, he));
          }
          l.backgrounding = Te !== L2, oe !== l.backgrounding && e.updateStyle(false);
        }, Oe2 = function() {
          var he = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, O = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : v;
        ...
        if (Be) {
          ...
          t.translate($e, rt), Ce(), Ie(), ge(je * X), Le(), Se(We, true), Ee(je * K), Xe(), Oe2(G !== 0 || N !== 0), Se(We, false), Fe(We), t.translate(-$e, -rt);
        }
        d && t.translate(-h.x, -h.y), Ue(), d && t.translate(h.x, h.y), Ce(), Ie(), ge(), Le(), Se(v, true), Ee(), Xe(), Oe2(G !== 0 || N !== 0), Se(v, false), Fe(), d && t.translate(-h.x, -h.y), ze(), Me(), r && t.translate(g.x1, g.y1);
      }
    };
    var Tl = function(e) {
      if (!["overlay", "underlay"].includes(e))
    ...
    Ea.drawNodeOverlay = Tl("overlay"), Ea.drawNodeUnderlay = Tl("underlay"), Ea.hasPie = function(t) {
      ...
      for (var d = 1; d <= n.pieBackgroundN; d++) {
        ...
        g + h > 1 && (g = 1 - h);
        var m = 1.5 * Math.PI + 2 * Math.PI * h, b = 2 * Math.PI * g, E2 = m + b;
        c === 0 || h >= 1 || h + g > 1 || (t.beginPath(), t.moveTo(s, o), t.arc(s, o, f, m, E2), t.closePath(), this.colorFillStyle(t, y[0], y[1], y[2], p), t.fill(), h += g);
      }
    };
    var Kt = {}, Jg = 100;
    Kt.getPixelRatio = function() {
      ...
      if (a === "radial-gradient")
        ...
        var b = s ? {
          x: 0,
          y: 0
        } : r.position(), E2 = r.paddedWidth(), M = r.paddedHeight(), L2 = E2 / 2, w = M / 2, k = r.pstyle("background-gradient-direction").value;
        switch (k) {
          case "to-bottom":
          ...
          case "to-top":
            ...
            break;
          case "to-left":
            i = t.createLinearGradient(b.x + L2, b.y, b.x - L2, b.y);
            break;
          case "to-right":
            i = t.createLinearGradient(b.x - L2, b.y, b.x + L2, b.y);
            break;
          ...
          case "to-right-bottom":
            i = t.createLinearGradient(b.x - L2, b.y - w, b.x + L2, b.y + w);
            break;
          case "to-top-right":
          case "to-right-top":
            i = t.createLinearGradient(b.x - L2, b.y + w, b.x + L2, b.y - w);
      ...
      !D && !(y && !c) && (s.motionBlurPxRatio = 1), i && (L2 = i), E2 *= o, L2.x *= o, L2.y *= o;
      ...
      function N(Ie, Me) {
        ...
        !s.clearingMotionBlur && (Ie === l.bufferContexts[s.MOTIONBLUR_BUFFER_NODE] || Ie === l.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG]) ? (Ue = {
          x: M.x * d,
          y: M.y * d
        }, ze = b * d, Be = s.canvasWidth * d, $e = s.canvasHeight * d) : (Ue = L2, ze = E2, Be = s.canvasWidth, $e = s.canvasHeight), Ie.setTransform(1, 0, 0, 1, 0, 0), Me === "motionBlur" ? G(Ie, 0, 0, Be, $e) : !e && (Me === void 0 || Me) && Ie.clearRect(0, 0, Be, $e), r || (Ie.translate(Ue.x, Ue.y), Ie.scale(ze, ze)), i && Ie.translate(i.x, i.y), n && Ie.scale(n, n);
      }
      if (h || (s.textureDrawLastFrame = false), h) {
        ...
        var B2 = l.contexts[s.NODE], re = s.textureCache.texture, w = s.textureCache.viewport;
        B2.setTransform(1, 0, 0, 1, 0, 0), v ? G(B2, 0, 0, w.width, w.height) : B2.clearRect(0, 0, w.width, w.height);
        var K = m.core("outside-texture-bg-color").value, W = m.core("outside-texture-bg-opacity").value;
        s.colorFillStyle(B2, K[0], K[1], K[2], W), B2.fillRect(0, 0, w.width, w.height);
        var b = u.zoom();
        N(B2, false), B2.clearRect(w.mpan.x, w.mpan.y, w.width / w.zoom / o, w.height / w.zoom / o), B2.drawImage(re, w.mpan.x, w.mpan.y, w.width / w.zoom / o, w.height / w.zoom / o);
      } else
      ...
      if (ie[s.NODE] = !f[s.NODE] && v && !s.clearedForMotionBlur[s.NODE] || s.clearingMotionBlur, ie[s.NODE] && (s.clearedForMotionBlur[s.NODE] = true), ie[s.DRAG] = !f[s.DRAG] && v && !s.clearedForMotionBlur[s.DRAG] || s.clearingMotionBlur, ie[s.DRAG] && (s.clearedForMotionBlur[s.DRAG] = true), f[s.NODE] || r || a || ie[s.NODE]) {
        var ge = v && !ie[s.NODE] && d !== 1, B2 = e || (ge ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_NODE] : l.contexts[s.NODE]), Ee = v && !ge ? "motionBlur" : void 0;
        N(B2, Ee), me ? s.drawCachedNodes(B2, F.nondrag, o, ae) : s.drawLayeredElements(B2, F.nondrag, o, ae), s.debug && s.drawDebugPoints(B2, F.nondrag), !r && !v && (f[s.NODE] = false);
      }
      if (!a && (f[s.DRAG] || r || ie[s.DRAG])) {
        var ge = v && !ie[s.DRAG] && d !== 1, B2 = e || (ge ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG] : l.contexts[s.DRAG]);
        N(B2, v && !ge ? "motionBlur" : void 0), me ? s.drawCachedNodes(B2, F.drag, o, ae) : s.drawCachedElements(B2, F.drag, o, ae), s.debug && s.drawDebugPoints(B2, F.drag), !r && !v && (f[s.DRAG] = false);
      }
      if (s.showFps || !a && f[s.SELECT_BOX] && !r) {
        var B2 = e || l.contexts[s.SELECT_BOX];
        if (N(B2), s.selection[4] == 1 && (s.hoverData.selecting || s.touchData.selecting)) {
          var b = s.cy.zoom(), Ce = m.core("selection-box-border-width").value / b;
          B2.lineWidth = Ce, B2.fillStyle = "rgba(" + m.core("selection-box-color").value[0] + "," + m.core("selection-box-color").value[1] + "," + m.core("selection-box-color").value[2] + "," + m.core("selection-box-opacity").value + ")", B2.fillRect(s.selection[0], s.selection[1], s.selection[2] - s.selection[0], s.selection[3] - s.selection[1]), Ce > 0 && (B2.strokeStyle = "rgba(" + m.core("selection-box-border-color").value[0] + "," + m.core("selection-box-border-color").value[1] + "," + m.core("selection-box-border-color").value[2] + "," + m.core("selection-box-opacity").value + ")", B2.strokeRect(s.selection[0], s.selection[1], s.selection[2] - s.selection[0], s.selection[3] - s.selection[1]));
        }
        if (l.bgActivePosistion && !s.hoverData.selecting) {
          var b = s.cy.zoom(), we = l.bgActivePosistion;
          B2.fillStyle = "rgba(" + m.core("active-bg-color").value[0] + "," + m.core("active-bg-color").value[1] + "," + m.core("active-bg-color").value[2] + "," + m.core("active-bg-opacity").value + ")", B2.beginPath(), B2.arc(we.x, we.y, m.core("active-bg-size").pfValue / b, 0, 2 * Math.PI), B2.fill();
        }
        var De = s.lastRedrawTime;
        if (s.showFps && De) {
          De = Math.round(De);
          var se = Math.round(1e3 / De);
          B2.setTransform(1, 0, 0, 1, 0, 0), B2.fillStyle = "rgba(255, 0, 0, 0.75)", B2.strokeStyle = "rgba(255, 0, 0, 0.75)", B2.lineWidth = 1, B2.fillText("1 frame = " + De + " ms = " + se + " fps", 0, 20);
          var xe = 60;
          B2.strokeRect(0, 30, 250, 20), B2.fillRect(0, 30, 250 * Math.min(se / xe, 1), 20);
        }
        r || (f[s.SELECT_BOX] = false);
      }
      if (v && d !== 1) {
        var Le = l.contexts[s.NODE], Se = s.data.bufferCanvases[s.MOTIONBLUR_BUFFER_NODE], Oe2 = l.contexts[s.DRAG], Fe = s.data.bufferCanvases[s.MOTIONBLUR_BUFFER_DRAG], Xe = function(Me, Ue, ze) {
        ...
        (f[s.NODE] || ie[s.NODE]) && (Xe(Le, Se, ie[s.NODE]), f[s.NODE] = false), (f[s.DRAG] || ie[s.DRAG]) && (Xe(Oe2, Fe, ie[s.DRAG]), f[s.DRAG] = false);
      }
    ...
    function Nl(t) {
      ...
      for (var o = 0; o < ut.CANVAS_LAYERS; o++) {
        ...
        e.data.contexts[o] = u.getContext("2d"), Object.keys(s).forEach(function(De) {
          u.style[De] = s[De];
        }), u.style.position = "absolute", u.setAttribute("data-id", "layer" + o), u.style.zIndex = String(ut.CANVAS_LAYERS - o), e.data.canvasContainer.appendChild(u), e.data.canvasNeedsRedraw[o] = false;
      }
      ...
      }, g = function(se, xe, Le, Se, Oe2) {
        return e.drawElement(se, xe, Le, false, false, Oe2);
      }, m = function(se, xe, Le, Se, Oe2) {
        return e.drawElementText(se, xe, Le, Se, "main", Oe2);
      }, b = function(se, xe, Le, Se, Oe2) {
        return e.drawElementText(se, xe, Le, Se, "source", Oe2);
      }, E2 = function(se, xe, Le, Se, Oe2) {
        return e.drawElementText(se, xe, Le, Se, "target", Oe2);
      }, M = function(se) {
      ...
      return (
        ...
        function(_) {
          ...
          function Q(C) {
            ...
            return _[C].call(T.exports, T, T.exports, Q), T.l = true, T.exports;
          }
          ...
          function(_, fe, Q) {
            ...
            function I(Y, P, Z) {
              C.call(this, Z), this.isOverlapingSourceAndTarget = false, this.vGraphObject = Z, this.bendpoints = [], this.source = Y, this.target = P;
            }
          ...
          function(_, fe, Q) {
            ...
            P.prototype.getEdges = function() {
              ...
              if (this.getChild().getNodes().length != 0) {
                var A = this.getChild();
                if (A.updateBounds(true), this.rect.x = A.getLeft(), this.rect.y = A.getTop(), this.setWidth(A.getRight() - A.getLeft()), this.setHeight(A.getBottom() - A.getTop()), I.NODE_DIMENSIONS_INCLUDE_LABELS) {
          ...
          function(_, fe, Q) {
            ...
            function $(J, ne, le) {
              C.call(this, le), this.estimatedSize = T.MIN_VALUE, this.margin = x.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = J, ne != null && ne instanceof I ? this.graphManager = ne : ne != null && ne instanceof Layout && (this.graphManager = ne.graphManager);
            }
            ...
            $.prototype.getNodes = function() {
              ...
              if (ne == null && le == null) {
                ...
                return ne.owner != le.owner ? null : (ee.source = ne, ee.target = le, ee.isInterGraph = false, this.getEdges().push(ee), ne.edges.push(ee), le != ne && le.edges.push(ee), ee);
              }
              ...
              if (this.isConnected = false, le.size >= this.nodes.length) {
                var ve = 0;
          ...
          function(_, fe, Q) {
            ...
            x.prototype.addRoot = function() {
              ...
              if (Y == null && P == null && Z == null) {
                ...
                if (A == $)
                  return Y.isInterGraph = false, A.add(Y, P, Z);
                if (Y.isInterGraph = true, Y.source = P, Y.target = Z, this.edges.indexOf(Y) > -1)
          ...
          function(_, fe, Q) {
            ...
            T.calcSeparationAmount = function(x, I, z, Y) {
              ...
              if (x.intersects(I))
                return z[0] = Y, z[1] = P, z[2] = Z, z[3] = A, true;
              var $ = x.getX(), U = x.getY(), J = x.getRight(), ne = x.getX(), le = x.getBottom(), j = x.getRight(), ee = x.getWidthHalf(), H = x.getHeightHalf(), te = I.getX(), S = I.getY(), V = I.getRight(), R = I.getX(), q = I.getBottom(), ve = I.getRight(), pe = I.getWidthHalf(), Ae = I.getHeightHalf(), Ne = false, Ye = false;
              if (Y === Z) {
                if (P > A)
                  return z[0] = Y, z[1] = U, z[2] = Z, z[3] = q, false;
                if (P < A)
                  return z[0] = Y, z[1] = le, z[2] = Z, z[3] = S, false;
              } else if (P === A) {
                if (Y > Z)
                  return z[0] = $, z[1] = P, z[2] = V, z[3] = A, false;
                if (Y < Z)
                  return z[0] = J, z[1] = P, z[2] = te, z[3] = A, false;
              } else {
                var at = x.height / x.width, dt = I.height / I.width, Re = (A - P) / (Z - Y), Ve = void 0, Ze = void 0, nt = void 0, ht = void 0, it = void 0, tt = void 0;
                if (-at === Re ? Y > Z ? (z[0] = ne, z[1] = le, Ne = true) : (z[0] = J, z[1] = U, Ne = true) : at === Re && (Y > Z ? (z[0] = $, z[1] = U, Ne = true) : (z[0] = j, z[1] = le, Ne = true)), -dt === Re ? Z > Y ? (z[2] = R, z[3] = q, Ye = true) : (z[2] = V, z[3] = S, Ye = true) : dt === Re && (Z > Y ? (z[2] = te, z[3] = S, Ye = true) : (z[2] = ve, z[3] = q, Ye = true)), Ne && Ye)
                  return false;
          ...
          function(_, fe, Q) {
            var C = function() {
              function P(Z, A) {
                for (var $ = 0; $ < A.length; $++) {
                  var U = A[$];
                  U.enumerable = U.enumerable || false, U.configurable = true, "value" in U && (U.writable = true), Object.defineProperty(Z, U.key, U);
                }
              }
              return function(Z, A, $) {
          ...
          function(_, fe, Q) {
            ...
            function $(U) {
              A.call(this), this.layoutQuality = T.QUALITY, this.createBendsAsNeeded = T.DEFAULT_CREATE_BENDS_AS_NEEDED, this.incremental = T.DEFAULT_INCREMENTAL, this.animationOnLayout = T.DEFAULT_ANIMATION_ON_LAYOUT, this.animationDuringLayout = T.DEFAULT_ANIMATION_DURING_LAYOUT, this.animationPeriod = T.DEFAULT_ANIMATION_PERIOD, this.uniformLeafNodeSizes = T.DEFAULT_UNIFORM_LEAF_NODE_SIZES, this.edgeToDummyNodes = /* @__PURE__ */ new Map(), this.graphManager = new x(this), this.isLayoutFinished = false, this.isSubLayout = false, this.isRemoteUse = false, U != null && (this.isRemoteUse = U);
            }
            $.RANDOM_SEED = 1, $.prototype = Object.create(A.prototype), $.prototype.getGraphManager = function() {
              ...
              var U;
              return this.checkLayoutSuccess() ? U = false : U = this.layout(), T.ANIMATE === "during" ? false : (U && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, U);
              ...
              for (var U = [], J = true, ne = this.graphManager.getRoot().getNodes(), le = true, j = 0; j < ne.length; j++)
                ne[j].getChild() != null && (le = false);
              if (!le)
                return U;
              ...
              var J = [];
              J = J.concat(U);
              var ne = [], le = /* @__PURE__ */ new Map(), j = false, ee = null;
              ...
              for (V = V.concat(ne); !j; ) {
                ...
                ne = ne.concat(V), (J.length == 1 || J.length == 2) && (j = true, ee = J[0]);
              }
              return ee;
          ...
          function(_, fe, Q) {
            ...
            P.prototype.initParameters = function() {
              ...
              var A = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, $ = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, U, J, ne, le, j = this.getAllNodes(), ee;
            ...
            var C = function() {
              function z(Y, P) {
                for (var Z = 0; Z < P.length; Z++) {
                  var A = P[Z];
                  A.enumerable = A.enumerable || false, A.configurable = true, "value" in A && (A.writable = true), Object.defineProperty(Y, A.key, A);
                }
              }
          ...
          function(_, fe, Q) {
            var C = function() {
              function I(z, Y) {
                for (var P = 0; P < Y.length; P++) {
                  var Z = Y[P];
                  Z.enumerable = Z.enumerable || false, Z.configurable = true, "value" in Z && (Z.writable = true), Object.defineProperty(z, Z.key, Z);
                }
              }
              ...
              return C(I, [{
                ...
                value: function() {
                  for (var Y = 1; Y < this.jMax; Y++)
                    this.grid[0][Y] = this.grid[0][Y - 1] + this.gap_penalty, this.tracebackGrid[0][Y] = [false, false, true];
      ...
      return (
        ...
        function(fe) {
          ...
          function C(T) {
            ...
            return fe[T].call(x.exports, x, x.exports, C), x.l = true, x.exports;
          }
          ...
          function(fe, Q, C) {
            ...
            for (var I in T)
              x[I] = T[I];
            x.DEFAULT_USE_MULTI_LEVEL_SCALING = false, x.DEFAULT_RADIAL_SEPARATION = T.DEFAULT_EDGE_LENGTH, x.DEFAULT_COMPONENT_SEPERATION = 60, x.TILE = true, x.TILING_PADDING_VERTICAL = 10, x.TILING_PADDING_HORIZONTAL = 10, x.TREE_REDUCTION_ON_INCREMENTAL = false, fe.exports = x;
          },
          /* 2 */
          /***/
          function(fe, Q, C) {
          ...
          function(fe, Q, C) {
            ...
            H.prototype.newGraphManager = function() {
              ...
              return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(R, q), this.calcGravitationalForces(), this.moveNodes(), this.animate(), false;
              ...
              var R = S.getChild();
              if (R == null)
                return this.toBeTiled[V] = false, false;
              ...
              return this.toBeTiled[V] = true, true;
              ...
              for (var S = [], V = true, R; V; ) {
                var q = this.graphManager.getAllNodes(), ve = [];
                V = false;
                for (var pe = 0; pe < q.length; pe++)
                  R = q[pe], R.getEdges().length == 1 && !R.getEdges()[0].isInterGraph && R.getChild() == null && (ve.push([R, R.getEdges()[0], R.getOwner()]), V = true);
                if (V == true) {
        ...
        function(fe, Q, C) {
          ...
          U.prototype.run = function() {
            ...
            var Ye = function(Re, Ve) {
              ...
              for (var Re = function() {
                ee.fit && ee.cy.fit(ee.eles, ee.padding), le || (le = true, te.cy.one("layoutready", ee.ready), te.cy.trigger({ type: "layoutready", layout: te }));
              }, Ve = te.options.refresh, Ze, nt = 0; nt < Ve && !Ze; nt++)
                Ze = te.stopped || te.layout.tick();
              if (Ze) {
                H.checkLayoutSuccess() && !H.isSubLayout && H.doPostLayout(), H.tilingPostLayout && H.tilingPostLayout(), H.isLayoutFinished = true, te.options.eles.nodes().positions(Ye), Re(), te.cy.one("layoutstop", te.options.stop), te.cy.trigger({ type: "layoutstop", layout: te }), j && cancelAnimationFrame(j), le = false;
                return;
              }
            ...
            }), H.runLayout(), this.options.animate !== "during" && (te.options.eles.nodes().not(":parent").layoutPositions(te, te.options, Ye), le = false), this;
            ...
            for (var H = j.length, te = 0; te < H; te++) {
              ...
              if (S.outerWidth() != null && S.outerHeight() != null ? R = le.add(new Y(ee.graphManager, new P(S.position("x") - q.w / 2, S.position("y") - q.h / 2), new Z(parseFloat(q.w), parseFloat(q.h)))) : R = le.add(new Y(this.graphManager)), R.id = S.data("id"), R.paddingLeft = parseInt(S.css("padding")), R.paddingTop = parseInt(S.css("padding")), R.paddingRight = parseInt(S.css("padding")), R.paddingBottom = parseInt(S.css("padding")), this.options.nodeDimensionsIncludeLabels && S.isParent()) {
                var ve = S.boundingBox({ includeLabels: true, includeNodes: false }).w, pe = S.boundingBox({ includeLabels: true, includeNodes: false }).h, Ae = S.css("text-halign");
...
`);
  ...
  const Z = Y.node().getBBox(), [A] = Un(Q.fontSize);
...
function jp(de, Pe) {
  Pe.edges().map((_, fe) => {
    ...
    if (_[0]._private.bodyBounds) {
      ...
      L.trace("Edge: ", fe, Q), de.insert("path").attr(
        "d",
...
function ey(de, Pe) {
  return new Promise((_) => {
    const fe = Tt("body").append("div").attr("id", "cy").attr("style", "display:none"), Q = Hl({
...
function ty(de, Pe) {
  Pe.nodes().map((_, fe) => {
    ...
    L.info("Id:", fe, "Position: (", _.position().x, ", ", _.position().y, ")", Q), C.attr(
      "transform",
      `translate(${_.position().x - Q.width / 2}, ${_.position().y - Q.height / 2})`
    ), C.attr("attr", `apa-${fe})`);
  });
}
var ry = async (de, Pe, _, fe) => {
  var P, Z;
...
` + de);
  ...
  jp(I, Y), ty(Q, Y), A_(
    void 0,
    x,
    ((P = T.mindmap) == null ? void 0 : P.padding) ?? kp.mindmap.padding,
    ((Z = T.mindmap) == null ? void 0 : Z.useMaxWidth) ?? kp.mindmap.useMaxWidth
  );
};
var ay = {
  draw: ry
...
var ny = (de) => {
  ...
  for (let _ = 0; _ < de.THEME_COLOR_LIMIT; _++)
    de["lineColor" + _] = de["lineColor" + _] || de["cScaleInv" + _], Ci(de["lineColor" + _]) ? de["lineColor" + _] = B(de["lineColor" + _], 20) : de["lineColor" + _] = E(de["lineColor" + _], 20);
  for (let _ = 0; _ < de.THEME_COLOR_LIMIT; _++) {
    const fe = "" + (17 - 3 * _);
    Pe += `
...
mermaid/dist/mindmap-definition-f3352918.js:
  (*!
...
*/
//# sourceMappingURL=mindmap-definition-f3352918-7U42RVHM.js.map
