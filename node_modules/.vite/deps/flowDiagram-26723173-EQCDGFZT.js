import {
  ...
  ue,
  we
} from "./chunk-DJGPRMPB.js";
import "./chunk-RWXZCWB2.js";
import "./chunk-TALH7DKF.js";
import "./chunk-BUPAFUC6.js";
import {
  Xe,
  je
} from "./chunk-XFZNNMT4.js";
import "./chunk-JPMR5MLC.js";
import "./chunk-R2L7EZIU.js";
import {
  G,
  N,
  Yt,
...
// node_modules/mermaid/dist/flowDiagram-26723173.js
function Rt(r) {
  if (!r.ok)
...
function $t(r, e, t, n) {
  ...
  ee(s, t[n + "Style"]), t[n + "Class"] && s.attr("class", t[n + "Class"]);
}
function zt(r, e, t, n) {
...
function J(r, e, t) {
  ...
  e.labelType === "svg" ? Yt2(a, e) : typeof n != "string" || e.labelType === "html" ? te(a, e) : Ht(a, e);
...
var F = function(r, e) {
  ...
  var n;
  return t.exit ? n = t.exit() : n = t.selectAll(null), ue(n, e).style("opacity", 0).remove(), t;
};
function qt(r) {
  F = r;
}
...
var q = function(r, e, t) {
  ...
  return ue(s, e).style("opacity", 1), s.each(function(i) {
    var o = Tt(this), c = e.edge(i);
    c.elem = this, c.id && o.attr("id", c.id), be(
      o,
      c.class,
...
var Q = function(r, e, t) {
  ...
  a.exit().remove(), a.enter().append("g").attr("class", "node").style("opacity", 0), a = r.selectAll("g.node"), a.each(function(i) {
    ...
    o.elem = this, o.id && c.attr("id", o.id), o.labelId && d.attr("id", o.labelId), E(o, "width") && (h.width = o.width), E(o, "height") && (h.height = o.height), h.width += o.paddingLeft + o.paddingRight, h.height += o.paddingTop + o.paddingBottom, d.attr(
      "transform",
  ...
  var s;
  return a.exit ? s = a.exit() : s = a.selectAll(null), ue(s, e).style("opacity", 0).remove(), a;
};
function te2(r) {
  Q = r;
}
function ee2(r, e) {
  var t = r.filter(function() {
    return !Tt(this).classed("update");
  });
  function n(a) {
    var s = e.node(a);
    return "translate(" + s.x + "," + s.y + ")";
  }
  t.attr("transform", n), ue(r, e).style("opacity", 1).attr("transform", n), ue(t.selectAll("rect"), e).attr("width", function(a) {
...
function re(r, e) {
  ...
  t.attr("transform", n), ue(r, e).style("opacity", 1).attr("transform", n);
}
function ae(r, e) {
  var t = r.filter(function() {
    return !Tt(this).classed("update");
...
function he2() {
  var r = function(e, t) {
    ...
    Yt(t), ae(o, t), re(i, t), q(s, t, H);
    var c = X(a, t);
    ee2(c, t), ge(t);
  };
  return r.createNodes = function(e) {
    return arguments.length ? (te2(e), r) : Q;
...
function pe2(r) {
  r.nodes().forEach(function(e) {
    ...
    }), _e(t, ue2), m(["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"], function(n) {
      t[n] = Number(t[n]);
    }), E(t, "width") && (t._prevWidth = t.width), E(t, "height") && (t._prevHeight = t.height);
  }), r.edges().forEach(function(e) {
    var t = r.edge(e);
    E(t, "label") || (t.label = ""), _e(t, fe2);
  });
}
function ge(r) {
...
var kt = async function(r, e, t, n, a, s) {
  const i = n ? n.select(`[id="${t}"]`) : Tt(`[id="${t}"]`), o = a || document, c = Object.keys(r);
  for (const d of c) {
    const l = r[d];
    let g = "default";
    ...
    if (Da(Jn().flowchart.htmlLabels)) {
      ...
      p = te(i, y).node(), p.parentNode.removeChild(p);
    } else {
...
var St = async function(r, e, t) {
  let n = 0, a, s;
  if (r.defaultStyle !== void 0) {
    const i = O0(r.defaultStyle);
  ...
  for (const i of r) {
    ...
    l.style = g, l.labelStyle = h, i.interpolate !== void 0 ? l.curve = w0(i.interpolate, zf) : r.defaultInterpolate !== void 0 ? l.curve = w0(r.defaultInterpolate, zf) : l.curve = w0(bt.curve, zf), i.text === void 0 ? i.style !== void 0 && (l.arrowheadStyle = "fill: #333") : (l.arrowheadStyle = "fill: #333", l.labelpos = "c", Da(Jn().flowchart.htmlLabels) ? (l.labelType = "html", l.label = `<span id="L-${o}" class="edgeLabel L-${c}' L-${d}" style="${l.labelStyle}">${await Pd(
      i.text.replace(
        /fa[blrs]?:fa-[\w-]+/g,
        // cspell:disable-line
...
var be2 = async function(r, e, t, n) {
  L.info("Drawing flowchart");
  const { securityLevel: a, flowchart: s } = Jn();
  let i;
  a === "sandbox" && (i = Tt("#i" + e));
  const o = a === "sandbox" ? Tt(i.nodes()[0].contentDocument.body) : Tt("body"), c = a === "sandbox" ? i.nodes()[0].contentDocument : document;
  let d = n.db.getDirection();
  d === void 0 && (d = "TD");
  const l = s.nodeSpacing || 50, g = s.rankSpacing || 50, h = new Ze({
    multigraph: true,
    compound: true
  }).setGraph({
    rankdir: d,
  ...
  const k = new he2();
  we2.addToRender(k), k.arrows().none = function(b, L2, m2, B) {
    const C = b.append("marker").attr("id", L2).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("d", "M 0 0 L 0 0 L 0 0 z");
    ee(C, m2[B + "Style"]);
  }, k.arrows().normal = function(b, L2) {
    b.append("marker").attr("id", L2).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("class", "arrowheadPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  };
  ...
  for (k(_, h), _.selectAll("g.node").attr("title", function() {
    ...
    if (u = p[y], u.title !== "undefined") {
      ...
      ), L2 = w[0].x.baseVal.value, m2 = w[0].y.baseVal.value, B = w[0].width.baseVal.value, C = Tt(b[0]).select(".label");
      C.attr("transform", `translate(${L2 + B / 2}, ${m2 + 14})`), C.attr("id", e + "Text");
  ...
  if (!s.htmlLabels) {
    ...
    for (const b of w) {
      const L2 = b.getBBox(), m2 = c.createElementNS("http://www.w3.org/2000/svg", "rect");
      m2.setAttribute("rx", 0), m2.setAttribute("ry", 0), m2.setAttribute("width", L2.width), m2.setAttribute("height", L2.height), b.insertBefore(m2, b.firstChild);
    }
  }
  A_(h, I, s.diagramPadding, s.useMaxWidth), Object.keys(v).forEach(function(w) {
    const b = v[w];
    if (b.link) {
      const L2 = o.select("#" + e + ' [id="' + n.db.lookUpDomId(w) + '"]');
      if (L2) {
        const m2 = c.createElementNS("http://www.w3.org/2000/svg", "a");
        m2.setAttributeNS("http://www.w3.org/2000/svg", "class", b.classes.join(" ")), m2.setAttributeNS("http://www.w3.org/2000/svg", "href", b.link), m2.setAttributeNS("http://www.w3.org/2000/svg", "rel", "noopener"), a === "sandbox" ? m2.setAttributeNS("http://www.w3.org/2000/svg", "target", "_top") : b.linkTarget && m2.setAttributeNS("http://www.w3.org/2000/svg", "target", b.linkTarget);
        const B = L2.insert(function() {
          return m2;
        }, ":first-child"), P2 = L2.select(".label-container");
        P2 && B.append(function() {
          return P2.node();
        });
...
//# sourceMappingURL=flowDiagram-26723173-EQCDGFZT.js.map
