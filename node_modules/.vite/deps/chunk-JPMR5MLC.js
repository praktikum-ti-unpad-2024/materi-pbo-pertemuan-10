...
// node_modules/mermaid/dist/edges-d4a9e74e.js
var ht = (a, t, e, i) => {
  t.forEach((l) => {
    wt[l](a, e, i);
  });
...
function kt(a, t) {
  const e = Tt(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), i = e.append("xhtml:div"), l = a.label, r = a.isNode ? "nodeLabel" : "edgeLabel";
  return i.html(
    Oe(
...
var M = async (a, t, e, i) => {
  let l;
  const r = t.useHtmlLabels || Da(Jn().flowchart.htmlLabels);
  ...
  const o = n.node();
  let h;
  t.labelType === "markdown" ? h = Zr(n, Oe(Y0(c), Jn()), {
    useHtmlLabels: r,
    width: t.width || Jn().flowchart.wrappingWidth,
  ...
  let y = h.getBBox();
  const p = t.padding / 2;
  if (Da(Jn().flowchart.htmlLabels)) {
    const f = h.children[0], x = Tt(h), k = f.getElementsByTagName("img");
    if (k) {
          ...
          (u) => new Promise((S) => {
            function E() {
              if (u.style.display = "flex", u.style.flexDirection = "column", d) {
                const C = Jn().fontSize ? Jn().fontSize : window.getComputedStyle(document.body).fontSize, W = 5, A = parseInt(C, 10) * W + "px";
...
var Ct = async (a, t) => {
  t.useHtmlLabels || Jn().flowchart.htmlLabels || (t.centerLabel = true);
...
var K = (a) => a ? " " + a : "";
var _ = (a, t) => `${t || "node default"}${K(a.classes)} ${K(
  a.class
)}`;
var P2 = async (a, t) => {
...
var Nt = async (a, t) => {
  const { shapeSvg: e, bbox: i } = await M(a, t, void 0, true), l = 2, r = i.height + 2 * t.padding, s = r / l, n = i.width + 2 * s + t.padding, c = Rt(t.directions, i, t), o = I(e, n, r, c);
  return o.attr("style", t.style), m(t, o), t.intersect = function(h) {
    return w.polygon(t, c, h);
  }, e;
};
...
var Wt = async (a, t) => {
  const { shapeSvg: e, bbox: i } = await M(a, t, _(t), true), l = i.width + t.padding, r = i.height + t.padding, s = [
    { x: -2 * r / 6, y: 0 },
    { x: l - r / 6, y: 0 },
    { x: l + 2 * r / 6, y: -r },
    { x: r / 6, y: -r }
...
var Zt = async (a, t) => {
  const { shapeSvg: e } = await M(a, t, "label", true);
...
function q(a, t, e, i) {
  ...
  t.includes("t") ? (L.debug("add top border"), r(e)) : s(e), t.includes("r") ? (L.debug("add right border"), r(i)) : s(i), t.includes("b") ? (L.debug("add bottom border"), r(e)) : s(e), t.includes("l") ? (L.debug("add left border"), r(i)) : s(i), a.attr("stroke-dasharray", l.join(" "));
}
var Gt = (a, t) => {
  let e;
  ...
  const o = s.node().appendChild(R(c, t.labelStyle, true, true));
  let h = { width: 0, height: 0 };
  if (Da(Jn().flowchart.htmlLabels)) {
    const k = o.children[0], d = Tt(o);
  ...
  const f = s.node().appendChild(
    R(y.join ? y.join("<br/>") : y, t.labelStyle, true, true)
  );
  if (Da(Jn().flowchart.htmlLabels)) {
    const k = f.children[0], d = Tt(f);
    h = k.getBoundingClientRect(), d.attr("width", h.width), d.attr("height", h.height);
  }
  const x = t.padding / 2;
  return Tt(f).attr(
...
var Qt = async (a, t) => {
  ...
  return r.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", i.width / 2 + l).attr("width", i.width + t.padding).attr("height", i.height + t.padding), L.info("Circle main"), m(t, r), t.intersect = function(s) {
...
var Pt = (a, t) => {
  ...
  let f = 0;
  const x = t.classData.annotations && t.classData.annotations[0], k = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", d = p.node().appendChild(R(k, t.labelStyle, true, true));
  let u = d.getBBox();
  if (Da(Jn().flowchart.htmlLabels)) {
    const v = d.children[0], L2 = Tt(d);
    u = v.getBoundingClientRect(), L2.attr("width", u.width), L2.attr("height", u.height);
  }
  t.classData.annotations[0] && (y += u.height + i, h += u.width);
  let S = t.classData.label;
  t.classData.type !== void 0 && t.classData.type !== "" && (Jn().flowchart.htmlLabels ? S += "&lt;" + t.classData.type + "&gt;" : S += "<" + t.classData.type + ">");
  const E = p.node().appendChild(R(S, t.labelStyle, true, true));
  Tt(E).attr("class", "classTitle");
  let C = E.getBBox();
  if (Da(Jn().flowchart.htmlLabels)) {
    const v = E.children[0], L2 = Tt(E);
    C = v.getBoundingClientRect(), L2.attr("width", C.width), L2.attr("height", C.height);
  }
  y += C.height + i, C.width > h && (h = C.width);
  const W = [];
  t.classData.members.forEach((v) => {
    const L2 = v.getDisplayDetails();
    let X = L2.displayText;
    Jn().flowchart.htmlLabels && (X = X.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
    const N = p.node().appendChild(
      R(
        X,
        L2.cssStyle ? L2.cssStyle : t.labelStyle,
        true,
        true
      )
    );
  ...
  return Tt(E).attr(
    ...
    const L2 = v == null ? void 0 : v.getBBox();
    f += ((L2 == null ? void 0 : L2.height) ?? 0) + i;
...
var or = async (a, t, e) => {
  ...
  if (t.link) {
    let r;
    Jn().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), i = a.insert("svg:a").attr("xlink:href", t.link).attr("target", r), l = await rt[t.shape](i, t, e);
  } else
...
var xr = (a, t) => {
  const e = Da(Jn().flowchart.htmlLabels), i = t.labelType === "markdown" ? Zr(a, t.label, {
    style: t.labelStyle,
    useHtmlLabels: e,
...
function z(a, t) {
  Jn().flowchart.htmlLabels && a && (a.style.width = t.length * 9 + "px", a.style.height = "12px");
}
var gr = (a, t) => {
  L.debug("Moving label abc88 ", a.id, a.label, G[a.id], t);
  let e = t.updatedPath ? t.updatedPath : t.originalPath;
  const i = Jn(), { subGraphTitleTotalMargin: l } = tr(i);
  if (a.label) {
    const r = G[a.id];
    let s = a.x, n = a.y;
    if (e) {
      const c = oi.calcLabelPosition(e);
      L.debug(
  ...
  if (a.startLabelLeft) {
    ...
    let s = a.x, n = a.y;
    if (e) {
      const c = oi.calcTerminalLabelPosition(a.arrowTypeStart ? 10 : 0, "start_left", e);
      s = c.x, n = c.y;
    }
  ...
  if (a.startLabelRight) {
    ...
    let s = a.x, n = a.y;
    if (e) {
      const c = oi.calcTerminalLabelPosition(
  ...
  if (a.endLabelLeft) {
    ...
    let s = a.x, n = a.y;
    if (e) {
      const c = oi.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_left", e);
      s = c.x, n = c.y;
    }
    r.attr("transform", `translate(${s}, ${n})`);
  }
  if (a.endLabelRight) {
    ...
    let s = a.x, n = a.y;
    if (e) {
      const c = oi.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_right", e);
      s = c.x, n = c.y;
    }
    r.attr("transform", `translate(${s}, ${n})`);
  }
...
var ir = (a, t, e) => {
  ...
  if (Math.abs(l - t.y) * s > Math.abs(i - t.x) * c) {
    ...
    return n === 0 && (p.x = t.x, p.y = t.y), h === 0 && (p.x = t.x), o === 0 && (p.y = t.y), L.debug(`abc89 topp/bott calc, Q ${o}, q ${y}, R ${h}, r ${n}`, p), p;
  } else {
    e.x < t.x ? n = t.x - s - i : n = i - s - t.x;
    let y = o * n / h, p = e.x < t.x ? e.x + h - n : e.x - h + n, f = e.y < t.y ? e.y + y : e.y - y;
    return L.debug(`sides calc abc89, Q ${o}, q ${y}, R ${h}, r ${n}`, { _x: p, _y: f }), n === 0 && (p = t.x, f = t.y), h === 0 && (p = t.x), o === 0 && (f = t.y), { x: p, y: f };
  }
};
var et = (a, t) => {
  L.debug("abc88 cutPathAtIntersect", a, t);
  let e = [], i = a[0], l = false;
  return a.forEach((r) => {
    if (!sr(t, r) && !l) {
      const s = ir(t, i, r);
      ...
      e.forEach((c) => {
        n = n || c.x === s.x && c.y === s.y;
      }), e.some((c) => c.x === s.x && c.y === s.y) || e.push(s), l = true;
    } else
      i = r, l || e.push(r);
  }), e;
};
var ur = function(a, t, e, i, l, r, s) {
  let n = e.points;
  L.debug("abc88 InsertEdge: edge=", e, "e=", t);
  let c = false;
  const o = r.node(t.v);
  var h = r.node(t.w);
  h != null && h.intersect && (o != null && o.intersect) && (n = n.slice(1, e.points.length - 1), n.unshift(o.intersect(n[0])), n.push(h.intersect(n[n.length - 1]))), e.toCluster && (L.debug("to cluster abc88", i[e.toCluster]), n = et(e.points, i[e.toCluster].node), c = true), e.fromCluster && (L.debug("from cluster abc88", i[e.fromCluster]), n = et(n.reverse(), i[e.fromCluster].node).reverse(), c = true);
  const y = n.filter((C) => !Number.isNaN(C.y));
  let p = jf;
  e.curve && (l === "graph" || l === "flowchart") && (p = e.curve);
  const { x: f, y: x } = rr(e), k = P().x(f).y(x).curve(p);
  let d;
  switch (e.thickness) {
    case "normal":
  ...
  let S = "";
  (Jn().flowchart.arrowMarkerAbsolute || Jn().state.arrowMarkerAbsolute) && (S = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, S = S.replace(/\(/g, "\\("), S = S.replace(/\)/g, "\\)")), ar(u, e, S, s, l);
  let E = {};
...
//# sourceMappingURL=chunk-JPMR5MLC.js.map
