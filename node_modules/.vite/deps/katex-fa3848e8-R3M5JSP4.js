...
// node_modules/mermaid/dist/katex-fa3848e8.js
var u0 = class _u0 {
   ...
   */
  static range(e, t) {
    return t ? !e || !e.loc || !t.loc || e.loc.lexer !== t.loc.lexer ? null : new _u0(e.loc.lexer, e.loc.start, t.loc.end) : e && e.loc;
  }
};
var f0 = class _f0 {
   ...
   */
  range(e, t) {
    return new _f0(t, u0.range(this, e));
  }
};
var M = class _M {
  ...
  constructor(e, t) {
    ...
    var y = new Error(a);
    return y.name = "ParseError", y.__proto__ = _M.prototype, y.position = n, n != null && s != null && (y.length = s - n), y.rawMessage = e, y;
  }
};
...
var ba = /[&><"']/g;
function ya(r5) {
  return String(r5).replace(ba, (e) => ga[e]);
}
var pr = function r(e) {
...
var ze = {
  ...
  macros: {
    ...
    cliDefault: [],
    cliProcessor: (r5, e) => (e.push(r5), e)
  },
  minRuleThickness: {
    type: "number",
    description: "Specifies a minimum thickness, in ems, for fraction lines, `\\sqrt` top lines, `{array}` vertical lines, `\\hline`, `\\hdashline`, `\\underline`, `\\overline`, and the borders of `\\fbox`, `\\boxed`, and `\\fcolorbox`.",
    processor: (r5) => Math.max(0, r5),
  ...
  maxExpand: {
    ...
    processor: (r5) => Math.max(0, r5),
    cli: "-e, --max-expand <n>",
    cliProcessor: (r5) => r5 === "Infinity" ? 1 / 0 : parseInt(r5)
  },
  globalGroup: {
    type: "boolean",
    cli: false
...
var ee = 6;
var n0 = 7;
var y0 = [new O0(dt, 0, false), new O0(Te, 0, true), new O0(_0, 1, false), new O0(T0, 1, true), new O0(le, 2, false), new O0(d0, 2, true), new O0(ee, 3, false), new O0(n0, 3, true)];
var Ma = [le, d0, le, d0, ee, n0, ee, n0];
var za = [d0, d0, d0, d0, n0, n0, n0, n0];
var Aa = [_0, T0, le, d0, ee, n0, ee, n0];
var Ta = [T0, T0, d0, d0, n0, n0, n0, n0];
var Ba = [Te, Te, T0, T0, d0, d0, n0, n0];
var Da = [dt, Te, _0, T0, _0, T0, _0, T0];
var R = {
  DISPLAY: y0[dt],
  TEXT: y0[_0],
  SCRIPT: y0[le],
...
var Ae = [];
at.forEach((r5) => r5.blocks.forEach((e) => Ae.push(...e)));
function vr(r5) {
  for (var e = 0; e < Ae.length; e += 2)
    if (r5 >= Ae[e] && r5 <= Ae[e + 1])
      return true;
  return false;
}
var Q0 = 80;
...
function ft(r5, e, t) {
  ...
  var a = r5.charCodeAt(0), n = x0[e][a];
  if (!n && r5[0] in Ot && (a = Ot[r5[0]].charCodeAt(0), n = x0[e][a]), !n && t === "text" && vr(a) && (n = x0[e][77]), n)
    return {
      depth: n[0],
      height: n[1],
      italic: n[2],
...
var A0 = class _A0 {
  ...
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = Ht(_A0.BASESIZE, e);
    return this.size === t && this.textSize === _A0.BASESIZE && this.style === e ? this : this.extend({
      style: e,
      size: t
    });
  }
...
var p0 = class {
  ...
  toMarkup() {
    var e = false, t = "<span";
    this.classes.length && (e = true, t += ' class="', t += q.escape(L0(this.classes)), t += '"');
    var a = "";
    this.italic > 0 && (a += "margin-right:" + this.italic + "em;");
    for (var n in this.style)
      this.style.hasOwnProperty(n) && (a += q.hyphenate(n) + ":" + this.style[n] + ";");
    a && (e = true, t += ' style="' + q.escape(a) + '"');
...
var e1 = (r5, e) => {
  if (L0(r5.classes) !== L0(e.classes) || r5.skew !== e.skew || r5.maxFontSize !== e.maxFontSize)
    return false;
  ...
  for (var a in r5.style)
    if (r5.style.hasOwnProperty(a) && r5.style[a] !== e.style[a])
      return false;
  for (var n in e.style)
    if (e.style.hasOwnProperty(n) && r5.style[n] !== e.style[n])
      return false;
  return true;
};
var t1 = (r5) => {
  for (var e = 0; e < r5.length - 1; e++) {
    var t = r5[e], a = r5[e + 1];
    t instanceof p0 && a instanceof p0 && e1(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r5.splice(e + 1, 1), e--);
  }
  return r5;
};
var vt = function(e) {
...
var l0 = function(e, t, a, n) {
  var s = new he(e, t, a, n);
  return vt(s), s;
};
var kr = (r5, e, t, a) => new he(r5, e, t, a);
...
var C0 = b.makeSpan;
var m1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"];
var c1 = ["rightmost", "mrel", "mclose", "mpunct"];
var d1 = {
  display: R.DISPLAY,
  text: R.TEXT,
  script: R.SCRIPT,
  ...
  for (var s = [], o = [], h = 0; h < a.length; h++)
    if (o.push(a[h]), a[h].hasClass("mbin") || a[h].hasClass("mrel") || a[h].hasClass("allowbreak")) {
      for (var c = false; h < a.length - 1 && a[h + 1].hasClass("mspace") && !a[h + 1].hasClass("newline"); )
        h++, o.push(a[h]), a[h].hasClass("nobreak") && (c = true);
      c || (s.push(we(o, e)), o = []);
    } else
      a[h].hasClass("newline") && (o.pop(), o.length > 0 && (s.push(we(o, e)), o = []), s.push(a[h]));
  o.length > 0 && s.push(we(o, e));
  var p;
  t ? (p = we(t0(t, e, true)), p.classes = ["tag"], s.push(p)) : n && s.push(n);
...
var g1 = function(e, t, a) {
  var n = Dr(a), s;
  if (a.output === "mathml")
    return $t(e, t, n, a.displayMode, true);
  if (a.output === "html") {
    var o = ot(e, n);
...
function H(r5, e) {
  if (!r5 || r5.type !== e)
    throw new Error("Expected node of type " + e + ", but got " + (r5 ? "node of type " + r5.type : String(r5)));
  return r5;
}
function yt(r5) {
  var e = Re(r5);
  if (!e)
    throw new Error("Expected node of symbol group type, but got " + (r5 ? "node of type " + r5.type : String(r5)));
  return e;
}
function Re(r5) {
  return r5 && (r5.type === "atom" || Za.hasOwnProperty(r5.type)) ? r5 : null;
}
var xt = (r5, e) => {
  var t, a, n;
  r5 && r5.type === "supsub" ? (a = H(r5.base, "accent"), t = a.base, r5.base = t, n = Wa(P(r5, e)), r5.base = a) : (a = H(r5, "accent"), t = a.base);
...
var Nr = (r5, e) => {
  var t = r5.isStretchy ? N0.mathMLnode(r5.label) : new S.MathNode("mo", [v0(r5.label, r5.mode)]), a = new S.MathNode("mover", [X(r5.base, e), t]);
  return a.setAttribute("accent", "true"), a;
};
var z1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r5) => "\\" + r5).join("|"));
B({
  type: "accent",
  ...
  handler: (r5, e) => {
    var t = Ne(e[0]), a = !z1.test(r5.funcName), n = !a || r5.funcName === "\\widehat" || r5.funcName === "\\widetilde" || r5.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r5.parser.mode,
      label: r5.funcName,
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = P(r5.base, e), a = N0.svgSpan(r5, e), n = r5.label === "\\utilde" ? 0.12 : 0, s = b.makeVList({
      positionType: "top",
  ...
  mathmlBuilder: (r5, e) => {
    var t = N0.mathMLnode(r5.label), a = new S.MathNode("munder", [X(r5.base, e), t]);
    return a.setAttribute("accentunder", "true"), a;
  }
});
var ke = (r5) => {
  var e = new S.MathNode("mpadded", r5 ? [r5] : []);
...
B({
  ...
  htmlBuilder(r5, e) {
    var t = e.style, a = e.havingStyle(t.sup()), n = b.wrapFragment(P(r5.body, a, e), e), s = r5.label.slice(0, 2) === "\\x" ? "x" : "cd";
    n.classes.push(s + "-arrow-pad");
    var o;
    r5.below && (a = e.havingStyle(t.sub()), o = b.wrapFragment(P(r5.below, a, e), e), o.classes.push(s + "-arrow-pad"));
    var h = N0.svgSpan(r5, e), c = -e.fontMetrics().axisHeight + 0.5 * h.height, p = -e.fontMetrics().axisHeight - 0.5 * h.height - 0.111;
    (n.depth > 0.25 || r5.label === "\\xleftequilibrium") && (p -= n.depth);
    var g;
    if (o) {
...
B({
  ...
  htmlBuilder(r5, e) {
    var t = t0(r5.body, e, true), a = b.makeSpan([r5.mclass], t, e);
    return a.style.textShadow = "0.02em 0.01em 0.04px", a;
  },
  mathmlBuilder(r5, e) {
    var t = o0(r5.body, e), a = new S.MathNode("mstyle", t);
...
var jt = (r5) => r5.type === "textord" && r5.text === "@";
var B1 = (r5, e) => (r5.type === "mathord" || r5.type === "atom") && r5.text === e;
function D1(r5, e, t) {
  var a = T1[r5];
  switch (a) {
    case "\\\\cdrightarrow":
...
function C1(r5) {
  ...
  for (r5.gullet.beginGroup(), r5.gullet.macros.set("\\cr", "\\\\\\relax"), r5.gullet.beginGroup(); ; ) {
    ...
    if (t === "&" || t === "\\\\")
      ...
      throw new M("Expected \\\\ or \\cr or \\end", r5.nextToken);
  }
...
B({
  ...
  htmlBuilder(r5, e) {
    var t = e.havingStyle(e.style.sup()), a = b.wrapFragment(P(r5.label, t, e), e);
    return a.classes.push("cd-label-" + r5.side), a.style.bottom = A(0.8 - a.depth), a.height = 0, a.depth = 0, a;
  },
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mrow", [X(r5.label, e)]);
    return t = new S.MathNode("mpadded", [t]), t.setAttribute("width", "0"), r5.side === "left" && t.setAttribute("lspace", "-1width"), t.setAttribute("voffset", "0.7em"), t = new S.MathNode("mstyle", [t]), t.setAttribute("displaystyle", "false"), t.setAttribute("scriptlevel", "1"), t;
  }
});
B({
  type: "cdlabelparent",
  ...
  htmlBuilder(r5, e) {
    var t = b.wrapFragment(P(r5.fragment, e), e);
    return t.classes.push("cd-vert-arrow"), t;
  },
  mathmlBuilder(r5, e) {
    return new S.MathNode("mrow", [X(r5.fragment, e)]);
  }
});
B({
  type: "textord",
  ...
  handler(r5, e) {
    for (var {
      parser: t
    } = r5, a = H(e[0], "ordgroup"), n = a.body, s = "", o = 0; o < n.length; o++) {
      var h = H(n[o], "textord");
      s += h.text;
    }
    var c = parseInt(s), p;
...
var Rr = (r5, e) => {
  var t = t0(r5.body, e.withColor(r5.color), false);
  return b.makeFragment(t);
};
var Ir = (r5, e) => {
  var t = o0(r5.body, e.withColor(r5.color)), a = new S.MathNode("mstyle", t);
...
B({
  ...
  handler(r5, e) {
    var {
      parser: t
    } = r5, a = H(e[0], "color-token").color, n = e[1];
    return {
      type: "color",
      mode: t.mode,
      color: a,
...
B({
  ...
  handler(r5, e, t) {
    var {
      parser: a
    } = r5, n = a.gullet.future().text === "[" ? a.parseSizeGroup(true) : null, s = !a.settings.displayMode || !a.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode");
    return {
      type: "cr",
      mode: a.mode,
      newLine: s,
  ...
  htmlBuilder(r5, e) {
    ...
    return r5.newLine && (t.classes.push("newline"), r5.size && (t.style.marginTop = A(K(r5.size, e)))), t;
  },
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mspace");
    return r5.newLine && (t.setAttribute("linebreak", "newline"), r5.size && t.setAttribute("height", A(K(r5.size, e)))), t;
  }
});
var ut = {
  "\\global": "\\global",
...
var Or = (r5) => {
  var e = r5.text;
  if (/^(?:[\\{}$&#^_]|EOF)$/.test(e))
    throw new M("Expected a control sequence", r5);
  return e;
};
var N1 = (r5) => {
...
B({
  ...
  handler(r5) {
    var {
      parser: e,
      funcName: t
    } = r5, a = e.gullet.popToken(), n = a.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(n))
...
B({
  ...
  handler(r5) {
    var {
      parser: e,
      funcName: t
    } = r5, a = Or(e.gullet.popToken()), n = e.gullet.popToken(), s = e.gullet.popToken();
...
var R1 = ["|", "\\lvert", "\\rvert", "\\vert"];
var I1 = ["\\|", "\\lVert", "\\rVert", "\\Vert"];
var Pr = function(e, t, a, n, s, o) {
  var h, c, p, g, y = "", w = 0;
  h = p = g = e, c = null;
  var x = "Size1-Regular";
...
var Gr = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"];
var F1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"];
var Vr = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"];
var se = [0, 1.2, 1.8, 2.4, 3];
var H1 = function(e, t, a, n, s) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), q.contains(Gr, e) || q.contains(Vr, e))
    return Lr(e, t, false, a, n, s);
  if (q.contains(F1, e))
    return Pr(e, se[t], false, a, n, s);
...
var U1 = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Oe(r5, e) {
  var t = Re(r5);
  if (t && q.contains(U1, t.text))
    return t;
  throw t ? new M("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", r5) : new M("Invalid delimiter type '" + r5.type + "'", r5);
}
B({
  type: "delimsizing",
  ...
  handler: (r5, e) => {
    ...
    return {
      type: "delimsizing",
      mode: r5.parser.mode,
      size: Zt[r5.funcName].size,
      mclass: Zt[r5.funcName].mclass,
      delim: t.text
    };
  },
  htmlBuilder: (r5, e) => r5.delim === "." ? b.makeSpan([r5.mclass]) : B0.sizedDelim(r5.delim, r5.size, e, r5.mode, [r5.mclass]),
  mathmlBuilder: (r5) => {
    var e = [];
    r5.delim !== "." && e.push(v0(r5.delim, r5.mode));
    ...
    var a = A(B0.sizeToMaxHeight[r5.size]);
...
B({
  ...
  htmlBuilder: (r5, e) => {
    Kt(r5);
    for (var t = t0(r5.body, e, true, ["mopen", "mclose"]), a = 0, n = 0, s = false, o = 0; o < t.length; o++)
      t[o].isMiddle ? s = true : (a = Math.max(t[o].height, a), n = Math.max(t[o].depth, n));
    a *= e.sizeMultiplier, n *= e.sizeMultiplier;
    var h;
    if (r5.left === "." ? h = oe(e, ["mopen"]) : h = B0.leftRightDelim(r5.left, a, n, e, r5.mode, ["mopen"]), t.unshift(h), s)
      for (var c = 1; c < t.length; c++) {
        var p = t[c], g = p.isMiddle;
        g && (t[c] = B0.leftRightDelim(g.delim, a, n, g.options, r5.mode, []));
      }
    var y;
    if (r5.right === ".")
      y = oe(e, ["mclose"]);
    else {
      var w = r5.rightColor ? e.withColor(r5.rightColor) : e;
      y = B0.leftRightDelim(r5.right, a, n, w, r5.mode, ["mclose"]);
    }
  ...
  mathmlBuilder: (r5, e) => {
    ...
    var t = o0(r5.body, e);
    if (r5.left !== ".") {
      var a = new S.MathNode("mo", [v0(r5.left, r5.mode)]);
      a.setAttribute("fence", "true"), t.unshift(a);
    }
    if (r5.right !== ".") {
      var n = new S.MathNode("mo", [v0(r5.right, r5.mode)]);
...
B({
  ...
  htmlBuilder: (r5, e) => {
    ...
    if (r5.delim === ".")
      ...
      t = B0.sizedDelim(r5.delim, 1, e, r5.mode, []);
      var a = {
        delim: r5.delim,
        options: e
      };
  ...
  mathmlBuilder: (r5, e) => {
    var t = r5.delim === "\\vert" || r5.delim === "|" ? v0("|", "text") : v0(r5.delim, r5.mode), a = new S.MathNode("mo", [t]);
    return a.setAttribute("fence", "true"), a.setAttribute("lspace", "0.05em"), a.setAttribute("rspace", "0.05em"), a;
  }
});
var kt = (r5, e) => {
  var t = b.wrapFragment(P(r5.body, e), e), a = r5.label.slice(1), n = e.sizeMultiplier, s, o = 0, h = q.isCharacterBox(r5.body);
  if (a === "sout")
...
var St = (r5, e) => {
  var t = 0, a = new S.MathNode(r5.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [X(r5.body, e)]);
  switch (r5.label) {
    case "\\cancel":
...
B({
  ...
  handler(r5, e, t) {
    var {
      parser: a,
      funcName: n
    } = r5, s = H(e[0], "color-token").color, o = e[1];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
B({
  ...
  handler(r5, e, t) {
    var {
      parser: a,
      funcName: n
    } = r5, s = H(e[0], "color-token").color, o = H(e[1], "color-token").color, h = e[2];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
function Jt(r5) {
  ...
  r5.consumeSpaces();
  var t = r5.fetch().text;
  for (t === "\\relax" && (r5.consume(), r5.consumeSpaces(), t = r5.fetch().text); t === "\\hline" || t === "\\hdashline"; )
    r5.consume(), e.push(t === "\\hdashline"), r5.consumeSpaces(), t = r5.fetch().text;
  return e;
}
var Fe = (r5) => {
  var e = r5.parser.settings;
  if (!e.displayMode)
    throw new M("{" + r5.envName + "} can be used only in display mode.");
};
function Mt(r5) {
  if (r5.indexOf("ed") === -1)
    return r5.indexOf("*") === -1;
...
function V0(r5, e, t) {
  ...
  if (r5.gullet.beginGroup(), p || r5.gullet.macros.set("\\cr", "\\\\\\relax"), !o) {
    var x = r5.gullet.expandMacroAsText("\\arraystretch");
    if (x == null)
      o = 1;
  ...
  function V() {
    O && (r5.gullet.macros.get("\\df@tag") ? (O.push(r5.subparse([new f0("\\df@tag")])), r5.gullet.macros.set("\\df@tag", void 0, true)) : O.push(!!c && r5.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (F(), N.push(Jt(r5)); ; ) {
    var L = r5.parseExpression(false, p ? "\\end" : "\\\\");
    r5.gullet.endGroup(), r5.gullet.beginGroup(), L = {
      type: "ordgroup",
      mode: r5.mode,
      body: L
    }, t && (L = {
    ...
    if (U === "&") {
      if (y && z.length === y) {
        if (p || h)
          throw new M("Too many tab characters: &", r5.nextToken);
      ...
      r5.consume();
      var G = void 0;
      r5.gullet.future().text !== " " && (G = r5.parseSizeGroup(true)), C.push(G ? G.value : null), V(), N.push(Jt(r5)), z = [], T.push(z), F();
    } else
      throw new M("Expected & or \\\\ or \\cr or \\end", r5.nextToken);
  }
...
var k0 = function(e, t) {
  ...
  if (e.tags && e.tags.some((fe) => fe))
    for (a = 0; a < s; ++a) {
      ...
      R0 === true ? I0 = b.makeSpan(["eqn-num"], [], t) : R0 === false ? I0 = b.makeSpan([], [], t) : I0 = b.makeSpan([], t0(R0, t, true), t), I0.depth = j0.depth, I0.height = j0.height, W0.push({
        type: "elem",
        elem: I0,
        shift: Le
      });
  ...
  for (
    ...
    for (var m0 = U0[E0] || {}, ae = true; m0.type === "separator"; ) {
...
var S0 = function(e, t) {
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var F = N; F < O; F++)
      z[F].type === "align" ? (x += Y1[z[F].align], C && (T += "none "), C = true) : z[F].type === "separator" && C && (T += z[F].separator === "|" ? "solid " : "dashed ", C = false);
...
w0({
  ...
  handler(r5, e) {
    ...
    return V0(r5.parser, s, zt(r5.envName));
  },
  htmlBuilder: k0,
  mathmlBuilder: S0
});
w0({
  ...
  handler(r5) {
    ...
    var s = V0(r5.parser, a, zt(r5.envName)), o = Math.max(0, ...s.body.map((h) => h.length));
...
w0({
  ...
  handler(r5, e) {
    ...
    if (s = V0(r5.parser, s, "script"), s.body.length > 0 && s.body[0].length > 1)
      throw new M("{subarray} can contain only one column");
    return s;
  },
  htmlBuilder: k0,
...
w0({
  ...
  handler(r5) {
    ...
    }, t = V0(r5.parser, e, zt(r5.envName));
    return {
      type: "leftright",
      mode: r5.mode,
      body: [t],
...
w0({
  ...
  handler(r5) {
    q.contains(["gather", "gather*"], r5.envName) && Fe(r5);
    var e = {
      cols: [{
        type: "align",
        align: "c"
      ...
      autoTag: Mt(r5.envName),
      emptySingleRow: true,
      leqno: r5.parser.settings.leqno
    };
    return V0(r5.parser, e, "display");
  },
  htmlBuilder: k0,
  mathmlBuilder: S0
});
...
B({
  ...
  handler(r5, e) {
    throw new M(r5.funcName + " valid only within array environment");
  }
});
var Qt = $r;
B({
...
B({
  ...
  handler: (r5, e) => {
    var {
      ...
      mode: s
    } = t, o = t.parseExpression(true, n), h = "math" + a.slice(1);
    return {
      type: "font",
      mode: s,
      font: h,
...
var Jr = (r5, e) => {
  var t = e;
  return r5 === "display" ? t = t.id >= R.SCRIPT.id ? t.text() : R.DISPLAY : r5 === "text" && t.size === R.DISPLAY.size ? t = R.TEXT : r5 === "script" ? t = R.SCRIPT : r5 === "scriptscript" && (t = R.SCRIPTSCRIPT), t;
};
var At = (r5, e) => {
  var t = Jr(r5.size, e.style), a = t.fracNum(), n = t.fracDen(), s;
  s = e.havingStyle(a);
  var o = P(r5.numer, s, e);
  if (r5.continued) {
    var h = 8.5 / e.fontMetrics().ptPerEm, c = 3.5 / e.fontMetrics().ptPerEm;
    o.height = o.height < h ? h : o.height, o.depth = o.depth < c ? c : o.depth;
  }
  s = e.havingStyle(n);
  var p = P(r5.denom, s, e), g, y, w;
  r5.hasBarLine ? (r5.barSize ? (y = K(r5.barSize, e), g = b.makeLineSpan("frac-line", e, y)) : g = b.makeLineSpan("frac-line", e), y = g.height, w = g.height) : (g = null, y = 0, w = e.fontMetrics().defaultRuleThickness);
  var x, z, T;
  t.size === R.DISPLAY.size || r5.size === "display" ? (x = e.fontMetrics().num1, y > 0 ? z = 3 * w : z = 7 * w, T = e.fontMetrics().denom1) : (y > 0 ? (x = e.fontMetrics().num2, z = w) : (x = e.fontMetrics().num3, z = 3 * w), T = e.fontMetrics().denom2);
  var C;
  if (g) {
  ...
  var L, U;
  return r5.leftDelim == null ? L = oe(e, ["mopen"]) : L = B0.customSizedDelim(r5.leftDelim, V, true, e.havingStyle(t), r5.mode, ["mopen"]), r5.continued ? U = b.makeSpan([]) : r5.rightDelim == null ? U = oe(e, ["mclose"]) : U = B0.customSizedDelim(r5.rightDelim, V, true, e.havingStyle(t), r5.mode, ["mclose"]), b.makeSpan(["mord"].concat(s.sizingClasses(e)), [L, b.makeSpan(["mfrac"], [C]), U], e);
};
var Tt = (r5, e) => {
  var t = new S.MathNode("mfrac", [X(r5.numer, e), X(r5.denom, e)]);
  if (!r5.hasBarLine)
    t.setAttribute("linethickness", "0px");
  else if (r5.barSize) {
    var a = K(r5.barSize, e);
    t.setAttribute("linethickness", A(a));
  }
  var n = Jr(r5.size, e.style);
  ...
  if (r5.leftDelim != null || r5.rightDelim != null) {
    ...
    if (r5.leftDelim != null) {
      var h = new S.MathNode("mo", [new S.TextNode(r5.leftDelim.replace("\\", ""))]);
      h.setAttribute("fence", "true"), o.push(h);
    }
    if (o.push(t), r5.rightDelim != null) {
      var c = new S.MathNode("mo", [new S.TextNode(r5.rightDelim.replace("\\", ""))]);
...
B({
  ...
  handler: (r5, e) => {
    var {
      parser: t,
      funcName: a
    } = r5, n = e[0], s = e[1], o, h = null, c = null, p = "auto";
    switch (a) {
      case "\\dfrac":
      case "\\frac":
      case "\\tfrac":
...
B({
  ...
  handler(r5, e) {
    var {
      parser: t
    } = r5, a = e[4], n = e[5], s = Ne(e[0]), o = s.type === "atom" && s.family === "open" ? tr(s.text) : null, h = Ne(e[1]), c = h.type === "atom" && h.family === "close" ? tr(h.text) : null, p = H(e[2], "size"), g, y = null;
...
B({
  ...
  handler: (r5, e) => {
    var {
      parser: t,
      funcName: a
    } = r5, n = e[0], s = wa(H(e[1], "infix").size), o = e[2], h = s.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: n,
...
var X1 = (r5, e) => {
  var t = N0.mathMLnode(r5.label);
  return new S.MathNode(r5.isOver ? "mover" : "munder", [X(r5.base, e), t]);
};
B({
  type: "horizBrace",
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = t0(r5.body, e, false);
    return b.makeAnchor(r5.href, [], t, e);
  },
  mathmlBuilder: (r5, e) => {
    var t = G0(r5.body, e);
    return t instanceof c0 || (t = new c0("mrow", [t])), t.setAttribute("href", r5.href), t;
  }
});
B({
  type: "href",
...
B({
  ...
  mathmlBuilder(r5, e) {
    return new S.MathNode("mrow", o0(r5.body, e));
  }
});
B({
  type: "html",
  ...
  htmlBuilder: (r5, e) => {
    var t = t0(r5.body, e, false), a = ["enclosing"];
    r5.attributes.class && a.push(...r5.attributes.class.trim().split(/\s+/));
    var n = b.makeSpan(a, t, e);
    for (var s in r5.attributes)
      s !== "class" && r5.attributes.hasOwnProperty(s) && n.setAttribute(s, r5.attributes[s]);
    return n;
  },
  mathmlBuilder: (r5, e) => G0(r5.body, e)
});
B({
  type: "htmlmathml",
  names: ["\\html@mathml"],
  ...
  htmlBuilder: (r5, e) => {
    var t = t0(r5.html, e, false);
    return b.makeFragment(t);
  },
  mathmlBuilder: (r5, e) => G0(r5.mathml, e)
});
var _e = function(e) {
  if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
    return {
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = K(r5.height, e), a = 0;
    r5.totalheight.number > 0 && (a = K(r5.totalheight, e) - t);
    var n = 0;
    r5.width.number > 0 && (n = K(r5.width, e));
    var s = {
      height: A(t + a)
    };
    n > 0 && (s.width = A(n)), a > 0 && (s.verticalAlign = A(-a));
    var o = new Xa(r5.src, r5.alt, s);
    return o.height = t, o.depth = a, o;
  },
  mathmlBuilder: (r5, e) => {
    var t = new S.MathNode("mglyph", []);
    t.setAttribute("alt", r5.alt);
    var a = K(r5.height, e), n = 0;
    if (r5.totalheight.number > 0 && (n = K(r5.totalheight, e) - a, t.setAttribute("valign", A(-n))), t.setAttribute("height", A(a + n)), r5.width.number > 0) {
      var s = K(r5.width, e);
...
B({
  ...
  htmlBuilder(r5, e) {
    return b.makeGlue(r5.dimension, e);
  },
  mathmlBuilder(r5, e) {
    var t = K(r5.dimension, e);
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t;
    r5.alignment === "clap" ? (t = b.makeSpan([], [P(r5.body, e)]), t = b.makeSpan(["inner"], [t], e)) : t = b.makeSpan(["inner"], [P(r5.body, e)]);
    var a = b.makeSpan(["fix"], []), n = b.makeSpan([r5.alignment], [t, a], e), s = b.makeSpan(["strut"]);
  ...
  mathmlBuilder: (r5, e) => {
    var t = new S.MathNode("mpadded", [X(r5.body, e)]);
...
B({
  ...
  handler(r5, e) {
    throw new M("Mismatched " + r5.funcName);
  }
});
var rr = (r5, e) => {
  switch (e.style.size) {
...
var _r = (r5, e, t, a, n, s, o) => {
  ...
  var w;
  if (p && c) {
    var x = a.fontMetrics().bigOpSpacing5 + c.elem.height + c.elem.depth + c.kern + r5.depth + o;
    w = b.makeVList({
      positionType: "bottom",
      positionData: x,
      children: [{
...
var re = (r5, e) => {
  ...
  o.size === R.DISPLAY.size && s.symbol && !q.contains(ea, s.name) && (h = true);
  var c;
  if (s.symbol) {
...
var me = (r5, e) => {
  var t;
  if (r5.symbol)
    t = new c0("mo", [v0(r5.name, r5.mode)]), q.contains(ea, r5.name) && t.setAttribute("largeop", "false");
  else if (r5.body)
    t = new c0("mo", o0(r5.body, e));
  else {
    t = new c0("mi", [new ie(r5.name.slice(1))]);
    var a = new c0("mo", [v0("⁡", "text")]);
    r5.parentIsSupSub ? t = new c0("mrow", [t, a]) : t = Br([t, a]);
  }
  return t;
};
var $1 = {
...
var j1 = (r5, e) => {
  for (var t = o0(r5.body, e.withFont("mathrm")), a = true, n = 0; n < t.length; n++) {
    var s = t[n];
    if (!(s instanceof S.SpaceNode))
      if (s instanceof S.MathNode)
        switch (s.type) {
          ...
          case "mo": {
            var o = s.children[0];
            s.children.length === 1 && o instanceof S.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : a = false;
            break;
          }
          default:
            a = false;
  ...
  return r5.parentIsSupSub ? new S.MathNode("mrow", [c, p]) : S.newDocumentFragment([c, p]);
};
B({
  type: "operatorname",
...
$0({
  type: "ordgroup",
  htmlBuilder(r5, e) {
    return r5.semisimple ? b.makeFragment(t0(r5.body, e, false)) : b.makeSpan(["mord"], t0(r5.body, e, true), e);
  },
  mathmlBuilder(r5, e) {
    return G0(r5.body, e, true);
  }
});
B({
  type: "overline",
  ...
  htmlBuilder(r5, e) {
    var t = P(r5.body, e.havingCrampedStyle()), a = b.makeLineSpan("overline-line", e), n = e.fontMetrics().defaultRuleThickness, s = b.makeVList({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: t
  ...
  mathmlBuilder(r5, e) {
    ...
    var a = new S.MathNode("mover", [X(r5.body, e), t]);
    return a.setAttribute("accent", "true"), a;
  }
});
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = t0(r5.body, e.withPhantom(), false);
    return b.makeFragment(t);
  },
  mathmlBuilder: (r5, e) => {
    var t = o0(r5.body, e);
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = b.makeSpan([], [P(r5.body, e.withPhantom())]);
  ...
  mathmlBuilder: (r5, e) => {
    var t = o0(Q(r5.body), e), a = new S.MathNode("mphantom", t), n = new S.MathNode("mpadded", [a]);
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = b.makeSpan(["inner"], [P(r5.body, e.withPhantom())]), a = b.makeSpan(["fix"], []);
...
B({
  ...
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mpadded", [X(r5.body, e)]), a = r5.dy.number + r5.dy.unit;
...
B({
  ...
  handler(r5, e, t) {
    var {
      parser: a
    } = r5, n = t[0], s = H(e[0], "size"), o = H(e[1], "size");
    return {
      type: "rule",
      mode: a.mode,
  ...
  htmlBuilder(r5, e) {
    var t = b.makeSpan(["mord", "rule"], [], e), a = K(r5.width, e), n = K(r5.height, e), s = r5.shift ? K(r5.shift, e) : 0;
  ...
  mathmlBuilder(r5, e) {
    var t = K(r5.width, e), a = K(r5.height, e), n = r5.shift ? K(r5.shift, e) : 0, s = e.color && e.getColor() || "black", o = new S.MathNode("mspace");
...
function ra(r5, e, t) {
  for (var a = t0(r5, e, false), n = e.sizeMultiplier / t.sizeMultiplier, s = 0; s < a.length; s++) {
...
B({
  ...
  handler: (r5, e) => {
    var {
      ...
      funcName: a,
      parser: n
    } = r5, s = n.parseExpression(false, t);
    return {
      type: "sizing",
      mode: n.mode,
  ...
  htmlBuilder: Z1,
  mathmlBuilder: (r5, e) => {
    var t = e.havingSize(r5.size), a = o0(r5.body, t), n = new S.MathNode("mstyle", a);
...
B({
  ...
  handler: (r5, e, t) => {
    var {
      parser: a
    } = r5, n = false, s = false, o = t[0] && H(t[0], "ordgroup");
    if (o)
  ...
  htmlBuilder: (r5, e) => {
    var t = b.makeSpan([], [P(r5.body, e)]);
    if (!r5.smashHeight && !r5.smashDepth)
      return t;
    if (r5.smashHeight && (t.height = 0, t.children))
      for (var a = 0; a < t.children.length; a++)
        t.children[a].height = 0;
    if (r5.smashDepth && (t.depth = 0, t.children))
...
B({
  ...
  htmlBuilder(r5, e) {
    ...
    if (r5.index) {
      var z = e.havingStyle(R.SCRIPTSCRIPT), T = P(r5.index, z, e), C = 0.6 * (x.height - x.depth), N = b.makeVList({
        positionType: "shift",
        positionData: -C,
        children: [{
          type: "elem",
...
B({
  ...
  handler(r5, e) {
    var {
      ...
      funcName: a,
      parser: n
    } = r5, s = n.parseExpression(true, t), o = a.slice(1, a.length - 5);
    return {
      type: "styling",
      mode: n.mode,
  ...
  htmlBuilder(r5, e) {
    var t = nr[r5.style], a = e.havingStyle(t).withFont("");
    return ra(r5.body, a, e);
  },
  mathmlBuilder(r5, e) {
    var t = nr[r5.style], a = e.havingStyle(t), n = o0(r5.body, a), s = new S.MathNode("mstyle", n), o = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
$0({
  ...
  htmlBuilder(r5, e) {
    ...
    var {
      ...
      sup: n,
      sub: s
    } = r5, o = P(a, e), h, c, p = e.fontMetrics(), g = 0, y = 0, w = a && q.isCharacterBox(a);
    if (n) {
  ...
  mathmlBuilder(r5, e) {
    ...
    var s = [X(r5.base, e)];
    r5.sub && s.push(X(r5.sub, e)), r5.sup && s.push(X(r5.sup, e));
    var o;
    if (t)
      o = a ? "mover" : "munder";
    else if (r5.sub)
...
$0({
  type: "atom",
  htmlBuilder(r5, e) {
    return b.mathsym(r5.text, r5.mode, e, ["m" + r5.family]);
  },
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mo", [v0(r5.text, r5.mode)]);
    if (r5.family === "bin") {
      var a = bt(r5, e);
      a === "bold-italic" && t.setAttribute("mathvariant", a);
    } else
      r5.family === "punct" ? t.setAttribute("separator", "true") : (r5.family === "open" || r5.family === "close") && t.setAttribute("stretchy", "false");
    return t;
  }
});
var aa = {
...
$0({
  type: "mathord",
  htmlBuilder(r5, e) {
    return b.makeOrd(r5, e, "mathord");
  },
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mi", [v0(r5.text, r5.mode, e)]), a = bt(r5, e) || "italic";
...
$0({
  type: "textord",
  htmlBuilder(r5, e) {
    return b.makeOrd(r5, e, "textord");
  },
  mathmlBuilder(r5, e) {
    var t = v0(r5.text, r5.mode, e), a = bt(r5, e) || "normal", n;
    return r5.mode === "text" ? n = new S.MathNode("mtext", [t]) : /[0-9]/.test(r5.text) ? n = new S.MathNode("mn", [t]) : r5.text === "\\prime" ? n = new S.MathNode("mo", [t]) : n = new S.MathNode("mi", [t]), a !== aa[n.type] && n.setAttribute("mathvariant", a), n;
  }
});
var et = {
  "\\nobreak": "nobreak",
...
$0({
  type: "spacing",
  htmlBuilder(r5, e) {
    if (tt.hasOwnProperty(r5.text)) {
      var t = tt[r5.text].className || "";
      if (r5.mode === "text") {
        var a = b.makeOrd(r5, e, "textord");
        return a.classes.push(t), a;
      } else
        return b.makeSpan(["mspace", t], [b.mathsym(r5.text, r5.mode, e)], e);
    } else {
      if (et.hasOwnProperty(r5.text))
        return b.makeSpan(["mspace", et[r5.text]], [], e);
      throw new M('Unknown type of space "' + r5.text + '"');
    }
  },
  mathmlBuilder(r5, e) {
    var t;
...
var ir = () => {
  var r5 = new S.MathNode("mtd", []);
  return r5.setAttribute("width", "50%"), r5;
};
$0({
  type: "tag",
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mtable", [new S.MathNode("mtr", [ir(), new S.MathNode("mtd", [G0(r5.body, e)]), ir(), new S.MathNode("mtd", [G0(r5.tag, e)])])]);
...
B({
  ...
  htmlBuilder(r5, e) {
    var t = or(r5, e), a = t0(r5.body, t, true);
...
B({
  ...
  htmlBuilder(r5, e) {
    var t = P(r5.body, e), a = b.makeLineSpan("underline-line", e), n = e.fontMetrics().defaultRuleThickness, s = b.makeVList({
      positionType: "top",
      positionData: t.height,
      children: [{
        type: "kern",
  ...
  mathmlBuilder(r5, e) {
    var t = new S.MathNode("mo", [new S.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var a = new S.MathNode("munder", [X(r5.body, e), t]);
    return a.setAttribute("accentunder", "true"), a;
  }
});
B({
  ...
  mathmlBuilder(r5, e) {
    return new S.MathNode("mpadded", [X(r5.body, e)], ["vcenter"]);
  }
});
B({
  type: "verb",
  ...
  htmlBuilder(r5, e) {
    for (var t = ur(r5), a = [], n = e.havingStyle(e.style.text()), s = 0; s < t.length; s++) {
      var o = t[s];
      o === "~" && (o = "\\textasciitilde"), a.push(b.makeSymbol(o, "Typewriter-Regular", r5.mode, n, ["mord", "texttt"]));
    }
    return b.makeSpan(["mord", "text"].concat(n.sizingClasses(e)), b.tryCombineChars(a), n);
  },
  mathmlBuilder(r5, e) {
    var t = new S.TextNode(ur(r5)), a = new S.MathNode("mtext", [t]);
    return a.setAttribute("mathvariant", "monospace"), a;
  }
});
var ur = (r5) => r5.body.replace(/ /g, r5.star ? "␣" : " ");
var H0 = Ar;
var na = `[ \r
	]`;
var Q1 = "\\\\[a-zA-Z@]+";
...
?)[ \r	]*`;
var mt = "[̀-ͯ]";
var r4 = new RegExp(mt + "+$");
var a4 = "(" + na + "+)|" + // whitespace
(t4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(mt + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
m("\\char", function(r5) {
  ...
  if (t) {
    ...
    for (var n; (n = mr[r5.future().text]) != null && n < t; )
      a *= t, a += n, r5.popToken();
  }
  return "\\@char{" + a + "}";
});
var Bt = (r5, e, t) => {
  ...
  if (a = r5.consumeArg().tokens, a.length === 1 && a[0].text === "[") {
    for (var h = "", c = r5.expandNextToken(); c.text !== "]" && c.text !== "EOF"; )
      h += c.text, c = r5.expandNextToken();
    if (!h.match(/^\s*[0-9]+\s*$/))
...
m("\\newcommand", (r5) => Bt(r5, false, true));
m("\\renewcommand", (r5) => Bt(r5, true, false));
m("\\providecommand", (r5) => Bt(r5, true, true));
m("\\message", (r5) => {
...
m("\\show", (r5) => {
  ...
  return console.log(e, r5.macros.get(t), H0[t], $.math[t], $.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
var sa = (r5) => (e) => {
  ...
  e.macros.beginGroup();
  var c = (y) => (w) => {
    r5 && (w.macros.set("|", o), n.length && w.macros.set("\\|", h));
    var x = y;
    if (!y && n.length) {
      var z = w.future();
...
var He = class _He {
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (_He.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && H0[n.text] && H0[n.text].infix)
        break;
...
//# sourceMappingURL=katex-fa3848e8-R3M5JSP4.js.map
