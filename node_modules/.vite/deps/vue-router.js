...
import { computed, defineComponent, getCurrentInstance as getCurrentInstance2, h, inject as inject2, nextTick, provide, reactive, ref, shallowReactive, shallowRef, unref, watch as watch2, watchEffect } from "vue";
...
function useLink(props) {
  const router = inject2(routerKey);
  const currentRoute = inject2(routeLocationKey);
...
var RouterLinkImpl = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const { options } = inject2(routerKey);
...
var RouterViewImpl = defineComponent({
  ...
  setup(props, { attrs, slots }) {
    warnDeprecatedUsage();
    const injectedRoute = inject2(routerViewLocationKey);
    const routeToDisplay = computed(() => props.route || injectedRoute.value);
    const injectedDepth = inject2(viewDepthKey, 0);
...
function useRoute(_name) {
  return inject2(routeLocationKey);
}
export {
