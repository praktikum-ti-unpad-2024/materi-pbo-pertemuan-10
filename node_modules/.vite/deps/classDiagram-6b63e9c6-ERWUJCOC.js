...
// node_modules/mermaid/dist/classDiagram-6b63e9c6.js
var _ = 0;
var $ = function(i, a, t, o, p) {
  ...
  const s = a.points, c = P().x(function(e) {
    ...
    return e.y;
  }).curve(jf), n = i.append("path").attr("d", c(s)).attr("id", "edge" + _).attr("class", "relation");
  let r = "";
  ...
  let k = oi.calcLabelPosition(a.points);
  f = k.x, h = k.y;
  let y, m, w, b;
  if (x % 2 !== 0 && x > 1) {
    let e = oi.calcCardinalityPosition(
      t.relation.type1 !== "none",
      a.points,
      a.points[0]
    ), d = oi.calcCardinalityPosition(
      t.relation.type2 !== "none",
      a.points,
      a.points[x - 1]
    );
    L.debug("cardinality_1_point " + JSON.stringify(e)), L.debug("cardinality_2_point " + JSON.stringify(d)), y = e.x, m = e.y, w = d.x, b = d.y;
  }
  if (t.title !== void 0) {
  ...
  L.info("Rendering relation " + JSON.stringify(t)), t.relationTitle1 !== void 0 && t.relationTitle1 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type1").attr("x", y).attr("y", m).attr("fill", "black").attr("font-size", "6").text(t.relationTitle1), t.relationTitle2 !== void 0 && t.relationTitle2 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type2").attr("x", w).attr("y", b).attr("fill", "black").attr("font-size", "6").text(t.relationTitle2), _++;
};
var J = function(i, a, t, o) {
  L.debug("Rendering class ", a, t);
  const p = a.id, g = {
    id: p,
    label: a.id,
    width: 0,
...
var C = function(i) {
  let a = i.id;
  return i.type && (a += "<" + v1(i.type) + ">"), a;
};
var Z = function(i, a, t, o) {
  L.debug("Rendering note ", a, t);
  const p = a.id, g = {
    id: p,
    text: a.text,
    width: 0,
...
`);
  n.forEach(function(x) {
    L.debug(`Adding line: ${x}`), c.append("tspan").text(x).attr("class", "title").attr("dy", t.textHeight);
  });
...
var F = function(i, a, t, o) {
  const p = Jn().class;
  T = {}, L.info("Rendering diagram " + i);
  const g = Jn().securityLevel;
  let s;
  g === "sandbox" && (s = Tt("#i" + a));
  const c = g === "sandbox" ? Tt(s.nodes()[0].contentDocument.body) : Tt("body"), n = c.select(`[id='${a}']`);
  R(n);
  const r = new Ze({
    multigraph: true
  });
  ...
  for (const e of h) {
    ...
    T[l.id] = l, r.setNode(l.id, l), L.info("Org height: " + l.height);
  }
  o.db.getRelations().forEach(function(e) {
    ...
    L.debug(`Adding note: ${JSON.stringify(e)}`);
  ...
  }), Yt(r), r.nodes().forEach(function(e) {
    e !== void 0 && r.node(e) !== void 0 && (L.debug("Node " + e + ": " + JSON.stringify(r.node(e))), c.select("#" + (o.db.lookUpDomId(e) || e)).attr(
      "transform",
      "translate(" + (r.node(e).x - r.node(e).width / 2) + "," + (r.node(e).y - r.node(e).height / 2) + " )"
    ));
  }), r.edges().forEach(function(e) {
    e !== void 0 && r.edge(e) !== void 0 && (L.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(r.edge(e))), N.drawEdge(n, r.edge(e), r.edge(e).relation, p, o));
  });
  const y = n.node().getBBox(), m = y.width + E * 2, w = y.height + E * 2;
  Pl(n, w, m, p.useMaxWidth);
  const b = `${y.x - E} ${y.y - E} ${m} ${w}`;
  L.debug(`viewBox ${b}`), n.attr("viewBox", b);
};
var U = {
  draw: F
};
...
//# sourceMappingURL=classDiagram-6b63e9c6-ERWUJCOC.js.map
