...
var Ue = (a, t) => {
  for (var e in t)
    _e(a, e, { get: t[e], enumerable: true });
};
var wi = (a, t, e, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of Ai(t))
      !Ei.call(a, i) && i !== e && _e(a, i, { get: () => t[i], enumerable: !(s = bi(t, i)) || s.enumerable });
  return a;
};
var ls = (a, t, e) => (e = a != null ? Ti(Si(a)) : {}, wi(t || !a || !a.__esModule ? _e(e, "default", { value: a, enumerable: true }) : e, a));
var Tt = Ci((Pe) => {
  "use strict";
...
`);
  ...
  var br = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
    ...
    skipBlockComment(t) {
      ...
      if (i === -1)
        throw this.raise(p.UnterminatedComment, this.state.curPosition());
      for (this.state.pos = i + t.length, be.lastIndex = s + 2; be.test(this.input) && be.lastIndex <= i; )
    ...
    fillOptionalPropertiesForTSESLint(e) {
      ...
      switch (e.type) {
        ...
        case "AccessorProperty":
          ($ = e.declare) != null || (e.declare = false), (Ot = e.definite) != null || (e.definite = false), (Ft = e.readonly) != null || (e.readonly = false), (Bt = e.typeAnnotation) != null || (e.typeAnnotation = void 0);
        case "TSAbstractMethodDefinition":
        case "MethodDefinition":
          (Rt = e.accessibility) != null || (e.accessibility = void 0), (_t = e.decorators) != null || (e.decorators = []), (Ut = e.override) != null || (e.override = false), (jt = e.optional) != null || (e.optional = false);
          return;
        case "ClassExpression":
          ($t = e.id) != null || (e.id = null);
        case "ClassDeclaration":
          (Vt = e.abstract) != null || (e.abstract = false), (qt = e.declare) != null || (e.declare = false), (zt = e.decorators) != null || (e.decorators = []), (Ht = e.implements) != null || (e.implements = []), (Kt = e.superTypeArguments) != null || (e.superTypeArguments = void 0), (Wt = e.typeParameters) != null || (e.typeParameters = void 0);
          return;
        case "TSTypeAliasDeclaration":
        case "VariableDeclaration":
          (Jt = e.declare) != null || (e.declare = false);
          return;
        case "VariableDeclarator":
          (Xt = e.definite) != null || (e.definite = false);
          return;
        case "TSEnumDeclaration":
          (Gt = e.const) != null || (e.const = false), (Yt = e.declare) != null || (e.declare = false);
          return;
        case "TSEnumMember":
          (Qt = e.computed) != null || (e.computed = false);
          return;
        case "TSImportType":
          (Zt = e.qualifier) != null || (e.qualifier = null), (es = e.options) != null || (e.options = null);
          return;
        case "TSInterfaceDeclaration":
          (ts = e.declare) != null || (e.declare = false), (ss = e.extends) != null || (e.extends = []);
          return;
        case "TSModuleDeclaration":
          (is = e.declare) != null || (e.declare = false), (rs = e.global) != null || (e.global = e.kind === "global");
          return;
        case "TSTypeParameter":
          (as = e.const) != null || (e.const = false), (ns = e.in) != null || (e.in = false), (os = e.out) != null || (e.out = false);
          return;
      }
    }
  };
    ...
    parseExprOp(t, e, s) {
      ...
      if (Ki(i) && (this.prodParam.hasIn || !this.match(58))) {
        ...
        if (r > s) {
          ...
          if (l && (r = Ee(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
...
var G = ta;
var sa = ae(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", "Hashbang", "InterpreterDirective"]);
var bt = sa;
...
var ei = wt;
var so = ae(["RegExpLiteral", "BigIntLiteral", "NumericLiteral", "StringLiteral", "DirectiveLiteral", "Literal", "JSXText", "TemplateElement", "StringLiteralTypeAnnotation", "NumberLiteralTypeAnnotation", "BigIntLiteralTypeAnnotation"]);
function ca(a, t) {
...
var Oe = Aa;
var oe = (a) => Y(Ia(a));
var Sa = { sourceType: Nt, allowImportExportEverywhere: true, allowReturnOutsideFunction: true, allowNewTargetOutsideFunction: true, allowSuperOutsideMethod: true, allowUndeclaredExports: true, errorRecovery: true, createParenthesizedExpressions: true, createImportExpressions: true, attachComment: false, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", "decorators", "moduleBlocks", "asyncDoExpressions", "destructuringPrivate", "decoratorAutoAccessors", "explicitResourceManagement", "sourcePhaseImports", "deferredImportEvaluation", ["optionalChainingAssign", { version: "2023-07" }]], tokens: false, ranges: false };
var mi = "v8intrinsic";
var yi = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "fsharp" }]];
var j = (a, t = Sa) => ({ ...t, plugins: [...t.plugins, ...a] });
var Ea = /@(?:no)?flow\b/u;
function Ca(a, t) {
...
var xi = [j(["jsx"])];
var ka = oe({ optionsCombinations: xi });
var va = oe({ optionsCombinations: [j(["jsx", "typescript"]), j(["typescript"])] });
var La = oe({ isExpression: true, optionsCombinations: [j(["jsx"])] });
var Da = oe({ isExpression: true, optionsCombinations: [j(["typescript"])] });
var Pi = oe({ optionsCombinations: [j(["jsx", ["flow", { all: true }], "flowComments"])] });
var Ma = oe({ optionsCombinations: xi.map((a) => j(["estree"], a)) });
var Dt = {};
...
var Ba = Y({ parse: (a) => Re(a), hasPragma: () => true, hasIgnorePragma: () => false });
var Ra = Y((a) => Re(a));
var _a = Y((a) => Re(a, { allowEmpty: true }));
var Ua = Y({ parse: (a) => Re(a, { allowComments: false }), astFormat: "estree-json" });
var ja = { ...vt, ...Dt };
var Vo = Mt;
export {
  Vo as default,
