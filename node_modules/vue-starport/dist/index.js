    ...
    return () => {
      ...
      return vue.h(
        ...
        vue.h(
          ...
          vue.h(
            sp.value.component,
            vue.mergeProps(additionalProps, sp.value.props)
          )
        )
      );
    };
...
const StarportCarrier = vue.defineComponent({
  ...
  setup(_, { slots }) {
    ...
    return () => {
      return [
        slots.default?.(),
        Array.from(state.portMap.entries()).map(([port, { component }]) => vue.h(
          StarportCraft,
